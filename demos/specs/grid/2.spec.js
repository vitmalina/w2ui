        ...
        test("1: Grid Elements", () => {
            bela
                ...
                .begin('Column Headers')
                    ...
                    .click()
                    .if('#grid_grid_column_0', event => {
                        bela.error('Column headers should not exist')
                    })
                .end()
                .begin('Footer')
                ...
                .begin('Line Numbers')
                    ...
                    .click()
                    .if('#grid_grid_cell_0_number', event => {
                        bela.error('Line Numbers should not exist')
                    })
                .end()
                .begin('Select Column')
                    .if('#grid_grid_cell_0_select', event => {
                        bela.error('Select Column should not exist')
                    })
                ...
                .end()
                .begin('Expand Column')
                    .if('#grid_grid_cell_0_expand', event => {
                        bela.error('Expand Column should not exist')
                    })
                ...
                .end()
                .begin('Order Column')
                    .if('#grid_grid_cell_0_order', event => {
                        bela.error('Order Column should not exist')
                    })
