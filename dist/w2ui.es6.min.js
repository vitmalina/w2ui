            ...
            ${s.btnNow?`<div class="w2ui-cal-now">${w2utils.lang("Now")}</div>`:""}
                ...
                <div class="w2ui-sidebar-bottom"></div>
                    ...
                    <div class="w2ui-node-sub" id="node_${l.id}_sub" style="${l.style}; ${!l.hidden&&l.expanded?"":"display: none;"}">
                        ...
                        <div id="node_${l.id}_sub" style="${l.style}; ${!l.hidden&&l.expanded?"":"display: none;"}"></div>`)}else{l.selected&&!l.disabled&&(d.selected=l.id);let e="";a&&(e=a instanceof Object?(o="function"==typeof a.text?a.text.call(d,l,n)??"":a.text,`
                        ...
                        `):`
                            <div class="w2ui-node-image">
                                <span class="${"function"==typeof a?a.call(d,l,n):a}"></span>
                            </div>`);let t="",i="";if(null!=c.badge||null!=l.count){let e=l.count??c.badge?.text;var o=c.badge?.style,h=d.last.badge[l.id];(e="function"==typeof e?e.call(c,u,n):e)&&(i=`
                            ...
                            >
                                ${e}
                            </div>`)}!0===l.collapsible&&(t=`<div class="w2ui-${l.expanded?"expanded":"collapsed"} ${"left"==c.toggleAlign?"w2ui-left-toggle":""}"><span></span></div>`);o=w2utils.lang("function"==typeof l.text?l.text.call(d,l,n):l.text),h=["w2ui-node","w2ui-level-"+n,"w2ui-eaction"];l.selected&&h.push("w2ui-selected"),l.disabled&&h.push("w2ui-disabled"),l.class&&h.push(l.class);let s=l.parent?.childOffset??0;0===n&&!0===l.collapsible&&"left"==c.toggleAlign&&(s+=12),r=`
                    <div id="node_${l.id}" class="${h.join(" ")}" data-level="${n}"
                    ...
                    >
                        ${d.handle.text?`<div class="w2ui-node-handle w2ui-eaction" style="width: ${d.handle.width}px; ${d.handle.style}"
                                ...
                                >
                                   ${"function"==typeof d.handle.text?d.handle.text.call(d,l,n)??"":d.handle.text}
                              </div>`:""}
                      <div class="w2ui-node-data" style="margin-left: ${n*d.levelPadding+s+d.handle.width}px">
                            ${t} ${e} ${i}
