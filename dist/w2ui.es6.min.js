            ...
            ${s.btnNow?`<div class="w2ui-cal-now">${w2utils.lang("Now")}</div>`:""}
                ...
                <div class="w2ui-sidebar-bottom"></div>
                    ...
                    <div class="w2ui-node-sub" id="node_${s.id}_sub" style="${s.style}; ${!s.hidden&&s.expanded?"":"display: none;"}">
                        ...
                        <div id="node_${s.id}_sub" style="${s.style}; ${!s.hidden&&s.expanded?"":"display: none;"}"></div>`)}else{s.selected&&!s.disabled&&(h.selected=s.id);let e="";r&&(e=r instanceof Object?(n="function"==typeof r.text?r.text.call(h,s,a)??"":r.text,`
                            <div class="w2ui-node-image w2ui-eaction" style="${h.icon.style??""}; pointer-events: all"
                                data-mouseEnter="mouseAction|Enter|this|${s.id}|event|icon"
                                data-mouseLeave="mouseAction|Leave|this|${s.id}|event|icon"
                                data-click="mouseAction|click|this|${s.id}|event|icon">
                                    ${n}
                            </div>
                        `):`
                            <div class="w2ui-node-image">
                                <span class="${"function"==typeof r?r.call(h,s,a):r}"></span>
                            </div>`);let t="",i="";if(null!=u.badge||null!=s.count){let e=s.count??u.badge?.text;var n=u.badge?.style,o=h.last.badge[s.id];(e="function"==typeof e?e.call(u,d,a):e)&&(i=`
                            <div class="w2ui-node-badge w2ui-eaction ${null!=s.count?"w2ui-node-count":""} ${o?.className??""}"
                                style="${n??""};${o?.style??""}"
                    ...
                    >
                      ...
                      <div class="w2ui-node-data" style="margin-left: ${a*h.levelPadding+(s.parent?.childOffset??0)+h.handle.width}px">
                            ${t} ${e} ${i}
