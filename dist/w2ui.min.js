            ...
            ${s.btnNow?`<div class="w2ui-cal-now">${w2utils.lang("Now")}</div>`:""}
                ...
                <div class="w2ui-sidebar-bottom"></div>
                    ...
                    <div class="w2ui-node-image">
                        <span class="${"function"==typeof r?r.call(h,s,n):r}"></span>
                    </div>`),""),i="";if(null!=u.badge||null!=s.count){let e=s.count??u.badge?.text;var a=u.badge?.style,o=h.last.badge[s.id];(e="function"==typeof e?e.call(u,d,n):e)&&(i=`
                            ...
                            >
                                ${e}
                            </div>`)}!0===s.collapsible&&(t=`<div class="w2ui-${s.expanded?"expanded":"collapsed"} ${"left"==u.toggleAlign?"w2ui-left-toggle":""}"><span></span></div>`);a=w2utils.lang("function"==typeof s.text?s.text.call(h,s,n):s.text),o=["w2ui-node","w2ui-level-"+n,"w2ui-eaction"];s.selected&&o.push("w2ui-selected"),s.disabled&&o.push("w2ui-disabled"),s.class&&o.push(s.class),l=`
                    <div id="node_${s.id}" class="${o.join(" ")}" data-level="${n}"
                    ...
                    >
                        ${h.handle.text?`<div class="w2ui-node-handle w2ui-eaction" style="width: ${h.handle.width}px; ${h.handle.style}"
                                ...
                                >
                                   ${"function"==typeof h.handle.text?h.handle.text.call(h,s,n)??"":h.handle.text}
                              </div>`:""}
                      <div class="w2ui-node-data" style="margin-left: ${n*h.levelPadding+h.handle.width}px">
                            ${t} ${e} ${i}
                            <div class="w2ui-node-text ${e?"":"no-icon"}" style="${s.style||""}">${a}</div>
                       </div>
                    </div>
