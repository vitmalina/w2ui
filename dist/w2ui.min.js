            ...
            ${s.btnNow?`<div class="w2ui-cal-now">${w2utils.lang("Now")}</div>`:""}
                ...
                <div class="w2ui-sidebar-bottom"></div>
                    ...
                    <div class="w2ui-node-sub" id="node_${s.id}_sub" style="${s.style}; ${!s.hidden&&s.expanded?"":"display: none;"}">
                        ...
                        <div id="node_${s.id}_sub" style="${s.style}; ${!s.hidden&&s.expanded?"":"display: none;"}"></div>`)}else{s.selected&&!s.disabled&&(h.selected=s.id);let e="";r&&(e=r instanceof Object?(a="function"==typeof r.text?r.text.call(h,s,n)??"":r.text,`
                        ...
                        `):`
                            ...
                            </div>`);let t="",i="";if(null!=u.badge||null!=s.count){let e=s.count??u.badge?.text;var a=u.badge?.style,o=h.last.badge[s.id];(e="function"==typeof e?e.call(u,d,n):e)&&(i=`
                    ...
                    >
                      ...
                      <div class="w2ui-node-data" style="margin-left: ${n*h.levelPadding+(s.parent?.childOffset??0)+h.handle.width}px">
                            ${t} ${e} ${i}
