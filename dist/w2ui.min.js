...
class w2event{constructor(e,t){Object.assign(this,{type:t.type??null,detail:t,owner:e,target:t.target??null,phase:t.phase??"before",object:t.object??null,execute:null,isStopped:!1,isCancelled:!1,onComplete:null,listeners:[]}),delete t.type,delete t.target,delete t.object,this.complete=new Promise((e,t)=>{this._resolve=e,this._reject=t})}finish(e){e&&w2utils.extend(this.detail,e),this.phase="after",this.owner.trigger.call(this.owner,this)}done(e){this.listeners.push(e)}preventDefault(){this._reject(),this.isCancelled=!0}stopPropagation(){this.isStopped=!0}}class w2base{constructor(e){if(this.activeEvents=[],this.listeners=[],void 0!==e){if(!w2utils.checkName(e))return;w2ui[e]=this}this.debug=!1}on(e,t){return(e="string"==typeof e?e.split(/[,\s]+/):[e]).forEach(i=>{var e="string"==typeof i?i:i.type+":"+i.execute+"."+i.scope;if("string"==typeof i){let[e,t]=i.split(".");var[s,l]=e.replace(":complete",":after").replace(":done",":after").split(":");i={type:s,execute:l??"before",scope:t}}(i=w2utils.extend({type:null,execute:"before",onComplete:null},i)).type?t?(Array.isArray(this.listeners)||(this.listeners=[]),this.listeners.push({name:e,edata:i,handler:t}),this.debug&&console.log("w2base: add event",{name:e,edata:i,handler:t})):console.log("ERROR: You must specify event handler function when calling .on() method of "+this.name):console.log("ERROR: You must specify event type when calling .on() method of "+this.name)}),this}off(e,r){return(e="string"==typeof e?e.split(/[,\s]+/):[e]).forEach(i=>{var e="string"==typeof i?i:i.type+":"+i.execute+"."+i.scope;if("string"==typeof i){let[e,t]=i.split(".");var[s,l]=e.replace(":complete",":after").replace(":done",":after").split(":");i={type:s||"*",execute:l||"",scope:t||""}}if((i=w2utils.extend({type:null,execute:null,onComplete:null},i)).type||i.scope){r=r||null;let t=0;this.listeners=this.listeners.filter(e=>"*"!==i.type&&i.type!==e.edata.type||""!==i.execute&&i.execute!==e.edata.execute||""!==i.scope&&i.scope!==e.edata.scope||null!=i.handler&&i.handler!==e.edata.handler||(t++,!1)),this.debug&&console.log(`w2base: remove event (${t})`,{name:e,edata:i,handler:r})}else console.log("ERROR: You must specify event type when calling .off() method of "+this.name)}),this}trigger(e,i){if(1==arguments.length?i=e:(i.type=e,i.target=i.target??this),w2utils.isPlainObject(i)&&"after"==i.phase){if(!(i=this.activeEvents.find(e=>e.type==i.type&&e.target==i.target)))return void console.log(`ERROR: Cannot find even handler for "${i.type}" on "${i.target}".`);console.log("NOTICE: This syntax \"edata.trigger({ phase: 'after' })\" is outdated. Use edata.finish() instead.")}else i instanceof w2event||(i=new w2event(this,i),this.activeEvents.push(i));let s,t,l;Array.isArray(this.listeners)||(this.listeners=[]),this.debug&&console.log(`w2base: trigger "${i.type}:${i.phase}"`,i);for(let e=this.listeners.length-1;0<=e;e--){let t=this.listeners[e];if(!(null==t||t.edata.type!==i.type&&"*"!==t.edata.type||t.edata.target!==i.target&&null!=t.edata.target||t.edata.execute!==i.phase&&"*"!==t.edata.execute&&"*"!==t.edata.phase)&&(Object.keys(t.edata).forEach(e=>{null==i[e]&&null!=t.edata[e]&&(i[e]=t.edata[e])}),s=[],l=new RegExp(/\((.*?)\)/).exec(String(t.handler).split("=>")[0]),2===(s=l?l[1].split(/\s*,\s*/):s).length?(t.handler.call(this,i.target,i),this.debug&&console.log(" - call (old)",t.handler)):(t.handler.call(this,i),this.debug&&console.log(" - call",t.handler)),!0===i.isStopped||!0===i.stop))return i}var r="on"+i.type.substr(0,1).toUpperCase()+i.type.substr(1);if("before"===i.phase&&"function"==typeof this[r]&&(t=this[r],s=[],l=new RegExp(/\((.*?)\)/).exec(String(t).split("=>")[0]),2===(s=l?l[1].split(/\s*,\s*/):s).length?(t.call(this,i.target,i),this.debug&&console.log(" - call: on[Event] (old)",t)):(t.call(this,i),this.debug&&console.log(" - call: on[Event]",t)),!0===i.isStopped||!0===i.stop))return i;if(null!=i.object&&"before"===i.phase&&"function"==typeof i.object[r]&&(t=i.object[r],s=[],l=new RegExp(/\((.*?)\)/).exec(String(t).split("=>")[0]),2===(s=l?l[1].split(/\s*,\s*/):s).length?(t.call(this,i.target,i),this.debug&&console.log(" - call: edata.object (old)",t)):(t.call(this,i),this.debug&&console.log(" - call: edata.object",t)),!0===i.isStopped||!0===i.stop))return i;if("after"===i.phase){"function"==typeof i.onComplete&&i.onComplete.call(this,i);for(let e=0;e<i.listeners.length;e++)"function"==typeof i.listeners[e]&&(i.listeners[e].call(this,i),this.debug&&console.log(" - call: done",t));i._resolve(i),this.debug&&console.log(`w2base: trigger "${i.type}:${i.phase}"`,i)}return i}}const w2locale={locale:"en-US",dateFormat:"m/d/yyyy",timeFormat:"hh:mi pm",datetimeFormat:"m/d/yyyy|hh:mi pm",currencyPrefix:"$",currencySuffix:"",currencyPrecision:2,groupSymbol:",",decimalSymbol:".",shortmonths:["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],fullmonths:["January","February","March","April","May","June","July","August","September","October","November","December"],shortdays:["M","T","W","T","F","S","S"],fulldays:["Monday","Tuesday","Wednesday","Thursday","Friday","Saturday","Sunday"],weekStarts:"S",phrases:{"${count} letters or more...":"---","Add new record":"---","Add New":"---","Advanced Search":"---",after:"---","AJAX error. See console for more details.":"---","All Fields":"---",All:"---",Any:"---","Are you sure you want to delete ${count} ${records}?":"---","Attach files by dragging and dropping or Click to Select":"---",before:"---","begins with":"---",begins:"---",between:"---",buffered:"---",Cancel:"---",Close:"---",Column:"---",Confirmation:"---",contains:"---",Copied:"---","Copy to clipboard":"---","Current Date & Time":"---","Delete selected records":"---",Delete:"---",'Do you want to delete search item "${item}"?':"---","Edit selected record":"---",Edit:"---","Empty list":"---","ends with":"---",ends:"---","Field should be at least ${count} characters.":"---",Hide:"---",in:"---","is not":"---",is:"---","less than":"---","Line #":"---","Load ${count} more...":"---","Loading...":"---","Maximum number of files is ${count}":"---","Maximum total size is ${count}":"---",Modified:"---","more than":"---","Multiple Fields":"---",Name:"---","No items found":"---","No matches":"---",No:"---",none:"---","Not a float":"---","Not a hex number":"---","Not a valid date":"---","Not a valid email":"---","Not alpha-numeric":"---","Not an integer":"---","Not in money format":"---","not in":"---",Notification:"---",of:"---",Ok:"---",Opacity:"---","Record ID":"---",record:"---",records:"---","Refreshing...":"---","Reload data in the list":"---",Remove:"---","Request aborted.":"---","Required field":"---",Reset:"---","Restore Default State":"---","Returned data is not in valid JSON format.":"---","Save changed records":"---","Save Grid State":"---",Save:"---","Saved Searches":"---","Saving...":"---","Search took ${count} seconds":"---",Search:"---","Select Hour":"---","Select Minute":"---",selected:"---","Server Response ${count} seconds":"---","Show/hide columns":"---",Show:"---",Size:"---",Skip:"---","Sorting took ${count} seconds":"---","Type to search...":"---",Type:"---",Yes:"---",Yesterday:"---","Your remote data source record count has changed, reloading from the first record.":"---"}};class Query{constructor(e,t,i){this.version=.4,this.context=t??document,this.previous=i??null;let s=[];if(Array.isArray(e))s=e;else if(Query._isEl(e))s=[e];else if(e instanceof Query)s=e.nodes;else if("string"==typeof e){if("function"!=typeof this.context.querySelector)throw new Error("Invalid context");s=Array.from(this.context.querySelectorAll(e))}else if(null==e)s=[];else{t=Array.from(e??[]);if("object"!=typeof e||!Array.isArray(t))throw new Error(`Invalid selector "${e}"`);s=t}this.nodes=s,this.length=s.length,this.each((e,t)=>{this[t]=e})}static _isEl(e){return e instanceof Document||e instanceof DocumentFragment||e instanceof HTMLElement||e instanceof Text}static _fragment(e){let t=document.createElement("template");return t.innerHTML=e,t.content}_insert(l,i){let r=[],n=this.length;if(!(n<1)){var t=Query._isEl(i);let e=this;if("string"==typeof i)this.each(e=>{var t=Query._fragment(i);r.push(...t.childNodes),e[l](t)});else if(i instanceof Query){let s=1==n&&1==i.length;i.each(i=>{this.each(e=>{var t=s?i:i.cloneNode(!0);e[l](t),r.push(t)})}),s||i.remove()}else{if(!t)throw new Error(`Incorrect argument for "${l}(html)". It expects one string argument.`);this.each(e=>{var t=1===n?i:Query._fragment(i.outerHTML);r.push(...1===n?[i]:t.childNodes),e[l](t)}),1<n&&i.remove()}return e="replaceWith"==l?new Query(r,this.context,this):e}}_save(e,t,i){e._mQuery=e._mQuery??{},Array.isArray(i)?(e._mQuery[t]=e._mQuery[t]??[],e._mQuery[t].push(...i)):null!=i?e._mQuery[t]=i:delete e._mQuery[t]}get(e){var t=this[e=e<0?this.length+e:e];return t||(null!=e?null:this.nodes)}eq(e){let t=[this[e=e<0?this.length+e:e]];return null==t[0]&&(t=[]),new Query(t,this.context,this)}then(e){e=e(this);return null!=e?e:this}find(t){let i=[];return this.each(e=>{e=Array.from(e.querySelectorAll(t));0<e.length&&i.push(...e)}),new Query(i,this.context,this)}filter(t){let i=[];return this.each(e=>{(e===t||"string"==typeof t&&e.matches&&e.matches(t)||"function"==typeof t&&t(e))&&i.push(e)}),new Query(i,this.context,this)}next(){let t=[];return this.each(e=>{e=e.nextElementSibling;e&&t.push(e)}),new Query(t,this.context,this)}prev(){let t=[];return this.each(e=>{e=e.previousElementSibling;e&&t.push(e)}),new Query(t,this.context,this)}shadow(e){let t=[],i=(this.each(e=>{e.shadowRoot&&t.push(e.shadowRoot)}),new Query(t,this.context,this));return e?i.find(e):i}closest(t){let i=[];return this.each(e=>{e=e.closest(t);e&&i.push(e)}),new Query(i,this.context,this)}host(t){let i=[],s=e=>e.parentNode?s(e.parentNode):e,l=e=>{e=s(e);i.push(e.host||e),e.host&&t&&l(e.host)};return this.each(e=>{l(e)}),new Query(i,this.context,this)}parent(e){return this.parents(e,!0)}parents(e,t){let i=[],s=e=>{if(-1==i.indexOf(e)&&i.push(e),!t&&e.parentNode)return s(e.parentNode)},l=(this.each(e=>{e.parentNode&&s(e.parentNode)}),new Query(i,this.context,this));return e?l.filter(e):l}each(i){return this.nodes.forEach((e,t)=>{i(e,t,this)}),this}append(e){return this._insert("append",e)}prepend(e){return this._insert("prepend",e)}after(e){return this._insert("after",e)}before(e){return this._insert("before",e)}replace(e){return this._insert("replaceWith",e)}remove(){return this.each(e=>{e.remove()}),this}css(t,e){let s=t;var i=arguments.length;if(0!==i&&(1!==i||"string"!=typeof t))return"object"!=typeof t&&((s={})[t]=e),this.each((i,e)=>{Object.keys(s).forEach(e=>{var t=String(s[e]).toLowerCase().includes("!important")?"important":"";i.style.setProperty(e,String(s[e]).replace(/\!important/i,""),t)})}),this;if(this[0]){let e=this[0].style;return"string"==typeof t?(i=e.getPropertyPriority(t),e.getPropertyValue(t)+(i?"!"+i:"")):Object.fromEntries(this[0].style.cssText.split(";").filter(e=>!!e).map(e=>e.split(":").map(e=>e.trim())))}}addClass(e){return this.toggleClass(e,!0),this}removeClass(e){return this.toggleClass(e,!1),this}toggleClass(t,s){return"string"==typeof t&&(t=t.split(/[,\s]+/)),this.each(i=>{let e=t;(e=null==e&&!1===s?Array.from(i.classList):e).forEach(t=>{if(""!==t){let e=null!=s?s?"add":"remove":"toggle";i.classList[e](t)}})}),this}hasClass(e){if(null==(e="string"==typeof e?e.split(/[,\s]+/):e)&&0<this.length)return Array.from(this[0].classList);let i=!1;return this.each(t=>{i=i||e.every(e=>Array.from(t.classList).includes(e))}),i}on(e,s,l){"function"==typeof s&&(l=s,s=void 0);let r;return s?.delegate&&(r=s.delegate,delete s.delegate),(e=e.split(/[,\s]+/)).forEach(e=>{let[t,i]=String(e).toLowerCase().split(".");if(r){let i=l;l=e=>{var t=query(e.target).parents(r);0<t.length?e.delegate=t[0]:e.delegate=e.target,(e.target.matches(r)||0<t.length)&&i(e)}}this.each(e=>{this._save(e,"events",[{event:t,scope:i,callback:l,options:s}]),e.addEventListener(t,l,s)})}),this}off(e,t,r){return"function"==typeof t&&(r=t,t=void 0),(e=e.split(/[,\s]+/)).forEach(e=>{let[s,l]=String(e).toLowerCase().split(".");this.each(t=>{if(Array.isArray(t._mQuery?.events))for(let e=t._mQuery.events.length-1;0<=e;e--){var i=t._mQuery.events[e];null==l||""===l?i.event!=s||i.scope!=l||i.callback!=r&&null!=r||(t.removeEventListener(s,i.callback,i.options),t._mQuery.events.splice(e,1)):i.event!=s&&""!==s||i.scope!=l&&"*"!==l||(t.removeEventListener(i.event,i.callback,i.options),t._mQuery.events.splice(e,1))}})}),this}trigger(e,t){let i;return i=e instanceof Event||e instanceof CustomEvent?e:new(["click","dblclick","mousedown","mouseup","mousemove"].includes(e)?MouseEvent:["keydown","keyup","keypress"].includes(e)?KeyboardEvent:Event)(e,t),this.each(e=>{e.dispatchEvent(i)}),this}attr(t,i){if(void 0===i&&"string"==typeof t)return this[0]?this[0].getAttribute(t):void 0;{let e={};return"object"==typeof t?e=t:e[t]=i,this.each(i=>{Object.entries(e).forEach(([e,t])=>{i.setAttribute(e,t)})}),this}}removeAttr(){return this.each(t=>{Array.from(arguments).forEach(e=>{t.removeAttribute(e)})}),this}prop(t,i){if(void 0===i&&"string"==typeof t)return this[0]?this[0][t]:void 0;{let e={};return"object"==typeof t?e=t:e[t]=i,this.each(i=>{Object.entries(e).forEach(([e,t])=>{i[e]=t})}),this}}removeProp(){return this.each(t=>{Array.from(arguments).forEach(e=>{delete t[e]})}),this}data(i,t){if(i instanceof Object)Object.entries(i).forEach(e=>{this.data(e[0],e[1])});else{if(i&&-1!=i.indexOf("-")&&console.error(`Key "${i}" contains "-" (dash). Dashes are not allowed in property names. Use camelCase instead.`),!(arguments.length<2))return this.each(e=>{null!=t?e.dataset[i]=t instanceof Object?JSON.stringify(t):t:delete e.dataset[i]}),this;if(this[0]){let t=Object.assign({},this[0].dataset);return Object.keys(t).forEach(e=>{if(t[e].startsWith("[")||t[e].startsWith("{"))try{t[e]=JSON.parse(t[e])}catch(e){}}),i?t[i]:t}}}removeData(e){return"string"==typeof e&&(e=e.split(/[,\s]+/)),this.each(t=>{e.forEach(e=>{delete t.dataset[e]})}),this}show(){return this.toggle(!0)}hide(){return this.toggle(!1)}toggle(l){return this.each(e=>{var t=e.style.display,i=getComputedStyle(e).display,s="none"==t||"none"==i;!s||null!=l&&!0!==l||(e.style.display=e._mQuery?.prevDisplay??(t==i?"":"block"),this._save(e,"prevDisplay",null)),s||null!=l&&!1!==l||("none"!=i&&this._save(e,"prevDisplay",i),e.style.setProperty("display","none"))})}empty(){return this.html("")}html(e){return this.prop("innerHTML",e)}text(e){return this.prop("textContent",e)}val(e){return this.prop("value",e)}change(){return this.trigger("change")}click(){return this.trigger("click")}}let query=function(e,t){if("function"!=typeof e)return new Query(e,t);"complete"==document.readyState?e():window.addEventListener("load",e)},w2ui=(query.html=e=>{e=Query._fragment(e);return query(e.children,e)},{});class Utils{constructor(){this.version="2.0.x",this.tmp={},this.settings=this.extend({},{dataType:"HTTPJSON",dateStartYear:1950,dateEndYear:2030,macButtonOrder:!1,warnNoPhrase:!1},w2locale,{phrases:null}),this.i18nCompare=Intl.Collator().compare,this.hasLocalStorage=function(){var e="w2ui_test";try{return localStorage.setItem(e,e),localStorage.removeItem(e),!0}catch(e){return!1}}(),this.isMac=/Mac/i.test(navigator.platform),this.isMobile=/(iphone|ipod|ipad|mobile|android)/i.test(navigator.userAgent),this.isIOS=/(iphone|ipod|ipad)/i.test(navigator.platform),this.isAndroid=/(android)/i.test(navigator.userAgent),this.isSafari=/^((?!chrome|android).)*safari/i.test(navigator.userAgent),this.formatters={number(e,t){return 20<parseInt(t)&&(t=20),parseInt(t)<0&&(t=0),null==e||""===e?"":w2utils.formatNumber(parseFloat(e),t,!0)},float(e,t){return w2utils.formatters.number(e,t)},int(e,t){return w2utils.formatters.number(e,0)},money(e,t){if(null==e||""===e)return"";e=w2utils.formatNumber(Number(e),w2utils.settings.currencyPrecision);return(w2utils.settings.currencyPrefix||"")+e+(w2utils.settings.currencySuffix||"")},currency(e,t){return w2utils.formatters.money(e,t)},percent(e,t){return null==e||""===e?"":w2utils.formatNumber(e,t||1)+"%"},size(e,t){return null==e||""===e?"":w2utils.formatSize(parseInt(e))},date(e,t){if(""===t&&(t=w2utils.settings.dateFormat),null==e||0===e||""===e)return"";let i=w2utils.isDateTime(e,t,!0);return'<span title="'+(i=!1===i?w2utils.isDate(e,t,!0):i)+'">'+w2utils.formatDate(i,t)+"</span>"},datetime(e,t){if(""===t&&(t=w2utils.settings.datetimeFormat),null==e||0===e||""===e)return"";let i=w2utils.isDateTime(e,t,!0);return'<span title="'+(i=!1===i?w2utils.isDate(e,t,!0):i)+'">'+w2utils.formatDateTime(i,t)+"</span>"},time(e,t){if(""===t&&(t=w2utils.settings.timeFormat),null==e||0===e||""===e)return"";let i=w2utils.isDateTime(e,t="h24"===(t="h12"===t?"hh:mi pm":t)?"h24:mi":t,!0);return'<span title="'+(i=!1===i?w2utils.isDate(e,t,!0):i)+'">'+w2utils.formatTime(e,t)+"</span>"},timestamp(e,t){if(""===t&&(t=w2utils.settings.datetimeFormat),null==e||0===e||""===e)return"";let i=w2utils.isDateTime(e,t,!0);return(i=!1===i?w2utils.isDate(e,t,!0):i).toString?i.toString():""},gmt(e,t){if(""===t&&(t=w2utils.settings.datetimeFormat),null==e||0===e||""===e)return"";let i=w2utils.isDateTime(e,t,!0);return(i=!1===i?w2utils.isDate(e,t,!0):i).toUTCString?i.toUTCString():""},age(e,t){if(null==e||0===e||""===e)return"";let i=w2utils.isDateTime(e,null,!0);return'<span title="'+(i=!1===i?w2utils.isDate(e,null,!0):i)+'">'+w2utils.age(e)+(t?" "+t:"")+"</span>"},interval(e,t){return null==e||0===e||""===e?"":w2utils.interval(e)+(t?" "+t:"")},toggle(e,t){return e?"Yes":""},password(t,e){let i="";for(let e=0;e<t.length;e++)i+="*";return i}}}isBin(e){return/^[0-1]+$/.test(e)}isInt(e){return/^[-+]?[0-9]+$/.test(e)}isFloat(e){return("number"==typeof(e="string"==typeof e?e.replace(this.settings.groupSymbol,"").replace(this.settings.decimalSymbol,"."):e)||"string"==typeof e&&""!==e)&&!isNaN(Number(e))}isMoney(e){if("object"==typeof e||""===e)return!1;if(this.isFloat(e))return!0;var t=this.settings;let i=new RegExp("^"+(t.currencyPrefix?"\\"+t.currencyPrefix+"?":"")+"[-+]?"+(t.currencyPrefix?"\\"+t.currencyPrefix+"?":"")+"[0-9]*[\\"+t.decimalSymbol+"]?[0-9]+"+(t.currencySuffix?"\\"+t.currencySuffix+"?":"")+"$","i");return"string"==typeof e&&(e=e.replace(new RegExp(t.groupSymbol,"g"),"")),i.test(e)}isHex(e){return/^(0x)?[0-9a-fA-F]+$/.test(e)}isAlphaNumeric(e){return/^[a-zA-Z0-9_-]+$/.test(e)}isEmail(e){return/^[a-zA-Z0-9._%\-+]+@[а-яА-Яa-zA-Z0-9.-]+\.[а-яА-Яa-zA-Z]+$/.test(e)}isIpAddress(e){let t=new RegExp("^((25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?).){3}(25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)$");return t.test(e)}isDate(i,e,t){if(!i)return!1;let s="Invalid Date",l,r,n;if(null==e&&(e=this.settings.dateFormat),"function"==typeof i.getFullYear)n=i.getFullYear(),l=i.getMonth()+1,r=i.getDate();else if(parseInt(i)==i&&0<parseInt(i))i=new Date(parseInt(i)),n=i.getFullYear(),l=i.getMonth()+1,r=i.getDate();else{if(i=String(i),new RegExp("mon","ig").test(e)){e=e.replace(/month/gi,"m").replace(/mon/gi,"m").replace(/dd/gi,"d").replace(/[, ]/gi,"/").replace(/\/\//g,"/").toLowerCase(),i=i.replace(/[, ]/gi,"/").replace(/\/\//g,"/").toLowerCase();for(let t=0,e=this.settings.fullmonths.length;t<e;t++){let e=this.settings.fullmonths[t];i=i.replace(new RegExp(e,"ig"),parseInt(t)+1).replace(new RegExp(e.substr(0,3),"ig"),parseInt(t)+1)}}var a=i.replace(/-/g,"/").replace(/\./g,"/").toLowerCase().split("/"),e=e.replace(/-/g,"/").replace(/\./g,"/").toLowerCase();"mm/dd/yyyy"===e&&(l=a[0],r=a[1],n=a[2]),"m/d/yyyy"===e&&(l=a[0],r=a[1],n=a[2]),"dd/mm/yyyy"===e&&(l=a[1],r=a[0],n=a[2]),"d/m/yyyy"===e&&(l=a[1],r=a[0],n=a[2]),"yyyy/dd/mm"===e&&(l=a[2],r=a[1],n=a[0]),"yyyy/d/m"===e&&(l=a[2],r=a[1],n=a[0]),"yyyy/mm/dd"===e&&(l=a[1],r=a[2],n=a[0]),"yyyy/m/d"===e&&(l=a[1],r=a[2],n=a[0]),"mm/dd/yy"===e&&(l=a[0],r=a[1],n=a[2]),"m/d/yy"===e&&(l=a[0],r=a[1],n=parseInt(a[2])+1900),"dd/mm/yy"===e&&(l=a[1],r=a[0],n=parseInt(a[2])+1900),"d/m/yy"===e&&(l=a[1],r=a[0],n=parseInt(a[2])+1900),"yy/dd/mm"===e&&(l=a[2],r=a[1],n=parseInt(a[0])+1900),"yy/d/m"===e&&(l=a[2],r=a[1],n=parseInt(a[0])+1900),"yy/mm/dd"===e&&(l=a[1],r=a[2],n=parseInt(a[0])+1900),"yy/m/d"===e&&(l=a[1],r=a[2],n=parseInt(a[0])+1900)}return!!this.isInt(n)&&(!!this.isInt(l)&&(!!this.isInt(r)&&(n=+n,l=+l,r=+r,(s=new Date(n,l-1,r)).setFullYear(n),null!=l&&("Invalid Date"!==String(s)&&(s.getMonth()+1===l&&s.getDate()===r&&s.getFullYear()===n&&(!0!==t||s))))))}isTime(e,t){if(null==e)return!1;let i,s,l;s=0<=(e=(e=String(e)).toUpperCase()).indexOf("AM");var r=(l=0<=e.indexOf("PM"))||s,e=(i=r?12:24,(e=e.replace("AM","").replace("PM","").trim()).split(":"));let n=parseInt(e[0]||0),a=parseInt(e[1]||0),o=parseInt(e[2]||0);return(r&&1===e.length||2===e.length||3===e.length)&&(!(""===e[0]||n<0||n>i||!this.isInt(e[0])||2<e[0].length)&&(!(1<e.length&&(""===e[1]||a<0||59<a||!this.isInt(e[1])||2!==e[1].length))&&(!(2<e.length&&(""===e[2]||o<0||59<o||!this.isInt(e[2])||2!==e[2].length))&&((r||i!==n||0===a&&0===o)&&((!r||1!==e.length||0!==n)&&(!0!==t||(l&&12!==n&&(n+=12),s&&12===n&&(n+=12),{hours:n,minutes:a,seconds:o})))))))}isDateTime(i,s,l){if("function"==typeof i.getFullYear)return!0!==l||i;var r=parseInt(i);if(r===i)return!(r<0)&&(!0!==l||new Date(r));r=String(i).indexOf(" ");if(r<0)return!(String(i).indexOf("T")<0||"Invalid Date"==String(new Date(i)))&&(!0!==l||new Date(i));{let e=(s=null==s?this.settings.datetimeFormat:s).split("|");s=[i.substr(0,r),i.substr(r).trim()];e[0]=e[0].trim(),e[1]&&(e[1]=e[1].trim());let t=this.isDate(s[0],e[0],!0);i=this.isTime(s[1],!0);return!1!==t&&!1!==i&&(!0!==l||(t.setHours(i.hours),t.setMinutes(i.minutes),t.setSeconds(i.seconds),t))}}age(e){let t;if(""===e||null==e)return"";if(t="function"==typeof e.getFullYear?e:parseInt(e)==e&&0<parseInt(e)?new Date(parseInt(e)):new Date(e),"Invalid Date"===String(t))return"";let i=new Date;e=(i.getTime()-t.getTime())/1e3;let s="",l="";return e<0?(s=0,l="sec"):e<60?(s=Math.floor(e),l="sec",e<0&&(s=0,l="sec")):e<3600?(s=Math.floor(e/60),l="min"):e<86400?(s=Math.floor(e/60/60),l="hour"):e<2592e3?(s=Math.floor(e/24/60/60),l="day"):e<31536e3?(s=Math.floor(e/30/24/60/60*10)/10,l="month"):e<126144e3?(s=Math.floor(e/365/24/60/60*10)/10,l="year"):126144e3<=e&&(s=Math.floor(e/365.25/24/60/60*10)/10,l="year"),s+" "+l+(1<s?"s":"")}interval(e){let t="";return t=e<100?"< 0.01 sec":e<1e3?Math.floor(e/10)/100+" sec":e<1e4?Math.floor(e/100)/10+" sec":e<6e4?Math.floor(e/1e3)+" secs":e<36e5?Math.floor(e/6e4)+" mins":e<864e5?Math.floor(e/36e5*10)/10+" hours":e<2628e6?Math.floor(e/864e5*10)/10+" days":e<31536e6?Math.floor(e/2628e6*10)/10+" months":Math.floor(e/31536e5)/10+" years"}date(e){if(""===e||null==e||"object"==typeof e&&!e.getMonth)return"";let t=new Date(e);if(this.isInt(e)&&(t=new Date(Number(e))),"Invalid Date"===String(t))return"";e=this.settings.shortmonths;let i=new Date,s=new Date;s.setTime(s.getTime()-864e5);var l=e[t.getMonth()]+" "+t.getDate()+", "+t.getFullYear(),r=e[i.getMonth()]+" "+i.getDate()+", "+i.getFullYear(),e=e[s.getMonth()]+" "+s.getDate()+", "+s.getFullYear(),n=t.getHours()-(12<t.getHours()?12:0)+":"+(t.getMinutes()<10?"0":"")+t.getMinutes()+" "+(12<=t.getHours()?"pm":"am");let a=l==r?n:l;return'<span title="'+l+" "+(t.getHours()-(12<t.getHours()?12:0)+":"+(t.getMinutes()<10?"0":"")+t.getMinutes()+":"+(t.getSeconds()<10?"0":"")+t.getSeconds()+" "+(12<=t.getHours()?"pm":"am"))+'">'+(a=l==e?this.lang("Yesterday"):a)+"</span>"}formatSize(e){if(!this.isFloat(e)||""===e)return"";if(0===(e=parseFloat(e)))return 0;var t=parseInt(Math.floor(Math.log(e)/Math.log(1024)));return(Math.floor(e/Math.pow(1024,t)*10)/10).toFixed(0===t?0:1)+" "+(["Bt","KB","MB","GB","TB","PB","EB","ZB"][t]||"??")}formatNumber(e,t,i){if(null==e||""===e||"object"==typeof e)return"";let s={minimumFractionDigits:t,maximumFractionDigits:t,useGrouping:i};return(null==t||t<0)&&(s.minimumFractionDigits=0,s.maximumFractionDigits=20),parseFloat(e).toLocaleString(this.settings.locale,s)}formatDate(e,t){if(t=t||this.settings.dateFormat,""===e||null==e||"object"==typeof e&&!e.getMonth)return"";let i=new Date(e);if(this.isInt(e)&&(i=new Date(Number(e))),"Invalid Date"===String(i))return"";var e=i.getFullYear(),s=i.getMonth(),l=i.getDate();return t.toLowerCase().replace("month",this.settings.fullmonths[s]).replace("mon",this.settings.shortmonths[s]).replace(/yyyy/g,("000"+e).slice(-4)).replace(/yyy/g,("000"+e).slice(-4)).replace(/yy/g,("0"+e).slice(-2)).replace(/(^|[^a-z$])y/g,"$1"+e).replace(/mm/g,("0"+(s+1)).slice(-2)).replace(/dd/g,("0"+l).slice(-2)).replace(/th/g,1==l?"st":"th").replace(/th/g,2==l?"nd":"th").replace(/th/g,3==l?"rd":"th").replace(/(^|[^a-z$])m/g,"$1"+(s+1)).replace(/(^|[^a-z$])d/g,"$1"+l)}formatTime(e,t){if(t=t||this.settings.timeFormat,""===e||null==e||"object"==typeof e&&!e.getMonth)return"";let i=new Date(e);if(this.isInt(e)&&(i=new Date(Number(e))),this.isTime(e)&&(e=this.isTime(e,!0),(i=new Date).setHours(e.hours),i.setMinutes(e.minutes)),"Invalid Date"===String(i))return"";let s="am",l=i.getHours();e=i.getHours();let r=i.getMinutes(),n=i.getSeconds();return r<10&&(r="0"+r),n<10&&(n="0"+n),-1===t.indexOf("am")&&-1===t.indexOf("pm")||(12<=l&&(s="pm"),12<l&&(l-=12),0===l&&(l=12)),t.toLowerCase().replace("am",s).replace("pm",s).replace("hhh",l<10?"0"+l:l).replace("hh24",e<10?"0"+e:e).replace("h24",e).replace("hh",l).replace("mm",r).replace("mi",r).replace("ss",n).replace(/(^|[^a-z$])h/g,"$1"+l).replace(/(^|[^a-z$])m/g,"$1"+r).replace(/(^|[^a-z$])s/g,"$1"+n)}formatDateTime(e,t){let i;return""===e||null==e||"object"==typeof e&&!e.getMonth?"":("string"!=typeof t?i=[this.settings.dateFormat,this.settings.timeFormat]:((i=t.split("|"))[0]=i[0].trim(),i[1]=1<i.length?i[1].trim():this.settings.timeFormat),"h12"===i[1]&&(i[1]="h:m pm"),"h24"===i[1]&&(i[1]="h24:m"),this.formatDate(e,i[0])+" "+this.formatTime(e,i[1]))}stripSpaces(i){if(null==i)return i;switch(typeof i){case"number":break;case"string":i=String(i).replace(/(?:\r\n|\r|\n)/g," ").replace(/\s\s+/g," ").trim();break;case"object":Array.isArray(i)?(i=this.extend([],i)).forEach((e,t)=>{i[t]=this.stripSpaces(e)}):(i=this.extend({},i),Object.keys(i).forEach(e=>{i[e]=this.stripSpaces(i[e])}))}return i}stripTags(i){if(null==i)return i;switch(typeof i){case"number":break;case"string":i=String(i).replace(/<(?:[^>=]|='[^']*'|="[^"]*"|=[^'"][^\s>]*)*>/gi,"");break;case"object":Array.isArray(i)?(i=this.extend([],i)).forEach((e,t)=>{i[t]=this.stripTags(e)}):(i=this.extend({},i),Object.keys(i).forEach(e=>{i[e]=this.stripTags(i[e])}))}return i}encodeTags(i){if(null==i)return i;switch(typeof i){case"number":break;case"string":i=String(i).replace(/&/g,"&amp;").replace(/>/g,"&gt;").replace(/</g,"&lt;").replace(/"/g,"&quot;");break;case"object":Array.isArray(i)?(i=this.extend([],i)).forEach((e,t)=>{i[t]=this.encodeTags(e)}):(i=this.extend({},i),Object.keys(i).forEach(e=>{i[e]=this.encodeTags(i[e])}))}return i}decodeTags(i){if(null==i)return i;switch(typeof i){case"number":break;case"string":i=String(i).replace(/&gt;/g,">").replace(/&lt;/g,"<").replace(/&quot;/g,'"').replace(/&amp;/g,"&");break;case"object":Array.isArray(i)?(i=this.extend([],i)).forEach((e,t)=>{i[t]=this.decodeTags(e)}):(i=this.extend({},i),Object.keys(i).forEach(e=>{i[e]=this.decodeTags(i[e])}))}return i}escapeId(e){if(""===e||null==e)return"";return(e+"").replace(/([\0-\x1f\x7f]|^-?\d)|^-$|[^\0-\x1f\x7f-\uFFFF\w-]/g,(e,t)=>t?"\0"===e?"�":e.slice(0,-1)+"\\"+e.charCodeAt(e.length-1).toString(16)+" ":"\\"+e)}unescapeId(e){if(""===e||null==e)return"";return e.replace(/\\[\da-fA-F]{1,6}[\x20\t\r\n\f]?|\\([^\r\n\f])/g,(e,t)=>{e="0x"+e.slice(1)-65536;return t||(e<0?String.fromCharCode(65536+e):String.fromCharCode(e>>10|55296,1023&e|56320))})}base64encode(e){let t="",i,s,l,r,n,a,o,h=0;var d="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=";for(e=function(t){t=String(t).replace(/\r\n/g,"\n");let i="";for(let e=0;e<t.length;e++){var s=t.charCodeAt(e);s<128?i+=String.fromCharCode(s):i=127<s&&s<2048?(i+=String.fromCharCode(s>>6|192))+String.fromCharCode(63&s|128):(i=(i+=String.fromCharCode(s>>12|224))+String.fromCharCode(s>>6&63|128))+String.fromCharCode(63&s|128)}return i}(e);h<e.length;)i=e.charCodeAt(h++),s=e.charCodeAt(h++),l=e.charCodeAt(h++),r=i>>2,n=(3&i)<<4|s>>4,a=(15&s)<<2|l>>6,o=63&l,isNaN(s)?a=o=64:isNaN(l)&&(o=64),t=t+d.charAt(r)+d.charAt(n)+d.charAt(a)+d.charAt(o);return t}base64decode(e){let t="";var i,s,l,r,n,a;let o=0;var h="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=";for(e=e.replace(/[^A-Za-z0-9\+\/\=]/g,"");o<e.length;)l=h.indexOf(e.charAt(o++)),i=(15&(r=h.indexOf(e.charAt(o++))))<<4|(n=h.indexOf(e.charAt(o++)))>>2,s=(3&n)<<6|(a=h.indexOf(e.charAt(o++))),t+=String.fromCharCode(l<<2|r>>4),64!==n&&(t+=String.fromCharCode(i)),64!==a&&(t+=String.fromCharCode(s));return t=function(e){let t="",i=0,s=0,l,r;for(;i<e.length;)(s=e.charCodeAt(i))<128?(t+=String.fromCharCode(s),i++):191<s&&s<224?(l=e.charCodeAt(i+1),t+=String.fromCharCode((31&s)<<6|63&l),i+=2):(l=e.charCodeAt(i+1),r=e.charCodeAt(i+2),t+=String.fromCharCode((15&s)<<12|(63&l)<<6|63&r),i+=3);return t}(t)}async sha256(e){e=(new TextEncoder).encode(e);return crypto.subtle.digest("SHA-256",e).then(e=>{const t=Array.from(new Uint8Array(e));return t.map(e=>e.toString(16).padStart(2,"0")).join("")})}transition(r,n,a,o){return new Promise((e,t)=>{let i=r.computedStyleMap(),s=i.get("width").value,l=i.get("height").value;if(r&&n){switch(r.parentNode.style.cssText+="perspective: 900px; overflow: hidden;",r.style.cssText+="; position: absolute; z-index: 1019; backface-visibility: hidden",n.style.cssText+="; position: absolute; z-index: 1020; backface-visibility: hidden",a){case"slide-left":r.style.cssText+="overflow: hidden; transform: translate3d(0, 0, 0)",n.style.cssText+="overflow: hidden; transform: translate3d("+s+"px, 0, 0)",query(n).show(),setTimeout(()=>{n.style.cssText+="transition: 0.5s; transform: translate3d(0, 0, 0)",r.style.cssText+="transition: 0.5s; transform: translate3d(-"+s+"px, 0, 0)"},1);break;case"slide-right":r.style.cssText+="overflow: hidden; transform: translate3d(0, 0, 0)",n.style.cssText+="overflow: hidden; transform: translate3d(-"+s+"px, 0, 0)",query(n).show(),setTimeout(()=>{n.style.cssText+="transition: 0.5s; transform: translate3d(0px, 0, 0)",r.style.cssText+="transition: 0.5s; transform: translate3d("+s+"px, 0, 0)"},1);break;case"slide-down":r.style.cssText+="overflow: hidden; z-index: 1; transform: translate3d(0, 0, 0)",n.style.cssText+="overflow: hidden; z-index: 0; transform: translate3d(0, 0, 0)",query(n).show(),setTimeout(()=>{n.style.cssText+="transition: 0.5s; transform: translate3d(0, 0, 0)",r.style.cssText+="transition: 0.5s; transform: translate3d(0, "+l+"px, 0)"},1);break;case"slide-up":r.style.cssText+="overflow: hidden; transform: translate3d(0, 0, 0)",n.style.cssText+="overflow: hidden; transform: translate3d(0, "+l+"px, 0)",query(n).show(),setTimeout(()=>{n.style.cssText+="transition: 0.5s; transform: translate3d(0, 0, 0)",r.style.cssText+="transition: 0.5s; transform: translate3d(0, 0, 0)"},1);break;case"flip-left":r.style.cssText+="overflow: hidden; transform: rotateY(0deg)",n.style.cssText+="overflow: hidden; transform: rotateY(-180deg)",query(n).show(),setTimeout(()=>{n.style.cssText+="transition: 0.5s; transform: rotateY(0deg)",r.style.cssText+="transition: 0.5s; transform: rotateY(180deg)"},1);break;case"flip-right":r.style.cssText+="overflow: hidden; transform: rotateY(0deg)",n.style.cssText+="overflow: hidden; transform: rotateY(180deg)",query(n).show(),setTimeout(()=>{n.style.cssText+="transition: 0.5s; transform: rotateY(0deg)",r.style.cssText+="transition: 0.5s; transform: rotateY(-180deg)"},1);break;case"flip-down":r.style.cssText+="overflow: hidden; transform: rotateX(0deg)",n.style.cssText+="overflow: hidden; transform: rotateX(180deg)",query(n).show(),setTimeout(()=>{n.style.cssText+="transition: 0.5s; transform: rotateX(0deg)",r.style.cssText+="transition: 0.5s; transform: rotateX(-180deg)"},1);break;case"flip-up":r.style.cssText+="overflow: hidden; transform: rotateX(0deg)",n.style.cssText+="overflow: hidden; transform: rotateX(-180deg)",query(n).show(),setTimeout(()=>{n.style.cssText+="transition: 0.5s; transform: rotateX(0deg)",r.style.cssText+="transition: 0.5s; transform: rotateX(180deg)"},1);break;case"pop-in":r.style.cssText+="overflow: hidden; transform: translate3d(0, 0, 0)",n.style.cssText+="overflow: hidden; transform: translate3d(0, 0, 0); transform: scale(.8); opacity: 0;",query(n).show(),setTimeout(()=>{n.style.cssText+="transition: 0.5s; transform: scale(1); opacity: 1;",r.style.cssText+="transition: 0.5s;"},1);break;case"pop-out":r.style.cssText+="overflow: hidden; transform: translate3d(0, 0, 0); transform: scale(1); opacity: 1;",n.style.cssText+="overflow: hidden; transform: translate3d(0, 0, 0); opacity: 0;",query(n).show(),setTimeout(()=>{n.style.cssText+="transition: 0.5s; opacity: 1;",r.style.cssText+="transition: 0.5s; transform: scale(1.7); opacity: 0;"},1);break;default:r.style.cssText+="overflow: hidden; transform: translate3d(0, 0, 0)",n.style.cssText+="overflow: hidden; translate3d(0, 0, 0); opacity: 0;",query(n).show(),setTimeout(()=>{n.style.cssText+="transition: 0.5s; opacity: 1;",r.style.cssText+="transition: 0.5s"},1)}setTimeout(()=>{"slide-down"===a&&(query(r).css("z-index","1019"),query(n).css("z-index","1020")),n&&query(n).css({opacity:"1"}).css({transition:"",transform:""}),r&&query(r).css({opacity:"1"}).css({transition:"",transform:""}),"function"==typeof o&&o(),e()},500)}else console.log("ERROR: Cannot do transition when one of the divs is null")})}lock(s,l={}){if(null!=s){"string"==typeof l&&(l={msg:l}),arguments[2]&&(l.spinner=arguments[2]),l=this.extend({spinner:!1},l),s&&!(s instanceof HTMLElement)&&s[0]instanceof HTMLElement&&(s=Array.isArray(s)?s:s.get()),l.msg||0===l.msg||(l.msg=""),this.unlock(s),query(s).prepend('<div class="w2ui-lock"></div><div class="w2ui-lock-msg"></div>');let e=query(s).find(".w2ui-lock"),t=query(s).find(".w2ui-lock-msg"),i=(l.msg||t.css({"background-color":"transparent","background-image":"none",border:"0px","box-shadow":"none"}),!0===l.spinner&&(l.msg=`<div class="w2ui-spinner" ${l.msg?"":'style="width: 35px; height: 35px"'}></div>`+l.msg),l.msg?t.html(l.msg).css("display","block"):t.remove(),null!=l.opacity&&e.css("opacity",l.opacity),e.css({display:"block"}),l.bgColor&&e.css({"background-color":l.bgColor}),e.css("opacity")||.3);e.on("mousedown",function(){"function"==typeof l.onClick?l.onClick():e.css({transition:".2s",opacity:1.5*i})}).on("mouseup",function(){"function"!=typeof l.onClick&&e.css({transition:".2s",opacity:i})}).on("mousewheel",function(e){e&&(e.stopPropagation(),e.preventDefault())})}}unlock(e,t){null!=e&&(e&&!(e instanceof HTMLElement)&&e[0]instanceof HTMLElement&&(e=Array.isArray(e)?e:e.get()),this.isInt(t)?(query(e).find(".w2ui-lock").css({transition:t/1e3+"s",opacity:0}),query(e).find(".w2ui-lock-msg").remove(),setTimeout(()=>{query(e).find(".w2ui-lock").remove()},t)):(query(e).find(".w2ui-lock").remove(),query(e).find(".w2ui-lock-msg").remove()))}message(r,n){let i,a,o;if("object"!=typeof(n="string"==typeof n?{width:n.length<300?350:550,height:n.length<300?170:250,text:n}:n))u();else{null!=n.text&&(n.body=`<div class="w2ui-centered w2ui-msg-text">${n.text}</div>`),null==n.width&&(n.width=350),null==n.height&&(n.height=170),null==n.hideOn&&(n.hideOn=["esc"]),null==n.on&&(h=n,n=new w2base,w2utils.extend(n,h)),n.on("open",e=>{w2utils.bindEvents(query(n.box).find(".w2ui-eaction"),n),query(e.detail.box).find("button, input, textarea, [name=hidden-first]").off(".message").on("keydown.message",function(e){27==e.keyCode&&n.hideOn.includes("esc")&&(n.cancelAction?n.action(n.cancelAction):n.close())}),n.setFocus(n.focus)}),n.off(".prom");let s={self:n,action(e){return n.on("action.prom",e),s},close(e){return n.on("close.prom",e),s},then(e){return n.on("open:after.prom",e),s}},e=(null==n.actions&&null==n.buttons&&null==n.html&&(n.actions={Ok(e){e.detail.self.close()}}),n.off(".buttons"),null!=n.actions&&(n.buttons="",Object.keys(n.actions).forEach(e=>{var t=n.actions[e];let i=e;"function"==typeof t&&(n.buttons+=`<button class="w2ui-btn w2ui-eaction" data-click='["action","${e}","event"]'>${e}</button>`),"object"==typeof t&&(n.buttons+=`<button class="w2ui-btn w2ui-eaction ${t.class||""}" data-click='["action","${e}","event"]'
            ...
            `),getComputedStyle(r.box));var h=parseFloat(e.width),d=parseFloat(e.height);let t=0,l=(r.after&&(e=getComputedStyle(query(r.after).get(0)),t=parseInt("none"!=e.display?parseInt(e.height):0)),n.width>h&&(n.width=h-10),n.height>d-t&&(n.height=d-10-t),n.originalWidth=n.width,n.originalHeight=n.height,parseInt(n.width)<0&&(n.width=h+n.width),parseInt(n.width)<10&&(n.width=10),parseInt(n.height)<0&&(n.height=d+n.height-t),parseInt(n.height)<10&&(n.height=10),n.originalHeight<0&&(n.height=d+n.originalHeight-t),n.originalWidth<0&&(n.width=h+2*n.originalWidth),query(r.box).find(r.after));return n.tmp||(n.tmp={zIndex:l.css("z-index"),overflow:e.overflow}),""===n.html&&""===n.body&&""===n.buttons?u():(n.msgIndex=query(r.box).find(".w2ui-message").length,0===n.msgIndex&&"function"==typeof this.lock&&(query(r.box).css("overflow","hidden"),r.owner?r.owner.lock(r.param):this.lock(r.box)),query(r.box).find(".w2ui-message").css("z-index",1390),l.css("z-index",1501),d=`
        ...
        `),this.tmp.scrollBarSize=100-query("#_scrollbar_width > div")[0].clientWidth,query("#_scrollbar_width").remove(),this.tmp.scrollBarSize}checkName(e){return null==e?(console.log('ERROR: Property "name" is required but not supplied.'),!1):null!=w2ui[e]?(console.log(`ERROR: Object named "${e}" is already registered as w2ui.${e}.`),!1):!!this.isAlphaNumeric(e)||(console.log('ERROR: Property "name" has to be alpha-numeric (a-z, 0-9, dash and underscore).'),!1)}checkUniqueId(t,i,s,l){Array.isArray(i)||(i=[i]);let r=!0;return i.forEach(e=>{e.id===t&&(console.log(`ERROR: The item id="${t}" is not unique within the ${s} "${l}".`,i),r=!1)}),r}encodeParams(t,i=""){let s="";return Object.keys(t).forEach(e=>{""!=s&&(s+="&"),"object"==typeof t[e]?s+=this.encodeParams(t[e],i+e+(i?"]":"")+"["):s+=""+i+e+(i?"]":"")+"="+t[e]}),s}parseRoute(e){let n=[];e=e.replace(/\/\(/g,"(?:/").replace(/\+/g,"__plus__").replace(/(\/)?(\.)?:(\w+)(?:(\(.*?\)))?(\?)?/g,(e,t,i,s,l,r)=>(n.push({name:s,optional:!!r}),t=t||"",(r?"":t)+"(?:"+(r?t:"")+(i||"")+(l||(i?"([^/.]+?)":"([^/]+?)"))+")"+(r||""))).replace(/([\/.])/g,"\\$1").replace(/__plus__/g,"(.+)").replace(/\*/g,"(.*)");return{path:new RegExp("^"+e+"$","i"),keys:n}}cssPrefix(e,t,i){let s={},l={},r="";for(var n in e instanceof Object?(s=e,!0===t&&(i=!0)):s[e]=t,s)l[n]=s[n],l["-webkit-"+n]=s[n],l["-moz-"+n]=s[n].replace("-webkit-","-moz-"),l["-ms-"+n]=s[n].replace("-webkit-","-ms-"),l["-o-"+n]=s[n].replace("-webkit-","-o-");if(!0===i)for(var a in l)r+=a+": "+l[a]+"; ";else r=l;return r}getCursorPosition(i){if(null==i)return null;let s=0,t=i.ownerDocument||i.document,e=t.defaultView||t.parentWindow,l;if(["INPUT","TEXTAREA"].includes(i.tagName))s=i.selectionStart;else if(e.getSelection){if(0<(l=e.getSelection()).rangeCount){let e=l.getRangeAt(0),t=e.cloneRange();t.selectNodeContents(i),t.setEnd(e.endContainer,e.endOffset),s=t.toString().length}}else if((l=t.selection)&&"Control"!==l.type){var r=l.createRange();let e=t.body.createTextRange();e.moveToElementText(i),e.setEndPoint("EndToEnd",r),s=e.text.length}return s}setCursorPosition(s,l,r){if(null!=s){let e=document.createRange(),i,t=window.getSelection();if(["INPUT","TEXTAREA"].includes(s.tagName))s.setSelectionRange(l,r??l);else{for(let t=0;t<s.childNodes.length;t++){let e=query(s.childNodes[t]).text();if(l<=(e=s.childNodes[t].tagName?(e=query(s.childNodes[t]).html()).replace(/&lt;/g,"<").replace(/&gt;/g,">").replace(/&amp;/g,"&").replace(/&quot;/g,'"').replace(/&nbsp;/g," "):e).length){(i=(i=s.childNodes[t]).childNodes&&0<i.childNodes.length?i.childNodes[0]:i).childNodes&&0<i.childNodes.length&&(i=i.childNodes[0]);break}l-=e.length}null!=i&&(l>i.length&&(l=i.length),e.setStart(i,l),r?e.setEnd(i,r):e.collapse(!0),t.removeAllRanges(),t.addRange(e))}}}parseColor(e){if("string"!=typeof e)return null;let t={};if(3===(e="#"===(e=e.trim().toUpperCase())[0]?e.substr(1):e).length)t={r:parseInt(e[0]+e[0],16),g:parseInt(e[1]+e[1],16),b:parseInt(e[2]+e[2],16),a:1};else if(6===e.length)t={r:parseInt(e.substr(0,2),16),g:parseInt(e.substr(2,2),16),b:parseInt(e.substr(4,2),16),a:1};else if(8===e.length)t={r:parseInt(e.substr(0,2),16),g:parseInt(e.substr(2,2),16),b:parseInt(e.substr(4,2),16),a:Math.round(parseInt(e.substr(6,2),16)/255*100)/100};else if(4<e.length&&"RGB("===e.substr(0,4)){var i=e.replace("RGB","").replace(/\(/g,"").replace(/\)/g,"").split(",");t={r:parseInt(i[0],10),g:parseInt(i[1],10),b:parseInt(i[2],10),a:1}}else{if(!(5<e.length&&"RGBA("===e.substr(0,5)))return null;i=e.replace("RGBA","").replace(/\(/g,"").replace(/\)/g,"").split(",");t={r:parseInt(i[0],10),g:parseInt(i[1],10),b:parseInt(i[2],10),a:parseFloat(i[3])}}return t}hsv2rgb(e,t,i,s){let l,r,n,a,o,h,d,u;switch(1===arguments.length&&(t=e.s,i=e.v,s=e.a,e=e.h),h=(i/=100)*(1-(t/=100)),d=i*(1-(o=6*(e/=360)-(a=Math.floor(6*e)))*t),u=i*(1-(1-o)*t),a%6){case 0:l=i,r=u,n=h;break;case 1:l=d,r=i,n=h;break;case 2:l=h,r=i,n=u;break;case 3:l=h,r=d,n=i;break;case 4:l=u,r=h,n=i;break;case 5:l=i,r=h,n=d}return{r:Math.round(255*l),g:Math.round(255*r),b:Math.round(255*n),a:null!=s?s:1}}rgb2hsv(e,t,i,s){1===arguments.length&&(t=e.g,i=e.b,s=e.a,e=e.r);let l=Math.max(e,t,i),r=Math.min(e,t,i),n=l-r,a,o=0===l?0:n/l,h=l/255;switch(l){case r:a=0;break;case e:a=t-i+n*(t<i?6:0),a/=6*n;break;case t:a=i-e+2*n,a/=6*n;break;case i:a=e-t+4*n,a/=6*n}return{h:Math.round(360*a),s:Math.round(100*o),v:Math.round(100*h),a:null!=s?s:1}}tooltip(e,t){let i="mouseenter",s="mouseleave";return t=(t="object"==typeof e?e:t)||{},"string"==typeof e&&(t.html=e),t.showOn&&(i=t.showOn,delete t.showOn),t.hideOn&&(s=t.hideOn,delete t.hideOn),t.name||(t.name="no-name"),` on${i}="w2tooltip.show(this, `+`JSON.parse(w2utils.base64decode('${this.base64encode(JSON.stringify(t))}')))" `+`on${s}="w2tooltip.hide('${t.name}')"`}isPlainObject(e){if(null==e)return!1;if("[object Object]"!==Object.prototype.toString.call(e))return!1;if(void 0===e.constructor)return!0;e=Object.getPrototypeOf(e);return null===e||e===Object.prototype}clone(e,t={functions:!0,elements:!0}){let i;return Array.isArray(e)?(i=Array.from(e)).forEach((e,t)=>{i[t]=this.clone(e)}):this.isPlainObject(e)?(i={},Object.assign(i,e),Object.keys(i).forEach(e=>{i[e]=this.clone(i[e])})):"function"==typeof e&&!t.functions||e instanceof HTMLElement&&!t.elements||(i=e),i}extend(i,s){if(Array.isArray(i)){if(!Array.isArray(s))throw new Error("Arrays can be extended with arrays only");s.forEach(e=>{i.push(this.clone(e))})}else if(i&&"object"==typeof i&&null!=s){if("object"!=typeof s)throw new Error("Object can be extended with other objects only.");Object.keys(s).forEach(e=>{var t;null!=i[e]&&"object"==typeof i[e]&&null!=s[e]&&"object"==typeof s[e]?(t=this.clone(s[e]),Array.isArray(i[e])&&this.isPlainObject(t)&&(i[e]={}),this.extend(i[e],t)):i[e]=this.clone(s[e])})}else if(null!=s)throw new Error("Object is not extendable, only {} or [] can be extended.");if(2<arguments.length)for(let e=2;e<arguments.length;e++)this.extend(i,arguments[e]);return i}naturalCompare(e,t){let s,i,l=1,r=0,n=0,a=String.alphabet;function o(e,t,i){if(i){for(s=t;(i=o(e,s))<76&&65<i;)++s;return+e.slice(t-1,s)}return-1<(i=a&&a.indexOf(e.charAt(t)))?i+76:(i=e.charCodeAt(t)||0)<45||127<i?i:i<46?65:i<48?i-1:i<58?i+18:i<65?i-11:i<91?i+11:i<97?i-37:i<123?i+5:i-63}if((e+="")!=(t+=""))for(;l;)if(i=o(e,r++),l=o(t,n++),i<76&&l<76&&66<i&&66<l&&(i=o(e,r,r),l=o(t,n,r=s),n=s),i!=l)return i<l?-1:1;return 0}normMenu(i,e){return Array.isArray(i)?(i.forEach((e,t)=>{"string"==typeof e||"number"==typeof e?i[t]={id:e,text:e}:null!=e?(null!=e.caption&&null==e.text&&(e.text=e.caption),null!=e.text&&null==e.id&&(e.id=e.text),null==e.text&&null!=e.id&&(e.text=e.id)):i[t]={id:null,text:"null"}}),i):"function"==typeof i?(e=i.call(this,i,e),w2utils.normMenu.call(this,e)):"object"==typeof i?Object.keys(i).map(e=>({id:e,text:i[e]})):void 0}bindEvents(e,r){0!=e.length&&(e&&!(e instanceof HTMLElement)&&e[0]instanceof HTMLElement&&(e=Array.isArray(e)?e:e.get()),query(e).each(s=>{let l=query(s).data();Object.keys(l).forEach(i=>{if(-1!=["click","dblclick","mouseenter","mouseleave","mouseover","mouseout","mousedown","mousemove","mouseup","contextmenu","focus","focusin","focusout","blur","input","change","keydown","keyup","keypress"].indexOf(String(i).toLowerCase())){let e=l[i],t=(e="string"==typeof e?e.split("|").map(e=>("null"===(e="undefined"===(e="false"===(e="true"===e?!0:e)?!1:e)?void 0:e)&&(e=null),parseFloat(e)==e&&(e=parseFloat(e)),e=["'",'"',"`"].includes(e[0])&&["'",'"',"`"].includes(e[e.length-1])?e.substring(1,e.length-1):e)):e)[0];e=e.slice(1),query(s).off(i+".w2utils-bind").on(i+".w2utils-bind",function(i){switch(t){case"alert":alert(e[0]);break;case"stop":i.stopPropagation();break;case"prevent":i.preventDefault();break;case"stopPrevent":return i.stopPropagation(),i.preventDefault(),!1;default:if(null==r[t])throw new Error(`Cannot dispatch event as the method "${t}" does not exist.`);r[t].apply(r,e.map((e,t)=>{switch(String(e).toLowerCase()){case"event":return i;case"this":return this;default:return e}}))}})}})}))}}var w2utils=new Utils;class Dialog extends w2base{constructor(){super(),this.defaults={title:"",text:"",body:"",buttons:"",width:450,height:250,focus:null,actions:null,style:"",speed:.3,modal:!1,maximized:!1,keyboard:!0,showClose:!0,showMax:!1,transition:null,openMaximized:!1},this.name="popup",this.status="closed",this.onOpen=null,this.onClose=null,this.onMax=null,this.onMin=null,this.onToggle=null,this.onKeydown=null,this.onAction=null,this.onMove=null}open(n){let a=this;if("closing"==w2popup.status)setTimeout(()=>{a.open.call(a,n)},100);else{var o=this.options;null!=(n=["string","number"].includes(typeof n)?w2utils.extend({title:"Notification",body:`<div class="w2ui-centered">${n}</div>`,actions:{Ok(){w2popup.close()}},cancelAction:"ok"},arguments[1]??{}):n).text&&(n.body=`<div class="w2ui-centered w2ui-msg-text">${n.text}</div>`),n=Object.assign({},this.defaults,o,{title:"",body:""},n,{maximized:!1}),this.options=n,0===query("#w2ui-popup").length&&(w2popup.off("*"),Object.keys(w2popup).forEach(e=>{e.startsWith("on")&&"on"!=e&&(w2popup[e]=null)})),Object.keys(n).forEach(e=>{e.startsWith("on")&&"on"!=e&&n[e]&&(w2popup[e]=n[e])}),n.width=parseInt(n.width),n.height=parseInt(n.height);let e,t,s,i,l;t=null==window.innerHeight?(e=parseInt(document.documentElement.offsetWidth),parseInt(document.documentElement.offsetHeight)):(e=parseInt(window.innerWidth),parseInt(window.innerHeight)),e-10<n.width&&(n.width=e-10),t-10<n.height&&(n.height=t-10);var h=(t-n.height)/2,d=(e-n.width)/2;let r={self:this,action(e){return a.on("action.prom",e),r},close(e){return a.on("close.prom",e),r},then(e){return a.on("open:after.prom",e),r}};if(null==n.actions||n.buttons||(n.buttons="",Object.keys(n.actions).forEach(e=>{var t=n.actions[e];let i=e;"function"==typeof t&&(n.buttons+=`<button class="w2ui-btn w2ui-eaction" data-click='["action","${e}","event"]'>${e}</button>`),"object"==typeof t&&(n.buttons+=`<button class="w2ui-btn w2ui-eaction ${t.class||""}" data-click='["action","${e}","event"]'
                        ...
                        transition: ${n.speed}s"></div>`,query("body").append(i),query("#w2ui-popup")[0]._w2popup={self:this,created:new Promise(e=>{this._promCreated=e}),opened:new Promise(e=>{this._promOpened=e}),closing:new Promise(e=>{this._promClosing=e}),closed:new Promise(e=>{this._promClosed=e})},i=`
                <span name="hidden-first" tabindex="0" style="position: absolute; top: -100px"></span>
        ...
        `);return t.forEach((n,a)=>{i=n.icon;var o=(0<u.length?u.join("-")+"-":"")+a;if(null==i&&(i=null),-1==["radio","check"].indexOf(h.type)||Array.isArray(n.items)||!1===n.group||(i=!0===n.checked?"w2ui-icon-check":"w2ui-icon-empty"),!0!==n.hidden){let s=n.text,l="",r="";if("function"==typeof(s="function"==typeof h.render?h.render(n,h):s)&&(s=s(n,h)),i&&(l='<div class="menu-icon"><span class="w2ui-icon '+i+'"></span></div>'),"break"!==n.type&&null!=s&&""!==s&&"--"!=String(s).substr(0,2)){let e=["w2ui-menu-item"],t=(1==h.altRows&&e.push(c%2==0?"w2ui-even":"w2ui-odd"),1),i=(""===l&&t++,null==n.count&&null==n.hotkey&&!0!==n.remove&&null==n.items&&t++,null==n.tooltip&&null!=n.hint&&(n.tooltip=n.hint),"");if(!0===n.remove)i='<span class="remove">x</span>';else if(null!=n.items){let e=[];"function"==typeof n.items?e=n.items(n):Array.isArray(n.items)&&(e=n.items),i="<span></span>",r=`
            ...
            <div class="w2ui-cal-days">
                ${l}
        `,c=new Date(e+`/${n}/1`);var p=c.getDay();"M"==w2utils.settings.weekStarts&&s--,0<p&&(c=new Date(c.getTime()-864e5*s));for(let e=0;e<42;e++){let e=[];var f=`${c.getFullYear()}/${c.getMonth()+1}/`+c.getDate(),m=(6===c.getDay()&&e.push("saturday"),0===c.getDay()&&e.push("sunday"),c.getMonth()+1!==n&&e.push("outside"),f==this.today&&e.push("today"),c.getDate());let t="",i="",s,l;l="datetime"===r.type?(s=w2utils.formatDateTime(f,r.format),w2utils.formatDate(f,w2utils.settings.dateFormat)):s=w2utils.formatDate(f,r.format),r.colored&&void 0!==r.colored[l]&&(f=r.colored[l].split("|"),i="background-color: "+f[0]+";",t="color: "+f[1]+";"),u+=`<div class="w2ui-day ${this.inRange(s,r,!0)?"date "+(l==a?"selected":""):"blocked"} ${e.join(" ")}"
            ...
            <div class="w2ui-scroll-right w2ui-eaction" data-click='["scroll","right"]'></div>`;return query(this.box).attr("name",this.name).addClass("w2ui-reset w2ui-tabs").html(e),0<query(this.box).length&&(query(this.box)[0].style.cssText+=this.style),w2utils.bindEvents(query(this.box).find(".w2ui-eaction"),this),this.last.observeResize=new ResizeObserver(()=>{this.resize()}),this.last.observeResize.observe(this.box),i.finish(),this.refresh(),this.resize(),(new Date).getTime()-t}}initReorder(e,n){if(this.reorder){let t=this,i=query(this.box).find("#tabs_"+this.name+"_tab_"+w2utils.escapeId(e)),s=this.get(e,!0),l=query(i.get(0).cloneNode(!0)),r;l.attr("id","#tabs_"+this.name+"_tab_ghost"),this.last.moving={index:s,indexFrom:s,$tab:i,$ghost:l,divX:0,left:i.get(0).getBoundingClientRect().left,parentX:query(this.box).get(0).getBoundingClientRect().left,x:n.pageX,opacity:i.css("opacity")},query(document).off(".w2uiTabReorder").on("mousemove.w2uiTabReorder",function(e){if(!t.last.reordering){if(!0===(r=t.trigger("reorder",{target:t.tabs[s].id,indexFrom:s,tab:t.tabs[s]})).isCancelled)return;w2tooltip.hide(this.name+"_tooltip"),t.last.reordering=!0,l.addClass("moving"),l.css({"pointer-events":"none",position:"absolute",left:i.get(0).getBoundingClientRect().left}),i.css("opacity",0),query(t.box).find(".w2ui-scroll-wrapper").append(l.get(0)),query(t.box).find(".w2ui-tab-close").hide()}t.last.moving.divX=e.pageX-t.last.moving.x,l.css("left",t.last.moving.left-t.last.moving.parentX+t.last.moving.divX+"px"),t.dragMove(e)}).on("mouseup.w2uiTabReorder",function(){query(document).off(".w2uiTabReorder"),l.css({transition:"0.1s",left:t.last.moving.$tab.get(0).getBoundingClientRect().left-t.last.moving.parentX}),query(t.box).find(".w2ui-tab-close").show(),setTimeout(()=>{l.remove(),i.css({opacity:t.last.moving.opacity}),t.last.reordering&&r.finish({indexTo:t.last.moving.index}),t.last.reordering=!1},100)})}}scroll(a,o){return new Promise((e,t)=>{let i=query(this.box).find(".w2ui-scroll-wrapper");var s=i.get(0).scrollLeft,l=i.find(".w2ui-tabs-right").get(0),r=i.parent().get(0).getBoundingClientRect().width,n=s+parseInt(l.offsetLeft)+parseInt(l.clientWidth);switch(a){case"left":{let e=s-r+50;e<=0&&(e=0),i.get(0).scrollTo({top:0,left:e,behavior:o?"atuo":"smooth"});break}case"right":{let e=s+r-50;e>=n-r&&(e=n-r),i.get(0).scrollTo({top:0,left:e,behavior:o?"atuo":"smooth"});break}}setTimeout(()=>{this.resize(),e()},o?0:350)})}scrollIntoView(s,l){return new Promise((t,e)=>{null==s&&(s=this.active);var i=this.get(s);if(null!=i){let e=query(this.box).find("#tabs_"+this.name+"_tab_"+w2utils.escapeId(s)).get(0);e.scrollIntoView({block:"start",inline:"center",behavior:l?"atuo":"smooth"}),setTimeout(()=>{this.resize(),t()},l?0:500)}})}resize(){var i=(new Date).getTime();if(null!=this.box){let t=this.trigger("resize",{target:this.name});if(!0!==t.isCancelled){let e=query(this.box);e.find(".w2ui-scroll-left, .w2ui-scroll-right").hide();var s=e.find(".w2ui-scroll-wrapper").get(0),l=e.find(".w2ui-tabs-right"),r=e.get(0).getBoundingClientRect().width,l=0<l.length?l[0].offsetLeft+l[0].clientWidth:0;return r<l&&(0<s.scrollLeft&&e.find(".w2ui-scroll-left").show(),r<l-s.scrollLeft&&e.find(".w2ui-scroll-right").show()),t.finish(),(new Date).getTime()-i}}}destroy(){let e=this.trigger("destroy",{target:this.name});!0!==e.isCancelled&&(0<query(this.box).find("#tabs_"+this.name+"_right").length&&query(this.box).removeAttr("name").removeClass("w2ui-reset w2ui-tabs").html(""),this.last.observeResize?.disconnect(),delete w2ui[this.name],e.finish())}click(e,t){var i=this.get(e);if(null==i||i.disabled||this.last.reordering)return!1;let s=this.trigger("click",{target:e,tab:i,object:i,originalEvent:t});if(!0!==s.isCancelled){if(query(this.box).find("#tabs_"+this.name+"_tab_"+w2utils.escapeId(this.active)).removeClass("active"),query(this.box).find("#tabs_"+this.name+"_tab_"+w2utils.escapeId(this.active)).removeClass("active"),this.active=i.id,"string"==typeof i.route){let t=""!==i.route?String("/"+i.route).replace(/\/{2,}/g,"/"):"";var l=w2utils.parseRoute(t);if(0<l.keys.length)for(let e=0;e<l.keys.length;e++)null!=this.routeData[l.keys[e].name]&&(t=t.replace(new RegExp(":"+l.keys[e].name,"g"),this.routeData[l.keys[e].name]));setTimeout(()=>{window.location.hash=t},1)}s.finish(),this.refresh(e)}}clickClose(e,t){var i=this.get(e);if(null==i||i.disabled)return!1;let s=this.trigger("close",{target:e,object:i,tab:i,originalEvent:t});!0!==s.isCancelled&&(this.animateClose(e).then(()=>{this.remove(e),s.finish(),this.refresh()}),t&&t.stopPropagation())}animateClose(r){return new Promise((e,t)=>{let i=query(this.box).find("#tabs_"+this.name+"_tab_"+w2utils.escapeId(r));var s=parseInt(i.get(0).clientWidth||0);let l=i.replace(`<div class="tab-animate-close" style="display: inline-block; flex-shrink: 0; width: ${s}px; transition: width 0.25s"></div>`);setTimeout(()=>{l.css({width:"0px"})},1),setTimeout(()=>{l.remove(),this.resize(),e()},500)})}animateInsert(t,n){return new Promise((s,e)=>{let l=query(this.box).find("#tabs_"+this.name+"_tab_"+w2utils.escapeId(t)),r=query.html(this.getTabHTML(n.id));if(0==l.length)(l=query(this.box).find("#tabs_tabs_right")).before(r),this.resize();else{r.css({opacity:0}),query(this.box).find("#tabs_tabs_right").before(r.get(0));let e=query(this.box).find("#"+r.attr("id")),t=e.get(0).clientWidth??0,i=query.html('<div class="tab-animate-insert" style="flex-shrink: 0; width: 0; transition: width 0.25s"></div>');l.before(i),r.hide(),i.before(r[0]),setTimeout(()=>{i.css({width:t+"px"})},1),setTimeout(()=>{i.remove(),r.css({opacity:1}).show(),this.refresh(n.id),this.resize(),s()},500)}})}}let w2panels=["top","left","main","preview","right","bottom"];class w2layout extends w2base{constructor(e){super(e.name),this.box=null,this.name=null,this.panels=[],this.last={},this.padding=1,this.resizer=4,this.style="",this.onShow=null,this.onHide=null,this.onResizing=null,this.onResizerClick=null,this.onRender=null,this.onRefresh=null,this.onChange=null,this.onResize=null,this.onDestroy=null,this.panel_template={type:null,title:"",size:100,minSize:20,maxSize:!1,hidden:!1,resizable:!1,overflow:"auto",style:"",html:"",tabs:null,toolbar:null,width:null,height:null,show:{toolbar:!1,tabs:!1},removed:null,onRefresh:null,onShow:null,onHide:null},Object.assign(this,e),Array.isArray(this.panels)||(this.panels=[]),this.panels.forEach((t,i)=>{if(this.panels[i]=w2utils.extend({},this.panel_template,t),(w2utils.isPlainObject(t.tabs)||Array.isArray(t.tabs))&&function(e,t,i){let s=e.get(t);null!=s&&null==i&&(i=s.tabs);if(null==s||null==i)return;Array.isArray(i)&&(i={tabs:i});var l=e.name+"_"+t+"_tabs";w2ui[l]&&w2ui[l].destroy();s.tabs=new w2tabs(w2utils.extend({},i,{owner:e,name:e.name+"_"+t+"_tabs"})),s.show.tabs=!0}(this,t.type),w2utils.isPlainObject(t.toolbar)||Array.isArray(t.toolbar)){var i=this,t=t.type,s=void 0;let e=i.get(t);if(null!=e&&null==s&&(s=e.toolbar),null==e||null==s)return void!void 0;Array.isArray(s)&&(s={items:s});var l=i.name+"_"+t+"_toolbar";w2ui[l]&&w2ui[l].destroy(),e.toolbar=new w2toolbar(w2utils.extend({},s,{owner:i,name:i.name+"_"+t+"_toolbar"})),e.show.toolbar=!0}}),w2panels.forEach(e=>{null==this.get(e)&&this.panels.push(w2utils.extend({},this.panel_template,{type:e,hidden:"main"!==e,size:50}))}),this.box&&this.render(this.box)}html(i,s,l){let r=this.get(i),e={panel:i,html:r.html,error:!1,cancelled:!1,removed(e){"function"==typeof e&&(r.removed=e)}};if("function"==typeof r.removed&&(r.removed({panel:i,html:r.html,html_new:s,transition:l||"none"}),r.removed=null),"css"==i)return query(this.box).find("#layout_"+this.name+"_panel_css").html("<style>"+s+"</style>"),e.status=!0,e;if(null==r)return console.log("ERROR: incorrect panel name. Panel name can be main, left, right, top, bottom, preview or css"),e.error=!0,e;if(null==s)return e;let t=this.trigger("change",{target:i,panel:r,html_new:s,transition:l});if(!0===t.isCancelled)return e.cancelled=!0,e;let n="#layout_"+this.name+"_panel_"+r.type;var a=query(this.box).find(n+"> .w2ui-panel-content");let o=0;if(0<a.length&&(query(this.box).find(n).get(0).scrollTop=0,o=query(a).css("top")),""===r.html)r.html=s,this.refresh(i);else if(r.html=s,!r.hidden)if(null!=l&&""!==l){query(this.box).addClass("animating");let e=query(this.box).find(n+"> .w2ui-panel-content"),t=(e.after('<div class="w2ui-panel-content new-panel" style="'+e[0].style.cssText+'"></div>'),query(this.box).find(n+"> .w2ui-panel-content.new-panel"));e.css("top",o),t.css("top",o),"object"==typeof s?(s.box=t[0],s.render()):t.hide().html(s),w2utils.transition(e[0],t[0],l,()=>{e.remove(),t.removeClass("new-panel"),t.css("overflow",r.overflow),query(query(this.box).find(n+"> .w2ui-panel-content").get(1)).remove(),query(this.box).removeClass("animating"),this.refresh(i)})}else this.refresh(i);return t.finish(),e}message(e,t){var i=this.get(e);let s=query(this.box).find("#layout_"+this.name+"_panel_"+i.type),l=s.css("overflow"),r=(s.css("overflow","hidden"),w2utils.message({owner:this,box:s.get(0),after:".w2ui-panel-title",param:e},t));return r&&r.self.on("close:after",()=>{s.css("overflow",l)}),r}confirm(e,t){var i=this.get(e);let s=query(this.box).find("#layout_"+this.name+"_panel_"+i.type),l=s.css("overflow"),r=(s.css("overflow","hidden"),w2utils.confirm({owner:this,box:s.get(0),after:".w2ui-panel-title",param:e},t));return r&&r.self.on("close:after",()=>{s.css("overflow",l)}),r}load(i,s,l){return new Promise((t,e)=>{"css"!=i&&null==this.get(i)||null==s?e():fetch(s).then(e=>e.text()).then(e=>{this.resize(),t(this.html(i,e,l))})})}sizeTo(e,t,i){return null!=this.get(e)&&(query(this.box).find(":scope > div > .w2ui-panel").css("transition",!0!==i?".2s":"0s"),setTimeout(()=>{this.set(e,{size:t})},1),setTimeout(()=>{query(this.box).find(":scope > div > .w2ui-panel").css("transition","0s"),this.resize()},300),!0)}show(t,i){let s=this.trigger("show",{target:t,thisect:this.get(t),immediate:i});if(!0!==s.isCancelled){let e=this.get(t);return null==e?!1:(!(e.hidden=!1)===i?(query(this.box).find("#layout_"+this.name+"_panel_"+t).css({opacity:"1"}),s.finish(),this.resize()):(query(this.box).addClass("animating"),query(this.box).find("#layout_"+this.name+"_panel_"+t).css({opacity:"0"}),query(this.box).find(":scope > div > .w2ui-panel").css("transition",".2s"),setTimeout(()=>{this.resize()},1),setTimeout(()=>{query(this.box).find("#layout_"+this.name+"_panel_"+t).css({opacity:"1"})},250),setTimeout(()=>{query(this.box).find(":scope > div > .w2ui-panel").css("transition","0s"),query(this.box).removeClass("animating"),s.finish(),this.resize()},300)),!0)}}hide(t,i){let s=this.trigger("hide",{target:t,object:this.get(t),immediate:i});if(!0!==s.isCancelled){let e=this.get(t);return null==e?!1:((e.hidden=!0)===i?(query(this.box).find("#layout_"+this.name+"_panel_"+t).css({opacity:"0"}),s.finish(),this.resize()):(query(this.box).addClass("animating"),query(this.box).find(":scope > div > .w2ui-panel").css("transition",".2s"),query(this.box).find("#layout_"+this.name+"_panel_"+t).css({opacity:"0"}),setTimeout(()=>{this.resize()},1),setTimeout(()=>{query(this.box).find(":scope > div > .w2ui-panel").css("transition","0s"),query(this.box).removeClass("animating"),s.finish(),this.resize()},300)),!0)}}toggle(e,t){var i=this.get(e);return null!=i&&(i.hidden?this.show(e,t):this.hide(e,t))}set(e,t){var i=this.get(e,!0);return null!=i&&(w2utils.extend(this.panels[i],t),null==t.html&&null==t.resizable||this.refresh(e),this.resize(),!0)}get(t,i){for(let e=0;e<this.panels.length;e++)if(this.panels[e].type==t)return!0===i?e:this.panels[e];return null}el(e){e=query(this.box).find("#layout_"+this.name+"_panel_"+e+"> .w2ui-panel-content");return 1!=e.length?null:e[0]}hideToolbar(e){let t=this.get(e);t&&(t.show.toolbar=!1,query(this.box).find("#layout_"+this.name+"_panel_"+e+"> .w2ui-panel-toolbar").hide(),this.resize())}showToolbar(e){let t=this.get(e);t&&(t.show.toolbar=!0,query(this.box).find("#layout_"+this.name+"_panel_"+e+"> .w2ui-panel-toolbar").show(),this.resize())}toggleToolbar(e){var t=this.get(e);t&&(t.show.toolbar?this.hideToolbar(e):this.showToolbar(e))}assignToolbar(e,t){"string"==typeof t&&null!=w2ui[t]&&(t=w2ui[t]);let i=this.get(e),s=(i.toolbar=t,query(this.box).find(e+"> .w2ui-panel-toolbar"));null!=i.toolbar?(0===s.find("[name="+i.toolbar.name+"]").length?i.toolbar.render(s.get(0)):null!=i.toolbar&&i.toolbar.refresh(),(t.owner=this).showToolbar(e),this.refresh(e)):(s.html(""),this.hideToolbar(e))}hideTabs(e){let t=this.get(e);t&&(t.show.tabs=!1,query(this.box).find("#layout_"+this.name+"_panel_"+e+"> .w2ui-panel-tabs").hide(),this.resize())}showTabs(e){let t=this.get(e);t&&(t.show.tabs=!0,query(this.box).find("#layout_"+this.name+"_panel_"+e+"> .w2ui-panel-tabs").show(),this.resize())}toggleTabs(e){var t=this.get(e);t&&(t.show.tabs?this.hideTabs(e):this.showTabs(e))}render(e){let o=this;var t=(new Date).getTime();let i=this.trigger("render",{target:this.name,box:e});if(!0!==i.isCancelled){if(null!=e&&(0<query(this.box).find("#layout_"+this.name+"_panel_main").length&&query(this.box).removeAttr("name").removeClass("w2ui-layout").html(""),this.box=e),!this.box)return!1;query(this.box).attr("name",this.name).addClass("w2ui-layout").html("<div></div>"),0<query(this.box).length&&(query(this.box)[0].style.cssText+=this.style);for(let e=0;e<w2panels.length;e++){var s='<div id="layout_'+this.name+"_panel_"+w2panels[e]+'" class="w2ui-panel">    <div class="w2ui-panel-title"></div>    <div class="w2ui-panel-tabs"></div>    <div class="w2ui-panel-toolbar"></div>    <div class="w2ui-panel-content"></div></div><div id="layout_'+this.name+"_resizer_"+w2panels[e]+'" class="w2ui-resizer"></div>';query(this.box).find(":scope > div").append(s)}return query(this.box).find(":scope > div").append('<div id="layout_'+this.name+'_panel_css" style="position: absolute; top: 10000px;"></div>'),this.refresh(),this.last.observeResize=new ResizeObserver(()=>{this.resize()}),this.last.observeResize.observe(this.box),i.finish(),setTimeout(()=>{o.last.events={resizeStart:l,mouseMove:n,mouseUp:r},this.resize()},0),(new Date).getTime()-t}function l(e,t){o.box&&(t=t||window.event,query(document).off("mousemove",o.last.events.mouseMove).on("mousemove",o.last.events.mouseMove),query(document).off("mouseup",o.last.events.mouseUp).on("mouseup",o.last.events.mouseUp),o.last.resize={type:e,x:t.screenX,y:t.screenY,diff_x:0,diff_y:0,value:0},w2panels.forEach(e=>{let t=query(o.el(e)).find(".w2ui-lock");0<t.length?t.data("locked","yes"):o.lock(e,{opacity:0})}),t=query(o.box).find("#layout_"+o.name+"_resizer_"+e).get(0),"left"!=e&&"right"!=e||(o.last.resize.value=parseInt(t.style.left)),"top"!=e&&"preview"!=e&&"bottom"!=e||(o.last.resize.value=parseInt(t.style.top)))}function r(l){if(o.box&&(l=l||window.event,query(document).off("mousemove",o.last.events.mouseMove),query(document).off("mouseup",o.last.events.mouseUp),null!=o.last.resize)){if(w2panels.forEach(e=>{let t=query(o.el(e)).find(".w2ui-lock");"yes"==t.data("locked")?t.removeData("locked"):o.unlock(e)}),0!==o.last.diff_x||0!==o.last.resize.diff_y){var r=o.get("top"),n=o.get("bottom");let e=o.get(o.last.resize.type);var l=w2utils.getSize(query(o.box),"width"),a=w2utils.getSize(query(o.box),"height");let t=String(e.size),i,s;switch(o.last.resize.type){case"top":i=parseInt(e.sizeCalculated)+o.last.resize.diff_y,s=0;break;case"bottom":i=parseInt(e.sizeCalculated)-o.last.resize.diff_y,s=0;break;case"preview":i=parseInt(e.sizeCalculated)-o.last.resize.diff_y,s=(r&&!r.hidden?r.sizeCalculated:0)+(n&&!n.hidden?n.sizeCalculated:0);break;case"left":i=parseInt(e.sizeCalculated)+o.last.resize.diff_x,s=0;break;case"right":i=parseInt(e.sizeCalculated)-o.last.resize.diff_x,s=0}"%"==t.substr(t.length-1)?e.size=Math.floor(100*i/("left"==e.type||"right"==e.type?l:a-s)*100)/100+"%":"-"==String(e.size).substr(0,1)?e.size=parseInt(e.size)-e.sizeCalculated+i:e.size=i,o.resize()}query(o.box).find("#layout_"+o.name+"_resizer_"+o.last.resize.type).removeClass("active"),delete o.last.resize}}function n(r){if(o.box&&(r=r||window.event,null!=o.last.resize)){var n=o.get(o.last.resize.type);let s=o.last.resize,l=o.trigger("resizing",{target:o.name,object:n,originalEvent:r,panel:s?s.type:"all",diff_x:s?s.diff_x:0,diff_y:s?s.diff_y:0});if(!0!==l.isCancelled){let e=query(o.box).find("#layout_"+o.name+"_resizer_"+s.type),t=r.screenX-s.x,i=r.screenY-s.y;var a=o.get("main");switch(e.hasClass("active")||e.addClass("active"),s.type){case"left":n.minSize-t>n.width&&(t=n.minSize-n.width),n.maxSize&&n.width+t>n.maxSize&&(t=n.maxSize-n.width),a.minSize+t>a.width&&(t=a.width-a.minSize);break;case"right":n.minSize+t>n.width&&(t=n.width-n.minSize),n.maxSize&&n.width-t>n.maxSize&&(t=n.width-n.maxSize),a.minSize-t>a.width&&(t=a.minSize-a.width);break;case"top":n.minSize-i>n.height&&(i=n.minSize-n.height),n.maxSize&&n.height+i>n.maxSize&&(i=n.maxSize-n.height),a.minSize+i>a.height&&(i=a.height-a.minSize);break;case"preview":case"bottom":n.minSize+i>n.height&&(i=n.height-n.minSize),n.maxSize&&n.height-i>n.maxSize&&(i=n.height-n.maxSize),a.minSize-i>a.height&&(i=a.minSize-a.height)}switch(s.diff_x=t,s.diff_y=i,s.type){case"top":case"preview":case"bottom":(s.diff_x=0)<e.length&&(e[0].style.top=s.value+s.diff_y+"px");break;case"left":case"right":(s.diff_y=0)<e.length&&(e[0].style.left=s.value+s.diff_x+"px")}l.finish()}}}}refresh(s){let l=this;null==s&&(s=null);var e=(new Date).getTime();let t=l.trigger("refresh",{target:null!=s?s:l.name,object:l.get(s)});if(!0!==t.isCancelled){if("string"==typeof s){let e=l.get(s);if(null==e)return;let t="#layout_"+l.name+"_panel_"+e.type;s="#layout_"+l.name+"_resizer_"+e.type;query(l.box).find(t).css({display:e.hidden?"none":"block"}),e.resizable?query(l.box).find(s).show():query(l.box).find(s).hide(),"object"==typeof e.html&&"function"==typeof e.html.render?(e.html.box=query(l.box).find(t+"> .w2ui-panel-content")[0],setTimeout(()=>{0<query(l.box).find(t+"> .w2ui-panel-content").length&&(query(l.box).find(t+"> .w2ui-panel-content").removeClass().removeAttr("name").addClass("w2ui-panel-content").css("overflow",e.overflow)[0].style.cssText+=";"+e.style),e.html&&"function"==typeof e.html.render&&e.html.render()},1)):0<query(l.box).find(t+"> .w2ui-panel-content").length&&(query(l.box).find(t+"> .w2ui-panel-content").removeClass().removeAttr("name").addClass("w2ui-panel-content").html(e.html).css("overflow",e.overflow)[0].style.cssText+=";"+e.style);let i=query(l.box).find(t+"> .w2ui-panel-tabs");e.show.tabs?0===i.find("[name="+e.tabs.name+"]").length&&null!=e.tabs?e.tabs.render(i.get(0)):e.tabs.refresh():i.html("").removeClass("w2ui-tabs").hide(),i=query(l.box).find(t+"> .w2ui-panel-toolbar"),e.show.toolbar?0===i.find("[name="+e.toolbar.name+"]").length&&null!=e.toolbar?e.toolbar.render(i.get(0)):e.toolbar.refresh():i.html("").removeClass("w2ui-toolbar").hide(),i=query(l.box).find(t+"> .w2ui-panel-title"),e.title?i.html(e.title).show():i.html("").hide()}else{if(0===query(l.box).find("#layout_"+l.name+"_panel_main").length)return void l.render();l.resize();for(let e=0;e<this.panels.length;e++)l.refresh(this.panels[e].type)}return t.finish(),(new Date).getTime()-e}}resize(){if(!this.box)return!1;var u=(new Date).getTime();let c=this.last.resize,p=this.trigger("resize",{target:this.name,panel:c?c.type:"all",diff_x:c?c.diff_x:0,diff_y:c?c.diff_y:0});if(!0!==p.isCancelled){this.padding<0&&(this.padding=0);var f=w2utils.getSize(query(this.box),"width"),m=w2utils.getSize(query(this.box),"height");query(this.box).find(":scope > div").css({width:f+"px",height:m+"px"});let i=this,e=this.get("main"),t=this.get("preview"),s=this.get("left"),l=this.get("right"),r=this.get("top"),n=this.get("bottom");var g=null!=t&&!0!==t.hidden,w=null!=s&&!0!==s.hidden,y=null!=l&&!0!==l.hidden,b=null!=r&&!0!==r.hidden,v=null!=n&&!0!==n.hidden;let a,o,h,d;for(let e=0;e<w2panels.length;e++)if("main"!==w2panels[e]&&(c=this.get(w2panels[e]))){let e=String(c.size||0);if("%"==e.substr(e.length-1)){let e=m;"preview"==c.type&&(e=e-(r&&!r.hidden?r.sizeCalculated:0)-(n&&!n.hidden?n.sizeCalculated:0)),c.sizeCalculated=parseInt(("left"==c.type||"right"==c.type?f:e)*parseFloat(c.size)/100)}else c.sizeCalculated=parseInt(c.size);c.sizeCalculated=Math.max(c.sizeCalculated,parseInt(c.minSize))}"-"==String(l.size).substr(0,1)&&(w&&"-"==String(s.size).substr(0,1)?console.log("ERROR: you cannot have both left panel.size and right panel.size be negative."):l.sizeCalculated=f-(w?s.sizeCalculated:0)+parseInt(l.size)),"-"==String(s.size).substr(0,1)&&(y&&"-"==String(l.size).substr(0,1)?console.log("ERROR: you cannot have both left panel.size and right panel.size be negative."):s.sizeCalculated=f-(y?l.sizeCalculated:0)+parseInt(s.size)),null!=r&&!0!==r.hidden?(a=0,o=0,h=f,d=r.sizeCalculated,query(this.box).find("#layout_"+this.name+"_panel_top").css({display:"block",left:a+"px",top:o+"px",width:h+"px",height:d+"px"}),r.width=h,r.height=d,r.resizable&&(o=r.sizeCalculated-(0===this.padding?this.resizer:0),d=this.resizer>this.padding?this.resizer:this.padding,query(this.box).find("#layout_"+this.name+"_resizer_top").css({display:"block",left:a+"px",top:o+"px",width:h+"px",height:d+"px",cursor:"ns-resize"}).off("mousedown").on("mousedown",function(e){let t=i.trigger("resizerClick",{target:"top",originalEvent:e});if(!0!==t.isCancelled)return w2ui[i.name].last.events.resizeStart("top",e),t.finish(),!1}))):(query(this.box).find("#layout_"+this.name+"_panel_top").hide(),query(this.box).find("#layout_"+this.name+"_resizer_top").hide()),null!=s&&!0!==s.hidden?(a=0,o=0+(b?r.sizeCalculated+this.padding:0),h=s.sizeCalculated,d=m-(b?r.sizeCalculated+this.padding:0)-(v?n.sizeCalculated+this.padding:0),query(this.box).find("#layout_"+this.name+"_panel_left").css({display:"block",left:a+"px",top:o+"px",width:h+"px",height:d+"px"}),s.width=h,s.height=d,s.resizable&&(a=s.sizeCalculated-(0===this.padding?this.resizer:0),h=this.resizer>this.padding?this.resizer:this.padding,query(this.box).find("#layout_"+this.name+"_resizer_left").css({display:"block",left:a+"px",top:o+"px",width:h+"px",height:d+"px",cursor:"ew-resize"}).off("mousedown").on("mousedown",function(e){let t=i.trigger("resizerClick",{target:"left",originalEvent:e});if(!0!==t.isCancelled)return w2ui[i.name].last.events.resizeStart("left",e),t.finish(),!1}))):(query(this.box).find("#layout_"+this.name+"_panel_left").hide(),query(this.box).find("#layout_"+this.name+"_resizer_left").hide()),null!=l&&!0!==l.hidden?(a=f-l.sizeCalculated,o=0+(b?r.sizeCalculated+this.padding:0),h=l.sizeCalculated,d=m-(b?r.sizeCalculated+this.padding:0)-(v?n.sizeCalculated+this.padding:0),query(this.box).find("#layout_"+this.name+"_panel_right").css({display:"block",left:a+"px",top:o+"px",width:h+"px",height:d+"px"}),l.width=h,l.height=d,l.resizable&&(a-=this.padding,h=this.resizer>this.padding?this.resizer:this.padding,query(this.box).find("#layout_"+this.name+"_resizer_right").css({display:"block",left:a+"px",top:o+"px",width:h+"px",height:d+"px",cursor:"ew-resize"}).off("mousedown").on("mousedown",function(e){let t=i.trigger("resizerClick",{target:"right",originalEvent:e});if(!0!==t.isCancelled)return w2ui[i.name].last.events.resizeStart("right",e),t.finish(),!1}))):(query(this.box).find("#layout_"+this.name+"_panel_right").hide(),query(this.box).find("#layout_"+this.name+"_resizer_right").hide()),null!=n&&!0!==n.hidden?(a=0,o=m-n.sizeCalculated,h=f,d=n.sizeCalculated,query(this.box).find("#layout_"+this.name+"_panel_bottom").css({display:"block",left:a+"px",top:o+"px",width:h+"px",height:d+"px"}),n.width=h,n.height=d,n.resizable&&(o-=0===this.padding?0:this.padding,d=this.resizer>this.padding?this.resizer:this.padding,query(this.box).find("#layout_"+this.name+"_resizer_bottom").css({display:"block",left:a+"px",top:o+"px",width:h+"px",height:d+"px",cursor:"ns-resize"}).off("mousedown").on("mousedown",function(e){let t=i.trigger("resizerClick",{target:"bottom",originalEvent:e});if(!0!==t.isCancelled)return w2ui[i.name].last.events.resizeStart("bottom",e),t.finish(),!1}))):(query(this.box).find("#layout_"+this.name+"_panel_bottom").hide(),query(this.box).find("#layout_"+this.name+"_resizer_bottom").hide()),a=0+(w?s.sizeCalculated+this.padding:0),o=0+(b?r.sizeCalculated+this.padding:0),h=f-(w?s.sizeCalculated+this.padding:0)-(y?l.sizeCalculated+this.padding:0),d=m-(b?r.sizeCalculated+this.padding:0)-(v?n.sizeCalculated+this.padding:0)-(g?t.sizeCalculated+this.padding:0),query(this.box).find("#layout_"+this.name+"_panel_main").css({display:"block",left:a+"px",top:o+"px",width:h+"px",height:d+"px"}),e.width=h,e.height=d,null!=t&&!0!==t.hidden?(a=0+(w?s.sizeCalculated+this.padding:0),o=m-(v?n.sizeCalculated+this.padding:0)-t.sizeCalculated,h=f-(w?s.sizeCalculated+this.padding:0)-(y?l.sizeCalculated+this.padding:0),d=t.sizeCalculated,query(this.box).find("#layout_"+this.name+"_panel_preview").css({display:"block",left:a+"px",top:o+"px",width:h+"px",height:d+"px"}),t.width=h,t.height=d,t.resizable&&(o-=0===this.padding?0:this.padding,d=this.resizer>this.padding?this.resizer:this.padding,query(this.box).find("#layout_"+this.name+"_resizer_preview").css({display:"block",left:a+"px",top:o+"px",width:h+"px",height:d+"px",cursor:"ns-resize"}).off("mousedown").on("mousedown",function(e){let t=i.trigger("resizerClick",{target:"preview",originalEvent:e});if(!0!==t.isCancelled)return w2ui[i.name].last.events.resizeStart("preview",e),t.finish(),!1}))):(query(this.box).find("#layout_"+this.name+"_panel_preview").hide(),query(this.box).find("#layout_"+this.name+"_resizer_preview").hide());for(let t=0;t<w2panels.length;t++){var x,_=this.get(w2panels[t]),C="#layout_"+this.name+"_panel_"+w2panels[t]+" > .w2ui-panel-";let e=0;_&&(_.title&&(x=query(this.box).find(C+"title").css({top:e+"px",display:"block"}),e+=w2utils.getSize(x,"height")),_.show.tabs&&(x=query(this.box).find(C+"tabs").css({top:e+"px",display:"block"}),e+=w2utils.getSize(x,"height")),_.show.toolbar&&(_=query(this.box).find(C+"toolbar").css({top:e+"px",display:"block"}),e+=w2utils.getSize(_,"height"))),query(this.box).find(C+"content").css({display:"block"}).css({top:e+"px"})}return p.finish(),(new Date).getTime()-u}}destroy(){let e=this.trigger("destroy",{target:this.name});if(!0!==e.isCancelled)return null!=w2ui[this.name]&&(0<query(this.box).find("#layout_"+this.name+"_panel_main").length&&query(this.box).removeAttr("name").removeClass("w2ui-layout").html(""),this.last.observeResize?.disconnect(),delete w2ui[this.name],e.finish(),this.last.events&&this.last.events.resize&&query(window).off("resize",this.last.events.resize),!0)}lock(t,e,i){if(-1==w2panels.indexOf(t))console.log("ERROR: First parameter needs to be the a valid panel name.");else{let e=Array.from(arguments);e[0]="#layout_"+this.name+"_panel_"+t,w2utils.lock(...e)}}unlock(e,t){-1==w2panels.indexOf(e)?console.log("ERROR: First parameter needs to be the a valid panel name."):(e="#layout_"+this.name+"_panel_"+e,w2utils.unlock(e,t))}}class w2grid extends w2base{constructor(e){if(super(e.name),this.name=null,this.box=null,this.columns=[],this.columnGroups=[],this.records=[],this.summary=[],this.searches=[],this.toolbar={},this.ranges=[],this.menu=[],this.searchMap={},this.searchData=[],this.sortMap={},this.sortData=[],this.savedSearches=[],this.total=0,this.recid=null,this.last={field:"",label:"",logic:"AND",search:"",searchIds:[],selection:{indexes:[],columns:{}},_selection:null,multi:!1,scrollTop:0,scrollLeft:0,colStart:0,colEnd:0,xhr:null,xhr_cmd:"",xhr_offset:null,xhr_start:0,xhr_response:0,xhr_hasMore:!1,pull_more:!1,pull_refresh:!0,loaded:!1,range_start:null,range_end:null,sel_ind:null,sel_col:null,sel_type:null,sel_recid:null,idCache:{},move:null,cancelClick:null,inEditMode:!1,_edit:null,kbd_timer:null,marker_timer:null,click_time:null,click_recid:null,bubbleEl:null,colResizing:!1,tmp:null,copy_event:null,userSelect:"",columnDrag:!1,state:null,show_extra:0,_toolbar_height:0},this.header="",this.url="",this.limit=100,this.offset=0,this.postData={},this.routeData={},this.httpHeaders={},this.show={header:!1,toolbar:!1,footer:!1,columnHeaders:!0,lineNumbers:!1,orderColumn:!1,expandColumn:!1,selectColumn:!1,emptyRecords:!0,toolbarReload:!0,toolbarColumns:!1,toolbarSearch:!0,toolbarAdd:!1,toolbarEdit:!1,toolbarDelete:!1,toolbarSave:!1,searchAll:!0,searchLogic:!0,searchHiddenMsg:!1,searchSave:!0,statusRange:!0,statusBuffered:!1,statusRecordID:!0,statusSelection:!0,statusResponse:!0,statusSort:!1,statusSearch:!1,recordTitles:!1,selectionBorder:!0,skipRecords:!0,saveRestoreState:!0},this.stateId=null,this.hasFocus=!1,this.autoLoad=!0,this.fixedBody=!0,this.recordHeight=32,this.lineNumberWidth=34,this.keyboard=!0,this.selectType="row",this.multiSearch=!0,this.multiSelect=!0,this.multiSort=!0,this.reorderColumns=!1,this.reorderRows=!1,this.showExtraOnSearch=0,this.markSearch=!0,this.columnTooltip="top|bottom",this.disableCVS=!1,this.nestedFields=!0,this.vs_start=150,this.vs_extra=15,this.style="",this.tabIndex=null,this.method=null,this.dataType=null,this.parser=null,this.advanceOnEdit=!0,this.useLocalStorage=!0,this.colDefaults={text:"",field:"",size:null,min:20,max:null,gridMinWidth:null,sizeCorrected:null,sizeCalculated:null,sizeOriginal:null,sizeType:null,hidden:!1,sortable:!1,sortMode:null,searchable:!1,resizable:!0,hideable:!0,autoResize:null,attr:"",style:"",render:null,title:null,tooltip:null,editable:{},frozen:!1,info:null,clipboardCopy:!1},this.stateColProps={text:!1,field:!0,size:!0,min:!1,max:!1,gridMinWidth:!1,sizeCorrected:!1,sizeCalculated:!0,sizeOriginal:!0,sizeType:!0,hidden:!0,sortable:!1,sortMode:!0,searchable:!1,resizable:!1,hideable:!1,autoResize:!1,attr:!1,style:!1,render:!1,title:!1,tooltip:!1,editable:!1,frozen:!0,info:!1,clipboardCopy:!1},this.msgDelete="Are you sure you want to delete ${count} ${records}?",this.msgNotJSON="Returned data is not in valid JSON format.",this.msgAJAXerror="AJAX error. See console for more details.",this.msgRefresh="Refreshing...",this.msgNeedReload="Your remote data source record count has changed, reloading from the first record.",this.msgEmpty="",this.buttons={reload:{type:"button",id:"w2ui-reload",icon:"w2ui-icon-reload",tooltip:"Reload data in the list"},columns:{type:"menu-check",id:"w2ui-column-on-off",icon:"w2ui-icon-columns",tooltip:"Show/hide columns",overlay:{align:"none"}},search:{type:"html",id:"w2ui-search",html:"<div class=\"w2ui-icon w2ui-icon-search w2ui-search-down\" onclick=\"let grid = w2ui[jQuery(this).parents('div.w2ui-grid').attr('name')]; grid.searchShowFields()\"></div>"},add:{type:"button",id:"w2ui-add",text:"Add New",tooltip:"Add new record",icon:"w2ui-icon-plus"},edit:{type:"button",id:"w2ui-edit",text:"Edit",tooltip:"Edit selected record",icon:"w2ui-icon-pencil",batch:1,disabled:!0},delete:{type:"button",id:"w2ui-delete",text:"Delete",tooltip:"Delete selected records",icon:"w2ui-icon-cross",batch:!0,disabled:!0},save:{type:"button",id:"w2ui-save",text:"Save",tooltip:"Save changed records",icon:"w2ui-icon-check"}},this.operators={text:["is","begins","contains","ends"],number:["=","between",">","<",">=","<="],date:["is","between",{oper:"less",text:"before"},{oper:"more",text:"after"}],list:["is"],hex:["is","between"],color:["is","begins","contains","ends"],enum:["in","not in"]},this.defaultOperator={text:"begins",number:"=",date:"is",list:"is",enum:"in",hex:"begins",color:"begins"},this.operatorsMap={text:"text",int:"number",float:"number",money:"number",currency:"number",percent:"number",hex:"hex",alphanumeric:"text",color:"color",date:"date",time:"date",datetime:"date",list:"list",combo:"text",enum:"enum",file:"enum",select:"list",radio:"list",checkbox:"list",toggle:"list"},this.onAdd=null,this.onEdit=null,this.onRequest=null,this.onLoad=null,this.onDelete=null,this.onSave=null,this.onSelect=null,this.onUnselect=null,this.onClick=null,this.onDblClick=null,this.onContextMenu=null,this.onMenuClick=null,this.onColumnClick=null,this.onColumnDblClick=null,this.onColumnResize=null,this.onColumnAutoResize=null,this.onSort=null,this.onSearch=null,this.onSearchOpen=null,this.onChange=null,this.onRestore=null,this.onExpand=null,this.onCollapse=null,this.onError=null,this.onKeydown=null,this.onToolbar=null,this.onColumnOnOff=null,this.onCopy=null,this.onPaste=null,this.onSelectionExtend=null,this.onEditField=null,this.onRender=null,this.onRefresh=null,this.onReload=null,this.onResize=null,this.onDestroy=null,this.onStateSave=null,this.onStateRestore=null,this.onFocus=null,this.onBlur=null,this.onReorderRow=null,this.onSearchSave=null,this.onSearchRemove=null,this.onSearchSelect=null,this.onColumnSelect=null,this.onColumnDragStart=null,this.onColumnDragEnd=null,this.onResizerDblClick=null,w2utils.extend(this,e),Array.isArray(this.records)){let i=[];this.records.forEach((e,t)=>{null!=e[this.recid]&&(e.recid=e[this.recid]),null==e.recid&&console.log("ERROR: Cannot add records without recid. (obj: "+this.name+")"),e.w2ui&&!0===e.w2ui.summary&&(this.summary.push(e),i.push(t))}),i.sort();for(let e=i.length-1;0<=e;e--)this.records.splice(i[e],1)}if(Array.isArray(this.columns)&&this.columns.forEach((i,e)=>{i=w2utils.extend({},this.colDefaults,i);e=(this.columns[e]=i).searchable;if(null!=e&&!1!==e&&null==this.getSearch(i.field))if(w2utils.isPlainObject(e))this.addSearch(w2utils.extend({field:i.field,label:i.text,type:"text"},e));else{let e=i.searchable,t="";!0===i.searchable&&(e="text",t='size="20"'),this.addSearch({field:i.field,label:i.text,type:e,attr:t})}}),w2utils.hasLocalStorage&&this.useLocalStorage)try{var t=JSON.parse(localStorage.w2ui||"{}");if(t&&t.searches){let e=t.searches[this.stateId||this.name];Array.isArray(e)&&e.forEach(e=>{this.savedSearches.push({id:e.name,text:e.name,icon:"w2ui-icon-search",remove:!0,logic:e.logic,data:e.data})})}}catch(e){}this.box&&this.render(this.box)}add(i,s){Array.isArray(i)||(i=[i]);let l=0;for(let t=0;t<i.length;t++){let e=i[t];null!=e[this.recid]&&(e.recid=e[this.recid]),null==e.recid?console.log("ERROR: Cannot add record without recid. (obj: "+this.name+")"):(e.w2ui&&!0===e.w2ui.summary?s?this.summary.unshift(e):this.summary.push(e):s?this.records.unshift(e):this.records.push(e),l++)}return("object"!=typeof this.url?this.url:this.url.get)||(this.total=this.records.length,this.localSort(!1,!0),this.localSearch()),this.refresh(),l}find(s,e,t){let l=[],r=!1;for(var i in s=null==s?{}:s)-1!=String(i).indexOf(".")&&(r=!0);var n=t?this.last.range_start:0;let a=t?this.last.range_end+1:this.records.length;a>this.records.length&&(a=this.records.length);for(let i=n;i<a;i++){let t=!0;for(var o in s){let e=this.records[i][o];r&&-1!=String(o).indexOf(".")&&(e=this.parseField(this.records[i],o)),"not-null"==s[o]?null!=e&&""!==e||(t=!1):s[o]!=e&&(t=!1)}t&&!0!==e&&l.push(this.records[i].recid),t&&!0===e&&l.push(i)}return l}set(e,t,i){if("object"==typeof e&&null!==e&&(i=t,t=e,e=null),null==e){for(let e=0;e<this.records.length;e++)w2utils.extend(this.records[e],t);!0!==i&&this.refresh()}else{var s=this.get(e,!0);if(null==s)return!1;!this.records[s]||this.records[s].recid!=e?w2utils.extend(this.summary[s],t):w2utils.extend(this.records[s],t),!0!==i&&this.refreshRow(e,s)}return!0}get(i,s){if(Array.isArray(i)){let t=[];for(let e=0;e<i.length;e++){var l=this.get(i[e],s);null!==l&&t.push(l)}return t}{let t=this.last.idCache,e=(t||(this.last.idCache=t={}),t[i]);if("number"==typeof e){if(0<=e&&e<this.records.length&&this.records[e].recid==i)return!0===s?e:this.records[e];if(0<=(e=~e)&&e<this.summary.length&&this.summary[e].recid==i)return!0===s?e:this.summary[e];this.last.idCache=t={}}for(let e=0;e<this.records.length;e++)if(this.records[e].recid==i)return t[i]=e,!0===s?e:this.records[e];for(let e=0;e<this.summary.length;e++)if(this.summary[e].recid==i)return t[i]=~e,!0===s?e:this.summary[e];return null}}getFirst(e){if(0==this.records.length)return null;let t=this.records[0];var i=this.last.searchIds;return t=0<this.searchData.length?Array.isArray(i)&&0<i.length?this.records[i[e||0]]:null:t}remove(){let i=0;for(let t=0;t<arguments.length;t++){for(let e=this.records.length-1;0<=e;e--)this.records[e].recid==arguments[t]&&(this.records.splice(e,1),i++);for(let e=this.summary.length-1;0<=e;e--)this.summary[e].recid==arguments[t]&&(this.summary.splice(e,1),i++)}return("object"!=typeof this.url?this.url:this.url.get)||(this.localSort(!1,!0),this.localSearch()),this.refresh(),i}addColumn(e,s){let t=0;1==arguments.length?(s=e,e=this.columns.length):null==(e="string"==typeof e?this.getColumn(e,!0):e)&&(e=this.columns.length),Array.isArray(s)||(s=[s]);for(let i=0;i<s.length;i++){var l=w2utils.extend({},this.colDefaults,s[i]);if(this.columns.splice(e,0,l),s[i].searchable){let e=s[i].searchable,t="";!0===s[i].searchable&&(e="text",t='size="20"'),this.addSearch({field:s[i].field,label:s[i].label,type:e,attr:t})}e++,t++}return this.refresh(),t}removeColumn(){let i=0;for(let t=0;t<arguments.length;t++)for(let e=this.columns.length-1;0<=e;e--)this.columns[e].field==arguments[t]&&(this.columns[e].searchable&&this.removeSearch(arguments[t]),this.columns.splice(e,1),i++);return this.refresh(),i}getColumn(t,i){if(0===arguments.length){let t=[];for(let e=0;e<this.columns.length;e++)t.push(this.columns[e].field);return t}for(let e=0;e<this.columns.length;e++)if(this.columns[e].field==t)return!0===i?e:this.columns[e];return null}updateColumn(e,s){let l=0;return(e=Array.isArray(e)?e:[e]).forEach(e=>{this.columns.forEach(i=>{if(i.field==e){let t=w2utils.clone(s);Object.keys(t).forEach(e=>{"function"==typeof t[e]&&(t[e]=t[e](i)),i[e]!=t[e]&&l++}),w2utils.extend(i,t)}})}),0<l&&this.refresh(),l}toggleColumn(){return this.updateColumn(Array.from(arguments),{hidden(e){return!e.hidden}})}showColumn(){return this.updateColumn(Array.from(arguments),{hidden:!1})}hideColumn(){return this.updateColumn(Array.from(arguments),{hidden:!0})}addSearch(t,i){let s=0;1==arguments.length?(i=t,t=this.searches.length):null==(t="string"==typeof t?this.getSearch(t,!0):t)&&(t=this.searches.length),Array.isArray(i)||(i=[i]);for(let e=0;e<i.length;e++)this.searches.splice(t,0,i[e]),t++,s++;return this.searchClose(),s}removeSearch(){let i=0;for(let t=0;t<arguments.length;t++)for(let e=this.searches.length-1;0<=e;e--)this.searches[e].field==arguments[t]&&(this.searches.splice(e,1),i++);return this.searchClose(),i}getSearch(t,i){if(0===arguments.length){let t=[];for(let e=0;e<this.searches.length;e++)t.push(this.searches[e].field);return t}for(let e=0;e<this.searches.length;e++)if(this.searches[e].field==t)return!0===i?e:this.searches[e];return null}toggleSearch(){let i=0;for(let t=0;t<arguments.length;t++)for(let e=this.searches.length-1;0<=e;e--)this.searches[e].field==arguments[t]&&(this.searches[e].hidden=!this.searches[e].hidden,i++);return this.searchClose(),i}showSearch(){let i=0;for(let t=0;t<arguments.length;t++)for(let e=this.searches.length-1;0<=e;e--)this.searches[e].field==arguments[t]&&!1!==this.searches[e].hidden&&(this.searches[e].hidden=!1,i++);return this.searchClose(),i}hideSearch(){let i=0;for(let t=0;t<arguments.length;t++)for(let e=this.searches.length-1;0<=e;e--)this.searches[e].field==arguments[t]&&!0!==this.searches[e].hidden&&(this.searches[e].hidden=!0,i++);return this.searchClose(),i}getSearchData(t){for(let e=0;e<this.searchData.length;e++)if(this.searchData[e].field==t)return this.searchData[e];return null}localSort(t,i){let a=this;if("object"!=typeof this.url?this.url:this.url.get)console.log("ERROR: grid.localSort can only be used on local data source, grid.url should be empty.");else if(0!==Object.keys(this.sortData).length){let e=(new Date).getTime();this.selectionSave(),this.prepareData(),i||this.reset();for(let t=0;t<this.sortData.length;t++){let e=this.getColumn(this.sortData[t].field);if(!e)return;"string"==typeof e.render&&(-1!=["date","age"].indexOf(e.render.split(":")[0])&&(this.sortData[t].field_=e.field+"_"),-1!=["time"].indexOf(e.render.split(":")[0])&&(this.sortData[t].field_=e.field+"_"))}for(let t=0;t<a.records.length;t++){let e=a.records[t];e.w2ui&&null!=e.w2ui.parent_recid&&(e.w2ui._path=r(e))}this.records.sort((e,t)=>{if(!(e.w2ui&&null!=e.w2ui.parent_recid||t.w2ui&&null!=t.w2ui.parent_recid))return n(e,t);var i=r(e),s=r(t);for(let e=0;e<Math.min(i.length,s.length);e++){var l=n(i[e],s[e]);if(0!==l)return l}return i.length>s.length?1:i.length<s.length?-1:(console.log("ERROR: two paths should not be equal."),0)});for(let t=0;t<a.records.length;t++){let e=a.records[t];e.w2ui&&null!=e.w2ui.parent_recid&&(e.w2ui._path=null)}return this.selectionRestore(i),e=(new Date).getTime()-e,!0!==t&&this.show.statusSort&&setTimeout(()=>{this.status(w2utils.lang("Sorting took ${count} seconds",{count:e/1e3}))},10),e;function r(e){if(!e.w2ui||null==e.w2ui.parent_recid)return[e];if(e.w2ui._path)return e.w2ui._path;var t=a.get(e.w2ui.parent_recid);return t?r(t).concat(e):(console.log("ERROR: no parent record: "+e.w2ui.parent_recid),[e])}function n(s,l){if(s===l)return 0;for(let i=0;i<a.sortData.length;i++){var r=a.sortData[i].field,n=a.sortData[i].field_||r;let e=s[n],t=l[n];-1!=String(r).indexOf(".")&&(e=a.parseField(s,n),t=a.parseField(l,n));n=a.getColumn(r),r=(n&&0<Object.keys(n.editable).length&&(w2utils.isPlainObject(e)&&e.text&&(e=e.text),w2utils.isPlainObject(t)&&t.text&&(t=t.text)),o(e,t,i,a.sortData[i].direction,n.sortMode||"default"));if(0!==r)return r}return o(s.recid,l.recid,0,"asc")}function o(e,t,i,s,l){if(e===t)return 0;if((null==e||""===e)&&null!=t&&""!==t)return 1;if(null!=e&&""!==e&&(null==t||""===t))return-1;s="asc"===s.toLowerCase()?1:-1;if(typeof e!=typeof t)return typeof t<typeof e?s:-s;if(e.constructor.name!=t.constructor.name)return e.constructor.name>t.constructor.name?s:-s;e&&"object"==typeof e&&(e=e.valueOf()),t&&"object"==typeof t&&(t=t.valueOf());var r={}.toString;switch(e&&"object"==typeof e&&e.toString!=r&&(e=String(e)),t&&"object"==typeof t&&t.toString!=r&&(t=String(t)),"string"==typeof e&&(e=e.toLowerCase().trim()),"string"==typeof t&&(t=t.toLowerCase().trim()),l){case"natural":l=w2utils.naturalCompare;break;case"i18n":l=w2utils.i18nCompare}return"function"==typeof l?l(e,t)*s:t<e?s:e<t?-s:0}}}localSearch(t){let c=this;var i="object"!=typeof this.url?this.url:this.url.get;if(i)console.log("ERROR: grid.localSearch can only be used on local data source, grid.url should be empty.");else{let e=(new Date).getTime(),u={}.toString,l={};if(this.total=this.records.length,this.last.searchIds=[],this.prepareData(),0<this.searchData.length&&!i){for(let s=this.total=0;s<this.records.length;s++){var r=this.records[s];if(function i(l){let r=0,n,a,o,h;let d=!1;for(let e=0;e<c.searchData.length;e++){let i=c.searchData[e],s=c.getSearch(i.field);if(null!=i){null==s&&(s={field:i.field,type:i.type});let t=c.parseField(l,s.field);switch(n=null===t||void 0===t||"object"==typeof t&&t.toString==u?"":String(t).toLowerCase(),null!=i.value&&(Array.isArray(i.value)?(a=i.value[0],o=i.value[1]):a=String(i.value).toLowerCase()),i.operator){case"=":case"is":c.parseField(l,s.field)==i.value?r++:"date"==s.type?(h=c.parseField(l,s.field+"_")instanceof Date?c.parseField(l,s.field+"_"):c.parseField(l,s.field),n=w2utils.formatDate(h,"yyyy-mm-dd"),a=w2utils.formatDate(w2utils.isDate(a,w2utils.settings.dateFormat,!0),"yyyy-mm-dd"),n==a&&r++):"time"==s.type?(h=c.parseField(l,s.field+"_")instanceof Date?c.parseField(l,s.field+"_"):c.parseField(l,s.field),n=w2utils.formatTime(h,"hh24:mi"),a=w2utils.formatTime(a,"hh24:mi"),n==a&&r++):"datetime"==s.type&&(h=c.parseField(l,s.field+"_")instanceof Date?c.parseField(l,s.field+"_"):c.parseField(l,s.field),n=w2utils.formatDateTime(h,"yyyy-mm-dd|hh24:mm:ss"),a=w2utils.formatDateTime(w2utils.isDateTime(a,w2utils.settings.datetimeFormat,!0),"yyyy-mm-dd|hh24:mm:ss"),n==a&&r++);break;case"between":-1!=["int","float","money","currency","percent"].indexOf(s.type)?parseFloat(c.parseField(l,s.field))>=parseFloat(a)&&parseFloat(c.parseField(l,s.field))<=parseFloat(o)&&r++:"date"==s.type?(h=c.parseField(l,s.field+"_")instanceof Date?c.parseField(l,s.field+"_"):c.parseField(l,s.field),n=w2utils.isDate(h,w2utils.settings.dateFormat,!0),a=w2utils.isDate(a,w2utils.settings.dateFormat,!0),null!=(o=w2utils.isDate(o,w2utils.settings.dateFormat,!0))&&(o=new Date(o.getTime()+864e5)),n>=a&&n<o&&r++):"time"==s.type?(n=c.parseField(l,s.field+"_")instanceof Date?c.parseField(l,s.field+"_"):c.parseField(l,s.field),a=w2utils.isTime(a,!0),o=w2utils.isTime(o,!0),a=(new Date).setHours(a.hours,a.minutes,a.seconds||0,0),o=(new Date).setHours(o.hours,o.minutes,o.seconds||0,0),n>=a&&n<o&&r++):"datetime"==s.type&&(n=c.parseField(l,s.field+"_")instanceof Date?c.parseField(l,s.field+"_"):c.parseField(l,s.field),a=w2utils.isDateTime(a,w2utils.settings.datetimeFormat,!0),o=(o=w2utils.isDateTime(o,w2utils.settings.datetimeFormat,!0))&&new Date(o.getTime()+864e5),n>=a&&n<o&&r++);break;case"<=":d=!0;case"<":case"less":-1!=["int","float","money","currency","percent"].indexOf(s.type)?(n=parseFloat(c.parseField(l,s.field)),a=parseFloat(i.value),(n<a||d&&n===a)&&r++):"date"==s.type?(h=c.parseField(l,s.field+"_")instanceof Date?c.parseField(l,s.field+"_"):c.parseField(l,s.field),n=w2utils.isDate(h,w2utils.settings.dateFormat,!0),a=w2utils.isDate(a,w2utils.settings.dateFormat,!0),(n<a||d&&n===a)&&r++):"time"==s.type?(h=c.parseField(l,s.field+"_")instanceof Date?c.parseField(l,s.field+"_"):c.parseField(l,s.field),n=w2utils.formatTime(h,"hh24:mi"),a=w2utils.formatTime(a,"hh24:mi"),(n<a||d&&n===a)&&r++):"datetime"==s.type&&(h=c.parseField(l,s.field+"_")instanceof Date?c.parseField(l,s.field+"_"):c.parseField(l,s.field),n=w2utils.formatDateTime(h,"yyyy-mm-dd|hh24:mm:ss"),a=w2utils.formatDateTime(w2utils.isDateTime(a,w2utils.settings.datetimeFormat,!0),"yyyy-mm-dd|hh24:mm:ss"),n.length==a.length&&(n<a||d&&n===a)&&r++);break;case">=":d=!0;case">":case"more":-1!=["int","float","money","currency","percent"].indexOf(s.type)?(n=parseFloat(c.parseField(l,s.field)),a=parseFloat(i.value),(n>a||d&&n===a)&&r++):"date"==s.type?(h=c.parseField(l,s.field+"_")instanceof Date?c.parseField(l,s.field+"_"):c.parseField(l,s.field),n=w2utils.isDate(h,w2utils.settings.dateFormat,!0),a=w2utils.isDate(a,w2utils.settings.dateFormat,!0),(n>a||d&&n===a)&&r++):"time"==s.type?(h=c.parseField(l,s.field+"_")instanceof Date?c.parseField(l,s.field+"_"):c.parseField(l,s.field),n=w2utils.formatTime(h,"hh24:mi"),a=w2utils.formatTime(a,"hh24:mi"),(n>a||d&&n===a)&&r++):"datetime"==s.type&&(h=c.parseField(l,s.field+"_")instanceof Date?c.parseField(l,s.field+"_"):c.parseField(l,s.field),n=w2utils.formatDateTime(h,"yyyy-mm-dd|hh24:mm:ss"),a=w2utils.formatDateTime(w2utils.isDateTime(a,w2utils.settings.datetimeFormat,!0),"yyyy-mm-dd|hh24:mm:ss"),n.length==a.length&&(n>a||d&&n===a)&&r++);break;case"in":h=i.value,-1===(h=i.svalue?i.svalue:h).indexOf(w2utils.isFloat(t)?parseFloat(t):t)&&-1===h.indexOf(n)||r++;break;case"not in":h=i.value,-1===(h=i.svalue?i.svalue:h).indexOf(w2utils.isFloat(t)?parseFloat(t):t)&&-1===h.indexOf(n)&&r++;break;case"begins":case"begins with":0===n.indexOf(a)&&r++;break;case"contains":0<=n.indexOf(a)&&r++;break;case"null":null==c.parseField(l,s.field)&&r++;break;case"not null":null!=c.parseField(l,s.field)&&r++;break;case"ends":case"ends with":let e=n.lastIndexOf(a);-1!==e&&e==n.length-a.length&&r++}}}if("OR"==c.last.logic&&0!==r||"AND"==c.last.logic&&r==c.searchData.length)return!0;if(l.w2ui&&l.w2ui.children&&!0!==l.w2ui.expanded)for(let t=0;t<l.w2ui.children.length;t++){let e=l.w2ui.children[t];if(i(e))return!0}return!1}(r))if(r&&r.w2ui&&!function e(t){let i=c.get(t,!0);if(null==i||null==t||l[t]||c.last.searchIds.includes(i))return;l[t]=!0;let s=c.records[i];s&&s.w2ui&&e(s.w2ui.parent_recid);c.last.searchIds.push(i)}(r.w2ui.parent_recid),0<this.showExtraOnSearch){let t=this.showExtraOnSearch,i=this.showExtraOnSearch;if(s<t&&(t=s),s+i>this.records.length&&(i=this.records.length-s),0<t)for(let e=s-t;e<s;e++)this.last.searchIds.indexOf(e)<0&&this.last.searchIds.push(e);if(this.last.searchIds.indexOf(s)<0&&this.last.searchIds.push(s),0<i)for(let e=s+1;e<=s+i;e++)this.last.searchIds.indexOf(e)<0&&this.last.searchIds.push(e)}else this.last.searchIds.push(s)}this.total=this.last.searchIds.length}return e=(new Date).getTime()-e,!0!==t&&this.show.statusSearch&&setTimeout(()=>{this.status(w2utils.lang("Search took ${count} seconds",{count:e/1e3}))},10),e}}getRangeData(e,i){var s=this.get(e[0].recid,!0),l=this.get(e[1].recid,!0),r=e[0].column,n=e[1].column;let a=[];if(r==n)for(let e=s;e<=l;e++){var t=this.records[e],o=t[this.columns[r].field]||null;!0!==i?a.push(o):a.push({data:o,column:r,index:e,record:t})}else if(s==l){var h=this.records[s];for(let e=r;e<=n;e++){var d=h[this.columns[e].field]||null;!0!==i?a.push(d):a.push({data:d,column:e,index:s,record:h})}}else for(let t=s;t<=l;t++){var u=this.records[t];a.push([]);for(let e=r;e<=n;e++){var c=u[this.columns[e].field];!0!==i?a[a.length-1].push(c):a[a.length-1].push({data:c,column:e,index:t,record:u})}}return a}addRange(s){let e=0,l,r;if("row"==this.selectType)return e;Array.isArray(s)||(s=[s]);for(let i=0;i<s.length;i++){if("object"!=typeof s[i]&&(s[i]={name:"selection"}),"selection"==s[i].name){if(!1===this.show.selectionBorder)continue;var n=this.getSelection();if(0===n.length){this.removeRange("selection");continue}l=n[0],r=n[n.length-1]}else l=s[i].range[0],r=s[i].range[1];if(l){n={name:s[i].name,range:[{recid:l.recid,column:l.column},{recid:r.recid,column:r.column}],style:s[i].style||""};let t=!1;for(let e=0;e<this.ranges.length;e++)if(this.ranges[e].name==s[i].name){t=e;break}!1!==t?this.ranges[t]=n:this.ranges.push(n),e++}}return this.refreshRanges(),e}removeRange(){let t=0;for(let e=0;e<arguments.length;e++){var i=arguments[e];query(this.box).find("#grid_"+this.name+"_"+i).remove(),query(this.box).find("#grid_"+this.name+"_f"+i).remove();for(let e=this.ranges.length-1;0<=e;e--)this.ranges[e].name==i&&(this.ranges.splice(e,1),t++)}return t}refreshRanges(){if(0!==this.ranges.length){let r=this,d;var e=(new Date).getTime();let u=query(this.box).find("#grid_"+this.name+"_frecords"),c=query(this.box).find("#grid_"+this.name+"_records");for(let h=0;h<this.ranges.length;h++){var p=this.ranges[h];let e=p.range[0],t=p.range[1],i=(null==e.index&&(e.index=this.get(e.recid,!0)),null==t.index&&(t.index=this.get(t.recid,!0)),query(this.box).find("#grid_"+this.name+"_rec_"+w2utils.escapeId(e.recid)+' td[col="'+e.column+'"]')),s=query(this.box).find("#grid_"+this.name+"_rec_"+w2utils.escapeId(t.recid)+' td[col="'+t.column+'"]'),l=query(this.box).find("#grid_"+this.name+"_frec_"+w2utils.escapeId(e.recid)+' td[col="'+e.column+'"]'),r=query(this.box).find("#grid_"+this.name+"_frec_"+w2utils.escapeId(t.recid)+' td[col="'+t.column+'"]'),n=t.column;e.column<this.last.colStart&&t.column>this.last.colStart&&(i=query(this.box).find("#grid_"+this.name+"_rec_"+w2utils.escapeId(e.recid)+' td[col="start"]')),e.column<this.last.colEnd&&t.column>this.last.colEnd&&(s=query(this.box).find("#grid_"+this.name+"_rec_"+w2utils.escapeId(t.recid)+' td[col="end"]'),n='"end"');var f=parseInt(query(this.box).find("#grid_"+this.name+"_rec_top").next().attr("index")),m=parseInt(query(this.box).find("#grid_"+this.name+"_rec_bottom").prev().attr("index")),g=parseInt(query(this.box).find("#grid_"+this.name+"_frec_top").next().attr("index")),w=parseInt(query(this.box).find("#grid_"+this.name+"_frec_bottom").prev().attr("index"));0===i.length&&e.index<f&&t.index>f&&(i=query(this.box).find("#grid_"+this.name+"_rec_top").next().find("td[col="+e.column+"]")),0===s.length&&t.index>m&&e.index<m&&(s=query(this.box).find("#grid_"+this.name+"_rec_bottom").prev().find("td[col="+n+"]")),0===l.length&&e.index<g&&t.index>g&&(l=query(this.box).find("#grid_"+this.name+"_frec_top").next().find("td[col="+e.column+"]")),0===r.length&&t.index>w&&e.index<w&&(r=query(this.box).find("#grid_"+this.name+"_frec_bottom").prev().find("td[col="+t.column+"]"));let a=query(this.box).find("#grid_"+this.name+"_editable"),o=a.find(".w2ui-input");var y,f=o.attr("recid"),m=o.attr("column");"selection"==p.name&&p.range[0].recid==f&&p.range[0].column==m||(d=query(this.box).find("#grid_"+this.name+"_f"+p.name),0<l.length||0<r.length?(0===d.length?(u.append('<div id="grid_'+this.name+"_f"+p.name+'" class="w2ui-selection" style="'+p.style+'">'+("selection"==p.name?'<div id="grid_'+this.name+'_resizer" class="w2ui-selection-resizer"></div>':"")+"</div>"),d=query(this.box).find("#grid_"+this.name+"_f"+p.name)):(d.attr("style",p.style),d.find(".w2ui-selection-resizer").show()),0===r.length&&(0===(r=query(this.box).find("#grid_"+this.name+"_frec_"+w2utils.escapeId(t.recid)+" td:last-child")).length&&(r=query(this.box).find("#grid_"+this.name+"_frec_bottom td:first-child")),d.css("border-right","0px"),d.find(".w2ui-selection-resizer").hide()),null!=e.recid&&null!=t.recid&&0<l.length&&0<r.length?(g=getComputedStyle(r[0]),w=l.prop("offsetTop")-l.prop("scrollTop"),f=l.prop("offsetLeft")+l.prop("scrollLeft"),m=r.prop("offsetTop")-r.prop("scrollTop"),y=r.prop("offsetLeft")+r.prop("scrollLeft"),d.show().css({top:(0<w?w:0)+"px",left:(0<f?f:0)+"px",width:y-f+parseFloat(g.width)+2+"px",height:m-w+parseFloat(g.height)+1+"px"})):d.hide()):d.hide(),d=query(this.box).find("#grid_"+this.name+"_"+p.name),0<i.length||0<s.length?(0===d.length?(c.append('<div id="grid_'+this.name+"_"+p.name+'" class="w2ui-selection" style="'+p.style+'">'+("selection"==p.name?'<div id="grid_'+this.name+'_resizer" class="w2ui-selection-resizer"></div>':"")+"</div>"),d=query(this.box).find("#grid_"+this.name+"_"+p.name)):d.attr("style",p.style),0===i.length&&0===(i=query(this.box).find("#grid_"+this.name+"_rec_"+w2utils.escapeId(e.recid)+" td:first-child")).length&&(i=query(this.box).find("#grid_"+this.name+"_rec_top td:first-child")),0!==r.length&&d.css("border-left","0px"),null!=e.recid&&null!=t.recid&&0<i.length&&0<s.length?(y=getComputedStyle(s[0]),f=i.prop("offsetTop")-i.prop("scrollTop"),m=i.prop("offsetLeft")+i.prop("scrollLeft"),w=s.prop("offsetTop")-s.prop("scrollTop"),g=s.prop("offsetLeft")+s.prop("scrollLeft"),d.show().css({top:(0<f?f:0)+"px",left:(0<m?m:0)+"px",width:g-m+parseFloat(y.width)+2+"px",height:w-f+parseFloat(y.height)+1+"px"})):d.hide()):d.hide())}query(this.box).find(".w2ui-selection-resizer").off(".resizer").on("mousedown.resizer",function(e){var t=r.getSelection();r.last.move={type:"expand",x:e.screenX,y:e.screenY,divX:0,divY:0,recid:t[0].recid,column:t[0].column,originalRange:[w2utils.clone(t[0]),w2utils.clone(t[t.length-1])],newRange:[w2utils.clone(t[0]),w2utils.clone(t[t.length-1])]},query("body").off(".w2ui-"+r.name).on("mousemove.w2ui-"+r.name,i).on("mouseup.w2ui-"+r.name,s),e.preventDefault()}).on("dblclick.resizer",e=>{let t=this.trigger("resizerDblClick",{target:this.name,originalEvent:e});!0!==t.isCancelled&&t.finish()});let n={target:this.name,originalRange:null,newRange:null};return(new Date).getTime()-e;function i(s){let l=r.last.move;if(l&&"expand"==l.type){l.divX=s.screenX-l.x,l.divY=s.screenY-l.y;let e,t,i=s.target;"TD"!=i.tagName.toUpperCase()&&(i=query(i).closest("td")[0]),null!=(t=null!=query(i).attr("col")?parseInt(query(i).attr("col")):t)&&(i=query(i).closest("tr")[0],e=r.records[query(i).attr("index")].recid,l.newRange[1].recid==e&&l.newRange[1].column==t||(s=w2utils.clone(l.newRange),l.newRange=[{recid:l.recid,column:l.column},{recid:e,column:t}],n.detail&&(n.detail.newRange=w2utils.clone(l.newRange),n.detail.originalRange=w2utils.clone(l.originalRange)),!0===(n=r.trigger("selectionExtend",n)).isCancelled?(l.newRange=s,n.detail.newRange=s):(r.removeRange("grid-selection-expand"),r.addRange({name:"grid-selection-expand",range:l.newRange,style:"background-color: rgba(100,100,100,0.1); border: 2px dotted rgba(100,100,100,0.5);"}))))}}function s(e){r.removeRange("grid-selection-expand"),delete r.last.move,query("body").off(".w2ui-"+r.name),n.finish&&n.finish()}}}select(){if(0===arguments.length)return 0;let n=0,a=this.last.selection,t=(this.multiSelect||this.selectNone(),Array.from(arguments)),e=(Array.isArray(t[0])&&(t=t[0]),{target:this.name}),i=(1==t.length?(e.multiple=!1,w2utils.isPlainObject(t[0])?(e.recid=t[0].recid,e.column=t[0].column):e.recid=t[0]):(e.multiple=!0,e.recids=t),this.trigger("select",e));if(!0===i.isCancelled)return 0;if("row"==this.selectType)for(let e=0;e<t.length;e++){var s="object"==typeof t[e]?t[e].recid:t[e],l=this.get(s,!0);if(null!=l){let e=null,t=null;(0!==this.searchData.length||l+1>=this.last.range_start&&l+1<=this.last.range_end)&&(e=$(this.box).find("#grid_"+this.name+"_frec_"+w2utils.escapeId(s)),t=$(this.box).find("#grid_"+this.name+"_rec_"+w2utils.escapeId(s))),"row"==this.selectType&&-1==a.indexes.indexOf(l)&&(a.indexes.push(l),e&&t&&(e.addClass("w2ui-selected").data("selected","yes").find(".w2ui-col-number").addClass("w2ui-row-selected"),t.addClass("w2ui-selected").data("selected","yes").find(".w2ui-col-number").addClass("w2ui-row-selected"),e.find(".w2ui-grid-select-check").prop("checked",!0)),n++)}}else{let l={};for(let e=0;e<t.length;e++){var o="object"==typeof t[e]?t[e].recid:t[e],h="object"==typeof t[e]?t[e].column:null;if(l[o]=l[o]||[],Array.isArray(h))l[o]=h;else if(w2utils.isInt(h))l[o].push(h);else for(let e=0;e<this.columns.length;e++)this.columns[e].hidden||l[o].push(parseInt(e))}let r=[];for(var d in l){var u=this.get(d,!0);if(null!=u){let t=null,i=null,s=(u+1>=this.last.range_start&&u+1<=this.last.range_end&&(t=$(this.box).find("#grid_"+this.name+"_rec_"+w2utils.escapeId(d)),i=$(this.box).find("#grid_"+this.name+"_frec_"+w2utils.escapeId(d))),a.columns[u]||[]);-1==a.indexes.indexOf(u)&&a.indexes.push(u);for(let e=0;e<l[d].length;e++)-1==s.indexOf(l[d][e])&&s.push(l[d][e]);s.sort((e,t)=>e-t);for(let e=0;e<l[d].length;e++){var c=l[d][e];-1==r.indexOf(c)&&r.push(c),t&&(t.find("#grid_"+this.name+"_data_"+u+"_"+c).addClass("w2ui-selected"),t.find(".w2ui-col-number").addClass("w2ui-row-selected"),t.data("selected","yes"),t.find(".w2ui-grid-select-check").prop("checked",!0)),i&&(i.find("#grid_"+this.name+"_data_"+u+"_"+c).addClass("w2ui-selected"),i.find(".w2ui-col-number").addClass("w2ui-row-selected"),i.data("selected","yes"),i.find(".w2ui-grid-select-check").prop("checked",!0)),n++}a.columns[u]=s}}for(let e=0;e<r.length;e++)$(this.box).find("#grid_"+this.name+"_column_"+r[e]+" .w2ui-col-header").addClass("w2ui-col-selected")}a.indexes.sort((e,t)=>e-t);var r=0<this.records.length&&a.indexes.length==this.records.length,p=0<a.indexes.length&&0!==this.searchData.length&&a.indexes.length==this.last.searchIds.length;return r||p?$(this.box).find("#grid_"+this.name+"_check_all").prop("checked",!0):$(this.box).find("#grid_"+this.name+"_check_all").prop("checked",!1),this.status(),this.addRange("selection"),this.updateToolbar(a,r),i.finish(),n}unselect(){let r=0,n=this.last.selection,i=Array.from(arguments),e=(Array.isArray(i[0])&&(i=i[0]),{target:this.name}),t=(1==i.length?(e.multiple=!1,w2utils.isPlainObject(i[0])?(e.recid=i[0].recid,e.column=i[0].column):e.recid=i[0]):(e.multiple=!0,e.recids=i),this.trigger("unselect",e));if(!0===t.isCancelled)return 0;for(let t=0;t<i.length;t++){var a="object"==typeof i[t]?i[t].recid:i[t],o=this.get(a);if(null!=o){o=this.get(o.recid,!0);let s=$(this.box).find("#grid_"+this.name+"_frec_"+w2utils.escapeId(a)),l=$(this.box).find("#grid_"+this.name+"_rec_"+w2utils.escapeId(a));if("row"==this.selectType)-1!=n.indexes.indexOf(o)&&(n.indexes.splice(n.indexes.indexOf(o),1),s.removeClass("w2ui-selected w2ui-inactive").removeData("selected").find(".w2ui-col-number").removeClass("w2ui-row-selected"),l.removeClass("w2ui-selected w2ui-inactive").removeData("selected").find(".w2ui-col-number").removeClass("w2ui-row-selected"),0!=s.length&&(s[0].style.cssText="height: "+this.recordHeight+"px; "+s.attr("custom_style"),l[0].style.cssText="height: "+this.recordHeight+"px; "+l.attr("custom_style")),s.find(".w2ui-grid-select-check").prop("checked",!1),r++);else{var h=i[t].column;if(!w2utils.isInt(h)){let t=[];for(let e=0;e<this.columns.length;e++)this.columns[e].hidden||t.push({recid:a,column:e});return this.unselect(t)}let e=n.columns[o];if(Array.isArray(e)&&-1!=e.indexOf(h)){e.splice(e.indexOf(h),1),$(this.box).find("#grid_"+this.name+"_rec_"+w2utils.escapeId(a)).find(" > td[col="+h+"]").removeClass("w2ui-selected w2ui-inactive"),$(this.box).find("#grid_"+this.name+"_frec_"+w2utils.escapeId(a)).find(" > td[col="+h+"]").removeClass("w2ui-selected w2ui-inactive");let t=!1,i=!1;var d=this.getSelection();for(let e=0;e<d.length;e++)d[e].column==h&&(t=!0),d[e].recid==a&&(i=!0);t||$(this.box).find(".w2ui-grid-columns td[col="+h+"] .w2ui-col-header, .w2ui-grid-fcolumns td[col="+h+"] .w2ui-col-header").removeClass("w2ui-col-selected"),i||$(this.box).find("#grid_"+this.name+"_frec_"+w2utils.escapeId(a)).find(".w2ui-col-number").removeClass("w2ui-row-selected"),r++,0===e.length&&(delete n.columns[o],n.indexes.splice(n.indexes.indexOf(o),1),s.removeData("selected"),s.find(".w2ui-grid-select-check").prop("checked",!1),l.removeData("selected"))}}}}var s=0<this.records.length&&n.indexes.length==this.records.length,l=0<n.indexes.length&&0!==this.searchData.length&&n.indexes.length==this.last.searchIds.length;return s||l?$(this.box).find("#grid_"+this.name+"_check_all").prop("checked",!0):$(this.box).find("#grid_"+this.name+"_check_all").prop("checked",!1),this.status(),this.addRange("selection"),this.updateToolbar(n,s),t.finish(),r}selectAll(){var t=(new Date).getTime();if(!1!==this.multiSelect){let e=this.trigger("select",{target:this.name,all:!0});if(!0!==e.isCancelled){var l="object"!=typeof this.url?this.url:this.url.get;let i=this.last.selection,s=[];for(let e=0;e<this.columns.length;e++)s.push(e);if(i.indexes=[],l||0===this.searchData.length){let t=this.records.length;0==this.searchData.length||l||(t=this.last.searchIds.length);for(let e=0;e<t;e++)i.indexes.push(e),"row"!=this.selectType&&(i.columns[e]=s.slice())}else for(let e=0;e<this.last.searchIds.length;e++)i.indexes.push(this.last.searchIds[e]),"row"!=this.selectType&&(i.columns[this.last.searchIds[e]]=s.slice());return"row"==this.selectType?($(this.box).find(".w2ui-grid-records tr").not(".w2ui-empty-record").addClass("w2ui-selected").data("selected","yes").find(".w2ui-col-number").addClass("w2ui-row-selected"),$(this.box).find(".w2ui-grid-frecords tr").not(".w2ui-empty-record").addClass("w2ui-selected").data("selected","yes").find(".w2ui-col-number").addClass("w2ui-row-selected")):($(this.box).find(".w2ui-grid-columns td .w2ui-col-header, .w2ui-grid-fcolumns td .w2ui-col-header").addClass("w2ui-col-selected"),$(this.box).find(".w2ui-grid-records tr .w2ui-col-number").addClass("w2ui-row-selected"),$(this.box).find(".w2ui-grid-records tr").not(".w2ui-empty-record").find(".w2ui-grid-data").not(".w2ui-col-select").addClass("w2ui-selected").data("selected","yes"),$(this.box).find(".w2ui-grid-frecords tr .w2ui-col-number").addClass("w2ui-row-selected"),$(this.box).find(".w2ui-grid-frecords tr").not(".w2ui-empty-record").find(".w2ui-grid-data").not(".w2ui-col-select").addClass("w2ui-selected").data("selected","yes")),$(this.box).find("input.w2ui-grid-select-check").prop("checked",!0),i=this.getSelection(!0),this.addRange("selection"),$(this.box).find("#grid_"+this.name+"_check_all").prop("checked",!0),this.status(),this.updateToolbar({indexes:i},!0),e.finish(),(new Date).getTime()-t}}}selectNone(){var t=(new Date).getTime();let i=this.trigger("unselect",{target:this.name,all:!0});if(!0!==i.isCancelled){let e=this.last.selection;return"row"==this.selectType?($(this.box).find(".w2ui-grid-records tr.w2ui-selected").removeClass("w2ui-selected w2ui-inactive").removeData("selected").find(".w2ui-col-number").removeClass("w2ui-row-selected"),$(this.box).find(".w2ui-grid-frecords tr.w2ui-selected").removeClass("w2ui-selected w2ui-inactive").removeData("selected").find(".w2ui-col-number").removeClass("w2ui-row-selected")):($(this.box).find(".w2ui-grid-columns td .w2ui-col-header, .w2ui-grid-fcolumns td .w2ui-col-header").removeClass("w2ui-col-selected"),$(this.box).find(".w2ui-grid-records tr .w2ui-col-number").removeClass("w2ui-row-selected"),$(this.box).find(".w2ui-grid-frecords tr .w2ui-col-number").removeClass("w2ui-row-selected"),$(this.box).find(".w2ui-grid-data.w2ui-selected").removeClass("w2ui-selected w2ui-inactive").removeData("selected")),$(this.box).find("input.w2ui-grid-select-check").prop("checked",!1),e.indexes=[],e.columns={},this.removeRange("selection"),$(this.box).find("#grid_"+this.name+"_check_all").prop("checked",!1),this.status(),this.updateToolbar(e,!1),i.finish(),(new Date).getTime()-t}}updateToolbar(s){let l=this,r=s&&s.indexes?s.indexes.length:0;function i(t,i){if(null!=t.batch){let e=!1;!0===t.batch?0<r&&(e=!0):"number"==typeof t.batch?r===t.batch&&(e=!0):"function"==typeof t.batch&&(e=t.batch({cnt:r,sel:s})),e?l.toolbar.enable(i+t.id):l.toolbar.disable(i+t.id)}}this.toolbar.items.forEach(t=>{i(t,""),Array.isArray(t.items)&&t.items.forEach(e=>{i(e,t.id+":")})}),this.show.toolbarSave&&(0<this.getChanges().length?this.toolbar.enable("w2ui-save"):this.toolbar.disable("w2ui-save"))}getSelection(t){let i=[];var s=this.last.selection;if("row"==this.selectType){for(let e=0;e<s.indexes.length;e++)this.records[s.indexes[e]]&&(!0===t?i.push(s.indexes[e]):i.push(this.records[s.indexes[e]].recid));return i}for(let t=0;t<s.indexes.length;t++){var l=s.columns[s.indexes[t]];if(this.records[s.indexes[t]])for(let e=0;e<l.length;e++)i.push({recid:this.records[s.indexes[t]].recid,index:parseInt(s.indexes[t]),column:l[e]})}return i}search(l,r){var i,s,e="object"!=typeof this.url?this.url:this.url.get;let a=[],o=this.last.multi,t=this.last.logic,n=this.last.field,h=this.last.search,d=!1;for(let e=0;e<this.searches.length;e++)this.searches[e].hidden&&null!=this.searches[e].value&&(a.push({field:this.searches[e].field,operator:this.searches[e].operator||"is",type:this.searches[e].type,value:this.searches[e].value||""}),d=!0);if(0===arguments.length){this.focus(),t=$(this.box).find(`#grid_${this.name}_logic`).val(),h="";for(let e=0;e<this.searches.length;e++){var u=this.searches[e],c=$(this.box).find("#grid_"+this.name+"_operator_"+e).val();let i=$(this.box).find("#grid_"+this.name+"_field_"+e),s=$(this.box).find("#grid_"+this.name+"_field2_"+e),l=i.val(),r=s.val(),t=null,n=null;if(-1!=["int","float","money","currency","percent"].indexOf(u.type)){let e=i.data("w2field"),t=s.data("w2field");e&&(l=e.clean(l)),t&&(r=t.clean(r))}if(-1!=["list","enum"].indexOf(u.type)||-1!=["in","not in"].indexOf(c))if(l=i.data("selected")||{},Array.isArray(l)){t=[];for(let e=0;e<l.length;e++)t.push(w2utils.isFloat(l[e].id)?parseFloat(l[e].id):String(l[e].id).toLowerCase()),delete l[e].hidden;0===Object.keys(l).length&&(l="")}else n=l.text||"",l=l.id||"";if(""!==l&&null!=l||null!=r&&""!==r){let e={field:u.field,type:u.type,operator:c};"between"==c?w2utils.extend(e,{value:[l,r]}):"in"==c&&"string"==typeof l||"not in"==c&&"string"==typeof l?w2utils.extend(e,{value:l.split(",")}):w2utils.extend(e,{value:l}),t&&w2utils.extend(e,{svalue:t}),n&&w2utils.extend(e,{text:n});try{"date"==u.type&&"between"==c&&(e.value[0]=l,e.value[1]=r),"date"==u.type&&"is"==c&&(e.value=l)}catch(e){}a.push(e),o=!0}}}if("string"==typeof l&&(1==arguments.length&&(r=l,l="all"),n=l,h=r,o=!1,t=d?"AND":"OR",null!=r))if("all"==l.toLowerCase())if(0<this.searches.length)for(let t=0;t<this.searches.length;t++){let e=this.searches[t];if(("text"==e.type||"alphanumeric"==e.type&&w2utils.isAlphaNumeric(r)||"int"==e.type&&w2utils.isInt(r)||"float"==e.type&&w2utils.isFloat(r)||"percent"==e.type&&w2utils.isFloat(r)||("hex"==e.type||"color"==e.type)&&w2utils.isHex(r)||"currency"==e.type&&w2utils.isMoney(r)||"money"==e.type&&w2utils.isMoney(r)||"date"==e.type&&w2utils.isDate(r)||"time"==e.type&&w2utils.isTime(r)||"datetime"==e.type&&w2utils.isDateTime(r)||"datetime"==e.type&&w2utils.isDate(r)||"enum"==e.type&&w2utils.isAlphaNumeric(r)||"list"==e.type&&w2utils.isAlphaNumeric(r))&&(i=this.defaultOperator[this.operatorsMap[e.type]],i={field:e.field,type:e.type,operator:null!=e.operator?e.operator:i,value:r},""!=String(r).trim()&&a.push(i)),-1!=["int","float","money","currency","percent"].indexOf(e.type)&&2==String(r).trim().split("-").length&&(i=String(r).trim().split("-"),s={field:e.field,type:e.type,operator:null!=e.operator?e.operator:"between",value:[i[0],i[1]]},a.push(s)),-1!=["list","enum"].indexOf(e.type)){let i=[];null==e.options&&(e.options={}),Array.isArray(e.options.items)||(e.options.items=[]);for(let t=0;t<e.options.items;t++){var p=e.options.items[t];try{let e=new RegExp(r,"i");e.test(p)&&i.push(t),p.text&&e.test(p.text)&&i.push(p.id)}catch(e){}}0<i.length&&(s={field:e.field,type:e.type,operator:null!=e.operator?e.operator:"in",value:i},a.push(s))}}else for(let e=0;e<this.columns.length;e++){var f={field:this.columns[e].field,type:"text",operator:this.defaultOperator.text,value:r};a.push(f)}else{let i=$(this.box).find("#grid_"+this.name+"_search_all"),s=this.getSearch(l);if((s=null==s?{field:l,type:"text"}:s).field==l&&(this.last.label=s.label),""!==r){let e=this.defaultOperator[this.operatorsMap[s.type]],t=r;if(-1!=["date","time","datetime"].indexOf(s.type)&&(e="is"),-1!=["list","enum"].indexOf(s.type)&&(e="is",g=i.data("selected"),t=g&&0<Object.keys(g).length?g.id:""),"int"==s.type&&""!==r)if(e="is",-1==String(r).indexOf("-")||2==(g=r.split("-")).length&&(e="between",t=[parseInt(g[0]),parseInt(g[1])]),-1!=String(r).indexOf(",")){var m=r.split(",");e="in",t=[];for(let e=0;e<m.length;e++)t.push(m[e])}null!=s.operator&&(e=s.operator);var g={field:s.field,type:s.type,operator:e,value:t};a.push(g)}}if(Array.isArray(l)){let e="AND";"string"==typeof r&&"OR"!=(e=r.toUpperCase())&&"AND"!=e&&(e="AND"),h="",o=!0,t=e;for(let t=0;t<l.length;t++){let e=l[t];"number"==typeof e.value&&(e.operator=this.defaultOperator.number),"string"==typeof e.value&&(e.operator=this.defaultOperator.text),Array.isArray(e.value)&&(e.operator=this.defaultOperator.enum),w2utils.isDate(e.value)&&(e.operator=this.defaultOperator.date),a.push(e)}}let w=this.trigger("search",{target:this.name,multi:0===arguments.length,searchField:l||"multi",searchValue:l?r:"multi",searchData:a,searchLogic:t});!0!==w.isCancelled&&(this.searchData=w.detail.searchData,this.last.field=n,this.last.search=h,this.last.multi=o,this.last.logic=w.detail.searchLogic,this.last.scrollTop=0,this.last.scrollLeft=0,this.last.selection.indexes=[],this.last.selection.columns={},this.searchClose(),e?(this.last.xhr_offset=0,this.reload()):(this.localSearch(),this.refresh()),w.finish())}searchOpen(){if(this.box&&0!==this.searches.length){let i=this.trigger("searchOpen",{target:this.name});if(!0!==i.isCancelled){let t=query(this.toolbar.box).find(".w2ui-grid-search-input .w2ui-search-drop");t.addClass("checked"),w2tooltip.show({name:this.name+"-search-overlay",anchor:query(this.box).find("#grid_"+this.name+"_search_all").get(0),position:"bottom|top",html:this.getSearchesHTML(),align:"left",arrowSize:12,class:"w2ui-grid-search-advanced",hideOn:["doc-click"]}).then(e=>{this.initSearches(),this.last.search_opened=!0,query(`#w2overlay-${this.name}-search-overlay .w2ui-grid-search-advanced`).data("gridName",this.name),w2utils.bindEvents(query(`#w2overlay-${this.name}-search-overlay`).find("select, input, button"),this);let t=query(`#w2overlay-${this.name}-search-overlay *[rel=search]`);0<t.length&&t[0].focus(),i.finish()}).hide(e=>{t.removeClass("checked"),this.last.search_opened=!1})}}}searchClose(){w2tooltip.hide(this.name+"-search-overlay")}searchSuggest(e,t,i){clearTimeout(this.last.kbd_timer),clearTimeout(this.last.overlay_timer),this.searchShowFields(!0),this.searchClose(),!0===t?w2tooltip.hide(this.name+"-search-suggest"):0<$(`#w2overlay-${this.name}-search-suggest`).length||(e?(t=query(this.box).find(`#grid_${this.name}_search_all`).get(0),Array.isArray(this.savedSearches)&&0<this.savedSearches.length&&w2menu.show({name:this.name+"-search-suggest",anchor:t,align:"both",items:this.savedSearches,topHTML:`<div class="w2ui-grid-search-suggest">${w2utils.lang("Saved Searches")}</div>`,hideOn:["doc-click","sleect","remove"],render(e){let t=e.text;return t=e.isDefault?`<b>${t}</b>`:t}}).select(e=>{let t=this.trigger("searchSelect",{target:this.name,index:e.detail.index,item:e.detail.item});!0===t.isCancelled?e.preventDefault():(this.last.logic=e.detail.item.logic||"AND",this.last.search="",this.last.label="[Multiple Fields]",this.searchData=w2utils.clone(e.detail.item.data),this.searchSelected={name:e.detail.item.id,logic:e.detail.item.logic,data:this.searchData},this.reload(),t.finish())}).remove(e=>{let s=e.detail.item,l=this.trigger("searchRemove",{target:this.name,index:e.detail.index,item:s});!0===l.isCancelled?e.preventDefault():this.confirm(w2utils.lang('Do you want to delete search item "${item}"?',{item:s.text})).yes(e=>{if(w2utils.hasLocalStorage&&this.useLocalStorage)try{var t=JSON.parse(localStorage.w2ui||"{}");if(t&&t.searches){let e=t.searches[this.stateId||this.name];Array.isArray(e)&&(null!==(i=e.findIndex((e,t)=>e.name==s.id))&&e.splice(i,1),localStorage.w2ui=JSON.stringify(t))}}catch(e){}var i=this.savedSearches.findIndex((e,t)=>e.name==s.id);null!==i&&this.savedSearches.splice(i,1),e.detail.self.close(),l.finish()}).no(e=>{e.detail.self.close()})})):this.last.overlay_timer=setTimeout(()=>{this.searchSuggest(!0)},100))}searchFieldDrop(t,i,e){let s=this;var l=this.searches[t];let r=this.searchData[i];this.name,this.name,this.getOperators(l.type,l.operators);let n="";switch(l.type){case"text":case"alphanumeric":case"hex":case"color":case"list":case"combo":case"enum":{let e="width: 250px;";-1!=["hex","color"].indexOf(l.type)&&(e="width: 90px;"),n+='<input rel="search" type="text" id="grid_'+this.name+"_field_"+t+'" name="'+l.field+'"    class="w2ui-input" style="'+e+l.style+'" '+l.inTag+"/>";break}case"int":case"float":case"money":case"currency":case"percent":case"date":case"time":case"datetime":let e="width: 80px";"datetime"==l.type&&(e="width: 140px;"),n+='<input rel="search" type="text" class="w2ui-input" style="'+e+l.style+'" id="grid_'+this.name+"_field_"+t+'" name="'+l.field+'" '+l.inTag+'/><span id="grid_'+this.name+"_extra1_"+t+'" style="padding-left: 5px; color: #6f6f6f; font-size: 10px"></span><span id="grid_'+this.name+"_range_"+t+'" style="display: none">&#160;-&#160;&#160;<input rel="search" type="text" class="w2ui-input" style="'+e+l.style+'" id="grid_'+this.name+"_field2_"+t+'" name="'+l.field+'" '+l.inTag+'/></span><span id="grid_'+this.name+"_extra2_"+t+'" style="padding-left: 5px; color: #6f6f6f; font-size: 10px"></span>';break;case"select":n+='<select rel="search" class="w2ui-input" style="'+l.style+'" id="grid_'+this.name+"_field_"+t+'"  name="'+l.field+'" '+l.inTag+'  onclick="event.stopPropagation();"></select>'}let a=r.operator,o=("less"==(a="more"==a&&"date"==r.type?"since":a)&&"date"==r.type&&(a="before"),""),h=r.value;Array.isArray(r.value)?(r.value.forEach(e=>{o+=`<li>${e.text||e}</li>`}),"date"==r.type&&(o="",r.value.forEach(e=>{o+=`<li>${w2utils.formatDate(e)}</li>`}))):"date"==r.type&&(h=w2utils.formatDateTime(h)),w2tooltip.show({name:this.name+"-search-props",anchor:e,class:"w2ui-white",hideOn:"doc-click",html:`
                ...
                </div>`}).then(e=>{query(e.detail.overlay.box).find("#remove").on("click",()=>{s.searchData.splice(""+i,1),s.reload(),s.localSearch(),w2tooltip.hide(this.name+"-search-props")})})}searchSave(){let i="",l=(this.searchSelected&&(i=this.searchSelected.name),this),r=this.trigger("searchSave",{target:this.name,saveLocalStorage:!0});!0!==r.isCancelled&&this.message({width:350,height:150,body:`<div style="padding-top: 29px; text-align: center;">
            ...
            `,onOpen(e){setTimeout(()=>{$(this.box).find("#grid-search-cancel").on("click",()=>{l.message()}),$(this.box).find("#grid-search-save").on("click",()=>{var e,i=$(l.box).find(".w2ui-message .search-name").val();if(l.searchSelected?(e=l.savedSearches.findIndex(e=>e.id==l.searchSelected.name),Object.assign(l.savedSearches[e],{id:i,text:i,logic:l.last.logic,data:w2utils.clone(l.searchData)})):l.savedSearches.push({id:i,text:i,icon:"w2ui-icon-search",remove:!0,logic:l.last.logic,data:l.searchData}),w2utils.hasLocalStorage&&l.useLocalStorage)try{let e=JSON.parse(localStorage.w2ui||"{}"),t=((e=e||{}).searches||(e.searches={}),Array.isArray(e.searches[l.stateId||l.name])||(e.searches[l.stateId||l.name]=[]),e.searches[l.stateId||l.name]);var s=t.findIndex(e=>e.name==l.searchSelected.name);-1!==s?Object.assign(t[s],{name:i,logic:l.last.logic,data:l.searchData}):t.push({name:i,logic:l.last.logic,data:l.searchData}),localStorage.w2ui=JSON.stringify(e)}catch(e){return delete localStorage.w2ui,null}l.message(),l.searchSelected?(l.searchSelected.name=i,$(l.box).find(`#grid_${l.name}_search_name .name-text`).html(i)):(l.searchSelected={name:i,logic:l.last.logic,data:w2utils.clone(l.searchData)},$(l.box).find(`#grid_${l.name}_search_all`).val(" ").prop("readOnly",!0),$(l.box).find(`#grid_${l.name}_search_name`).show().find(".name-text").html(i)),r.finish({name:i})});let t=$(this.box).find("input, button");t.off(".message").on("blur.message",function(e){t.index(e.target)+1===t.length&&(t.get(0).focus(),e.preventDefault())}).on("keydown.message",function(e){var t=String($(l.box).find(".w2ui-message-body input").val()).trim();13==e.keyCode&&""!=t&&$(l.box).find("#grid-search-save").click(),27==e.keyCode&&l.message()}),$(this.box).find(".w2ui-message-body input").on("input",function(e){let t=$(this).closest(".w2ui-message").find("#grid-search-save");""===String($(this).val()).trim()?t.prop("disabled",!0):t.prop("disabled",!1)}).val(i).focus()},25)}})}searchReset(e){let t=[],i=!1;for(let e=0;e<this.searches.length;e++)this.searches[e].hidden&&null!=this.searches[e].value&&(t.push({field:this.searches[e].field,operator:this.searches[e].operator||"is",type:this.searches[e].type,value:this.searches[e].value||""}),i=!0);let s=this.trigger("search",{reset:!0,target:this.name,searchData:t});if(!0!==s.isCancelled){if(this.searchData=s.detail.searchData,this.searchSelected=null,this.last.search="",this.last.logic=i?"AND":"OR",0<this.searches.length)if(this.multiSearch&&this.show.searchAll)this.last.field="all",this.last.label="All Fields";else{let e=0;for(;e<this.searches.length&&(this.searches[e].hidden||!1===this.searches[e].simple);)e++;e>=this.searches.length?(this.last.field="",this.last.label=""):(this.last.field=this.searches[e].field,this.last.label=this.searches[e].label)}this.last.multi=!1,this.last.xhr_offset=0,this.last.scrollTop=0,this.last.scrollLeft=0,this.last.selection.indexes=[],this.last.selection.columns={},this.searchClose(),$(this.box).find("#grid_"+this.name+"_search_all").val("").removeData("selected"),e||this.reload(),s.finish()}}searchShowFields(e){if(!0===e)w2tooltip.hide(this.name+"-search-fields");else{let l=[];for(let s=-1;s<this.searches.length;s++){let e=this.searches[s];var r=e?e.field:null,r=this.getColumn(r);let t=!1,i=null;if(1==this.show.searchHiddenMsg&&-1!=s&&(null==r||!0===r.hidden&&!1!==r.hideable)&&(t=!0,i=w2utils.lang("This column "+(null==r?"does not exist":"is hidden"))),-1==s){if(!this.multiSearch||!this.show.searchAll)continue;e={field:"all",label:"All Fields"}}else{if(null!=r&&!1===r.hideable)continue;if(!0===e.hidden&&(i=w2utils.lang("This column is hidden"),!1===e.simple))continue}null==e.label&&null!=e.caption&&(console.log("NOTICE: grid search.caption property is deprecated, please use search.label. Search ->",e),e.label=e.caption),l.push({id:e.field,text:w2utils.lang(e.label),search:e,tooltip:i,disabled:t,checked:e.field==this.last.field})}w2menu.show({type:"radio",name:this.name+"-search-fields",anchor:query(this.box).find("#grid_"+this.name+"_search_name").parent().find(".w2ui-search-down").get(0),items:l,align:"none",hideOn:["doc-click"]}).select(e=>{this.searchInitInput(e.detail.item.search.field)})}}searchInitInput(e,t){let i,s=query(this.box).find("#grid_"+this.name+"_search_all");if("all"==e)i={field:"all",label:w2utils.lang("All Fields")};else if(null==(i=this.getSearch(e)))return;""!=this.last.search?(this.last.label=i.label,this.search(i.field,this.last.search)):(this.last.field=i.field,this.last.label=i.label),s.attr("placeholder",w2utils.lang("Search")+" "+w2utils.lang(i.label||i.caption||i.field,!0))}clear(e){this.total=0,this.records=[],this.summary=[],this.last.xhr_offset=0,this.last.idCache={},this.reset(!0),e||this.refresh()}reset(e){this.last.scrollTop=0,this.last.scrollLeft=0,this.last.selection={indexes:[],columns:{}},this.last.range_start=null,this.last.range_end=null,$(this.box).find("#grid_"+this.name+"_records").prop("scrollTop",0),e||this.refresh()}skip(e,t){("object"!=typeof this.url?this.url:this.url.get)?(this.offset=parseInt(e),this.offset>this.total&&(this.offset=this.total-this.limit),(this.offset<0||!w2utils.isInt(this.offset))&&(this.offset=0),this.clear(!0),this.reload(t)):console.log("ERROR: grid.skip() can only be called when you have remote data source.")}load(e,t){null==e?console.log('ERROR: You need to provide url argument when calling .load() method of "'+this.name+'" object.'):(this.clear(!0),this.request("get",{},e,t))}reload(e){let t=this;var i="object"!=typeof this.url?this.url:this.url.get;t.selectionSave(),i?this.load(i,()=>{t.selectionRestore(),"function"==typeof e&&e()}):(this.reset(!0),this.localSearch(),this.selectionRestore(),"function"==typeof e&&e({status:"success"}))}request(l,s,r,n){if(null==s&&(s={}),""!=(r=""!=r&&null!=r?r:this.url)&&null!=r){w2utils.isInt(this.offset)||(this.offset=0),w2utils.isInt(this.last.xhr_offset)||(this.last.xhr_offset=0);let e,t={limit:this.limit,offset:parseInt(this.offset)+parseInt(this.last.xhr_offset),searchLogic:this.last.logic,search:this.searchData.map(e=>{let t=w2utils.clone(e);return this.searchMap&&this.searchMap[t.field]&&(t.field=this.searchMap[t.field]),t}),sort:this.sortData.map(e=>{let t=w2utils.clone(e);return this.sortMap&&this.sortMap[t.field]&&(t.field=this.sortMap[t.field]),t})};if(0===this.searchData.length&&(delete t.search,delete t.searchLogic),0===this.sortData.length&&delete t.sort,w2utils.extend(t,this.postData),w2utils.extend(t,s),"delete"!=l&&"save"!=l||(delete t.limit,delete t.offset,"delete"==(t.action=l)&&(t[this.recid||"recid"]=this.getSelection())),"get"==l){if(!0===(e=this.trigger("request",{target:this.name,url:r,postData:t,httpHeaders:this.httpHeaders})).isCancelled)return void("function"==typeof n&&n({status:"error",message:w2utils.lang("Request aborted.")}))}else e={url:r,postData:t,httpHeaders:this.httpHeaders};if(0===this.last.xhr_offset&&this.lock(w2utils.lang(this.msgRefresh),!0),this.last.xhr)try{this.last.xhr.abort()}catch(e){}if(r="object"!=typeof e.detail.url?e.detail.url:e.detail.url.get,"save"==l&&"object"==typeof e.detail.url&&(r=e.detail.url.save),"delete"==l&&"object"==typeof e.detail.url&&(r=e.detail.url.remove),0<Object.keys(this.routeData).length){var a=w2utils.parseRoute(r);if(0<a.keys.length)for(let e=0;e<a.keys.length;e++)null!=this.routeData[a.keys[e].name]&&(r=r.replace(new RegExp(":"+a.keys[e].name,"g"),this.routeData[a.keys[e].name]))}let i={type:"GET",url:r,data:e.detail.postData,headers:e.detail.httpHeaders,dataType:"json"};switch(this.dataType||w2utils.settings.dataType){case"HTTP":i.data="object"==typeof i.data?String($.param(i.data,!1)).replace(/%5B/g,"[").replace(/%5D/g,"]"):i.data;break;case"HTTPJSON":i.data={request:JSON.stringify(i.data)};break;case"RESTFULL":i.type="GET","save"==l&&(i.type="PUT"),"delete"==l&&(i.type="DELETE"),i.data="object"==typeof i.data?String($.param(i.data,!1)).replace(/%5B/g,"[").replace(/%5D/g,"]"):i.data;break;case"RESTFULLJSON":i.type="GET","save"==l&&(i.type="PUT"),"delete"==l&&(i.type="DELETE"),i.data=JSON.stringify(i.data),i.contentType="application/json";break;case"JSON":i.type="POST",i.data=JSON.stringify(i.data),i.contentType="application/json"}this.method&&(i.type=this.method),this.last.xhr_cmd=l,this.last.xhr_start=(new Date).getTime(),this.last.loaded=!1,this.last.xhr=$.ajax(i).done((e,t,i)=>{this.requestComplete(t,i,l,n)}).fail((t,e,i)=>{i={status:e,error:i,rawResponseText:t.responseText};let s=this.trigger("error",{error:i,xhr:t});if(!0!==s.isCancelled){if("abort"!=e){let e;try{e="object"==typeof t.responseJSON?t.responseJSON:JSON.parse(t.responseText)}catch(e){}console.log("ERROR: Server communication failed.","\n   EXPECTED:",{status:"success",total:5,records:[{recid:1,field:"value"}]},"\n         OR:",{status:"error",message:"error message"},"\n   RECEIVED:","object"==typeof e?e:t.responseText),this.requestComplete("error",t,l,n)}s.finish()}}),"get"==l&&e.finish()}}requestComplete(t,i,s,l){this.unlock(),this.last.xhr_response=((new Date).getTime()-this.last.xhr_start)/1e3,setTimeout(()=>{this.show.statusResponse&&this.status(w2utils.lang("Server Response ${count} seconds",{count:this.last.xhr_response}))},10),this.last.pull_more=!1,this.last.pull_refresh=!0;let e="load",r=("save"==this.last.xhr_cmd&&(e="save"),"delete"==this.last.xhr_cmd&&(e="delete"),this.trigger(e,{target:this.name,xhr:i,status:t}));if(!0===r.isCancelled)"function"==typeof l&&l({status:"error",message:w2utils.lang("Request aborted.")});else{let e;if("error"!=t){if("function"==typeof this.parser?"object"!=typeof(e=this.parser(i.responseJSON))&&console.log("ERROR: Your parser did not return proper object"):null==(e=i.responseJSON)?e={status:"error",message:w2utils.lang(this.msgNotJSON),responseText:i.responseText}:Array.isArray(e)&&(e={status:"success",records:e,total:e.length}),"error"==e.status)this.error(e.message);else if("get"==s){if(null==e.total&&(e.total=-1),null==e.records&&(e.records=[]),e.records.length==this.limit?(t=this.records.length+e.records.length,this.last.xhr_hasMore=t!=this.total):(this.last.xhr_hasMore=!1,this.total=this.offset+this.last.xhr_offset+e.records.length),this.last.xhr_hasMore||$(this.box).find("#grid_"+this.name+"_rec_more, #grid_"+this.name+"_frec_more").hide(),0===this.last.xhr_offset)this.records=[],this.summary=[];else if(-1!=e.total&&parseInt(e.total)!=parseInt(this.total)){let e=this;return void this.message(w2utils.lang(this.msgNeedReload)).ok(()=>{delete e.last.xhr_offset,e.reload()})}w2utils.isInt(e.total)&&(this.total=parseInt(e.total)),e.records&&e.records.forEach(e=>{this.recid&&(e.recid=this.parseField(e,this.recid)),null==e.recid&&(e.recid="recid-"+this.records.length),(e.w2ui&&!0===e.w2ui.summary?this.summary:this.records).push(e)}),e.summary&&(this.summary=[],e.summary.forEach(e=>{this.recid&&(e.recid=this.parseField(e,this.recid)),null==e.recid&&(e.recid="recid-"+this.summary.length),this.summary.push(e)}))}else if("delete"==s)return this.reset(),void this.reload()}else e={status:"error",message:w2utils.lang(this.msgAJAXerror),responseText:i.responseText},this.error(w2utils.lang(this.msgAJAXerror));("object"!=typeof this.url?this.url:this.url.get)||(this.localSort(),this.localSearch()),this.total=parseInt(this.total),0===this.last.xhr_offset?this.refresh():(this.scroll(),this.resize()),"function"==typeof l&&l(e),r.finish(),this.last.loaded=!0}}error(e){let t=this.trigger("error",{target:this.name,message:e,xhr:this.last.xhr});!0!==t.isCancelled&&(this.message(e),t.finish())}getChanges(t){let i=[];void 0===t&&(t=this.records);for(let e=0;e<t.length;e++){var s=t[e];if(s.w2ui){if(null!=s.w2ui.changes){let e={};e[this.recid||"recid"]=s.recid,i.push(w2utils.extend(e,s.w2ui.changes))}!0!==s.w2ui.expanded&&s.w2ui.children&&s.w2ui.children.length&&$.merge(i,this.getChanges(s.w2ui.children))}}return i}mergeChanges(){let i=this.getChanges();for(let t=0;t<i.length;t++){let e=this.get(i[t][this.recid||"recid"]);for(var s in i[t])if(!("recid"==s||this.recid&&s==this.recid)){"object"==typeof i[t][s]&&(i[t][s]=i[t][s].text);try{!function e(t,i,s){let l=i.split(".");1==l.length?t[i]=s:(t=t[l[0]],l.shift(),e(t,l.join("."),s))}(e,s,i[t][s])}catch(e){console.log("ERROR: Cannot merge. ",e.message||"",e)}e.w2ui&&delete e.w2ui.changes}}this.refresh()}save(t){var e=this.getChanges(),i="object"!=typeof this.url?this.url:this.url.save;let s=this.trigger("save",{target:this.name,changes:e});!0===s.isCancelled?i&&"function"==typeof t&&t({status:"error",message:w2utils.lang("Request aborted.")}):i?this.request("save",{changes:s.detail.changes},null,e=>{"error"!==e.status&&this.mergeChanges(),s.finish(),"function"==typeof t&&t(e)}):(this.mergeChanges(),s.finish())}editField(c,p,f,m){let g=this;if(!0===this.last.inEditMode)if(m&&13==m.keyCode){var{index:w,column:y,value:b}=this.last._edit;this.editChange({type:"custom",value:b},w,y,m),this.editDone(w,y,m)}else{let e=query(this.box).find("div.w2ui-edit-box .w2ui-input");0<e.length&&("DIV"==e.get(0).tagName?(e.text(e.text()+f),w2utils.setCursorPosition(e.get(0),e.text().length)):(e.val(e.val()+f),w2utils.setCursorPosition(e.get(0),e.val().length)))}else{let d=this.get(c,!0),u=this.getCellEditable(d,p);if(u&&!["checkbox","check"].includes(u.type)){let o=this.records[d],h=this.columns[p];b=!0===h.frozen?"_f":"_";if(-1!=["list","enum","file"].indexOf(u.type))console.log('ERROR: input types "list", "enum" and "file" are not supported in inline editing.');else{let a=this.trigger("editField",{target:this.name,recid:c,column:p,value:f,index:d,originalEvent:m});if(!0!==a.isCancelled){f=a.detail.value,this.last.inEditMode=!0,this.last.editColumn=p,this.last._edit={value:f,index:d,column:p,recid:c},this.selectNone(),this.select({recid:c,column:p});let e=query(this.box).find("#grid_"+this.name+b+"rec_"+w2utils.escapeId(c)),t=e.find('[col="'+p+'"] > div'),i=(this.last._edit.tr=e,this.last._edit.div=t,query(this.box).find("div.w2ui-edit-box").remove(),"row"!=this.selectType&&(query(this.box).find("#grid_"+this.name+b+"selection").attr("id","grid_"+this.name+"_editable").removeClass("w2ui-selection").addClass("w2ui-edit-box").prepend('<div style="position: absolute; top: 0px; bottom: 0px; left: 0px; right: 0px;"></div>').find(".w2ui-selection-resizer").remove(),t=query(this.box).find("#grid_"+this.name+"_editable > div:first-child")),u.inTag=u.inTag??"",u.outTag=u.outTag??"",u.style=u.style??"",u.items=u.items??[],null!=o.w2ui?.changes?.[h.field]?w2utils.stripTags(o.w2ui.changes[h.field]):w2utils.stripTags(g.parseField(o,h.field))),s="object"!=typeof(i=null==i?"":i)?i:"",l=(null!=a.detail.prevValue&&(s=a.detail.prevValue),null!=f&&(i=f),null!=h.style?h.style+";":"");"string"==typeof h.render&&["number","int","float","money","percent","size"].includes(h.render.split(":")[0])&&(l+="text-align: right;"),0<u.items.length&&!w2utils.isPlainObject(u.items[0])&&(u.items=w2utils.normMenu(u.items));let r,n=["date","time","datetime","color","list","combo"];w=getComputedStyle(e.find('[col="'+p+'"] > div').get(0)),y=`font-family: ${w["font-family"]}; font-size: ${w["font-size"]};`;function v(e){try{var t=getComputedStyle(e),i="DIV"==e.tagName.toUpperCase()?e.innerText:e.value,s=query(g.box).find("#grid_"+g.name+"_editable").get(0),l=`font-family: ${t["font-family"]}; font-size: ${t["font-size"]}; white-space: no-wrap;`,r=w2utils.getStrWidth(i,l);r+20>s.clientWidth&&query(s).css("width",r+20+"px")}catch(e){}}"div"===u.type?(t.addClass("w2ui-editable").html(w2utils.stripSpaces(`<div id="grid_${this.name}_edit_${c}_${p}" class="w2ui-input w2ui-focus"
                        contenteditable autocorrect="off" autocomplete="off" spellcheck="false"
                        style="${y+l+u.style}"
                        field="${h.field}" recid="${c}" column="${p}" ${u.inTag}>
                    </div>`+u.outTag)),(r=t.find("div.w2ui-input").get(0)).innerText="object"!=typeof i?i:"",null!=f?w2utils.setCursorPosition(r,r.innerText.length):w2utils.setCursorPosition(r,0,r.innerText.length)):(t.addClass("w2ui-editable").html(w2utils.stripSpaces(`<input id="grid_${this.name}_edit_${c}_${p}" class="w2ui-input"
                        autocorrect="off" autocomplete="off" spellcheck="false" type="text"
                        style="${y+l+u.style}"
                        field="${h.field}" recid="${c}" column="${p}" ${u.inTag}>`+u.outTag)),r=t.find("input").get(0),"number"==u.type&&(i=w2utils.formatNumber(i)),"date"==u.type&&(i=w2utils.formatDate(w2utils.isDate(i,u.format,!0)||new Date,u.format)),r.value="object"!=typeof i?i:"",m=e=>{var t=this.last._edit?.escKey;let i=!1;var s=query(r).data("tooltipName");s&&null!=w2tooltip.get(s[0])?.selected&&(i=!0),!this.last.inEditMode||t||!n.includes(u.type)||e.detail.overlay.anchor?.id!=this.last._edit.input?.id&&"list"!=u.type||(this.editChange(),this.editDone(void 0,void 0,{keyCode:i?13:0}))},new w2field(w2utils.extend({},u,{el:r,selected:i,onSelect:m,onHide:m})),null==f&&r&&r.select()),Object.assign(this.last._edit,{input:r,edit:u}),query(r).off(".w2ui-editable").on("blur.w2ui-editable",e=>{var t,i;this.last.inEditMode&&(t=this.last._edit.edit.type,i=query(r).data("tooltipName"),n.includes(t)&&i||(this.editChange(r,d,p,e),this.editDone()))}).on("mousedown.w2ui-editable",e=>{e.stopPropagation()}).on("click.w2ui-editable",e=>{v.call(r,e)}).on("paste.w2ui-editable",e=>{e.preventDefault();e=e.clipboardData.getData("text/plain");document.execCommand("insertHTML",!1,e)}).on("keyup.w2ui-editable",e=>{v.call(r,e)}).on("keydown.w2ui-editable",i=>{switch(i.keyCode){case 8:"list"!=u.type||r._w2field||i.preventDefault();break;case 9:case 13:i.preventDefault();break;case 27:var e=query(r).data("tooltipName");e&&0<e.length&&(this.last._edit.escKey=!0,w2tooltip.hide(e[0]),i.preventDefault()),i.stopPropagation()}setTimeout(()=>{switch(i.keyCode){case 9:var e=i.shiftKey?g.prevCell(d,p,!0):g.nextCell(d,p,!0);null!=e&&(t=g.records[e.index].recid,this.editChange(r,d,p,i),this.editDone(d,p,i),"row"!=g.selectType?(g.selectNone(),g.select({recid:t,column:e.colIndex})):g.editField(t,e.colIndex,null,i),i.preventDefault&&i.preventDefault());break;case 13:{let e=!1;var t=query(r).data("tooltipName");t&&null!=w2tooltip.get(t[0]).selected&&(e=!0),t&&e||(this.editChange(r,d,p,i),this.editDone(d,p,i));break}case 27:{this.last._edit.escKey=!1;let e=g.parseField(o,h.field);null!=o.w2ui?.changes?.[h.field]&&(e=o.w2ui.changes[h.field]),null!=r._prevValue&&(e=r._prevValue),"DIV"==r.tagName?r.innerText=null!=e?e:"":r.value=null!=e?e:"",this.editDone(d,p,i),setTimeout(()=>{g.select({recid:c,column:p})},1);break}}v(r)},1)}),r&&(r._prevValue=s),setTimeout(()=>{this.last.inEditMode&&r&&(r.focus(),clearTimeout(this.last.kbd_timer),(r.resize=v)(r))},50),a.finish({input:r})}}}}}editChange(e,t,i,s){e=e??this.last._edit.input,t=t??this.last._edit.index,i=i??this.last._edit.column,s=s??{};let l=(t<0?this.summary:this.records)[t=t<0?-t-1:t];var r=this.columns[i];let n="DIV"==e?.tagName?e.innerText:e.value,a=e._w2field;a&&("list"==a.type&&(n=a.selected),0!==Object.keys(n).length&&null!=n||(n=""),w2utils.isPlainObject(n)||(n=a.clean(n))),"checkbox"==e.type&&(l.w2ui&&!1===l.w2ui.editable&&(e.checked=!e.checked),n=e.checked);var o=this.parseField(l,r.field),h=l.w2ui&&l.w2ui.changes&&l.w2ui.changes.hasOwnProperty(r.field)?l.w2ui.changes[r.field]:o;let d={target:this.name,input:e,recid:l.recid,index:t,column:i,originalEvent:s,value:{new:n,previous:h,original:o}},u=(null!=s.target?._prevValue&&(d.value.previous=s.target._prevValue),0);for(;u<20;){if(u++,"object"!=typeof(n=d.value.new)&&String(o)!=String(n)||"object"==typeof n&&n&&n.id!=o&&("object"!=typeof o||null==o||n.id!=o.id)){if(!0!==(d=this.trigger("change",d)).isCancelled){if(n!==d.detail.value.new)continue;(""!==d.detail.value.new&&null!=d.detail.value.new||""!==h&&null!=h)&&(l.w2ui=l.w2ui??{},l.w2ui.changes=l.w2ui.changes??{},l.w2ui.changes[r.field]=d.detail.value.new),d.finish()}}else if(!0!==(d=this.trigger("restore",d)).isCancelled){if(n!==d.detail.value.new)continue;l.w2ui?.changes&&(delete l.w2ui.changes[r.field],0===Object.keys(l.w2ui.changes).length&&delete l.w2ui.changes),d.finish()}break}}editDone(t,i,s){if(t=t??this.last._edit.index,i=i??this.last._edit.column,s=s??{},this.advanceOnEdit&&13==s.keyCode){let e=s.shiftKey?this.prevRow(t,i,1):this.nextRow(t,i,1);null==e&&(e=t),setTimeout(()=>{"row"!=this.selectType?(this.selectNone(),this.select({recid:this.records[e].recid,column:i})):this.editField(this.records[e].recid,i,null,s)},1)}var e=t<0;let l=query(this.last._edit.tr).find('[col="'+i+'"]');var r=this.records[t],n=this.columns[i];this.last.inEditMode=!1,this.last._edit=null,e||(null!=r.w2ui?.changes?.[n.field]?l.addClass("w2ui-changed"):l.removeClass("w2ui-changed"),l.replace(this.getCellHTML(t,i,e))),query(this.box).find("div.w2ui-edit-box").remove(),this.updateToolbar(),setTimeout(()=>{let e=query(this.box).find("#grid_"+this.name+"_focus").get(0);document.activeElement===e||this.last.inEditMode||e.focus()},10)}delete(e){let t=this.trigger("delete",{target:this.name,force:e});if(e&&this.message(),!0!==t.isCancelled){e=t.detail.force;var i=this.getSelection();if(0!==i.length)if(""==this.msgDelete||e){if("object"!=typeof this.url?this.url:this.url.remove)this.request("delete");else if("object"!=typeof i[0])this.selectNone(),this.remove.apply(this,i);else{for(let t=0;t<i.length;t++){var s=this.columns[i[t].column].field,l=this.get(i[t].recid,!0);let e=this.records[l];null!=l&&"recid"!=s&&(this.records[l][s]="",e.w2ui&&e.w2ui.changes&&delete e.w2ui.changes[s])}this.update()}t.finish()}else this.confirm({text:w2utils.lang(this.msgDelete,{count:i.length,records:w2utils.lang(1==i.length?"record":"records")}),width:380,height:170,yes_text:"Delete",yes_class:"w2ui-btn-red",no_text:"Cancel"}).yes(e=>{e.detail.self.close(),this.delete(!0)}).no(e=>{e.detail.self.close()})}}click(n,a){var o=(new Date).getTime();let h=null;if(!(1==this.last.cancelClick||a&&a.altKey))if("object"==typeof n&&null!==n&&(h=n.column,n=n.recid),null==a&&(a={}),o-parseInt(this.last.click_time)<350&&this.last.click_recid==n&&"click"==a.type)this.dblClick(n,a);else{this.last.bubbleEl&&(this.last.bubbleEl=null),this.last.click_time=o;o=this.last.click_recid;if(this.last.click_recid=n,null==h&&a.target){let e=a.target;"TD"!=e.tagName.toUpperCase()&&(e=$(e).parents("td")[0]),null!=$(e).attr("col")&&(h=parseInt($(e).attr("col")))}let i=this.trigger("click",{target:this.name,recid:n,column:h,originalEvent:a});if(!0!==i.isCancelled){var d=this.getSelection(),u=($(this.box).find("#grid_"+this.name+"_check_all").prop("checked",!1),this.get(n,!0));let s=[];this.last.sel_ind=u,this.last.sel_col=h,this.last.sel_recid=n,this.last.sel_type="click";let e,l,t,r;if(a.shiftKey&&0<d.length&&this.multiSelect){if(d[0].recid){e=this.get(d[0].recid,!0),l=this.get(n,!0),r=h>d[0].column?(t=d[0].column,h):(t=h,d[0].column);for(let e=t;e<=r;e++)s.push(e)}else e=this.get(o,!0),l=this.get(n,!0);let i=[];e>l&&(o=e,e=l,l=o);var c="object"!=typeof this.url?this.url:this.url.get;for(let t=e;t<=l;t++)if(!(0<this.searchData.length)||c||-1!=$.inArray(t,this.last.searchIds))if("row"==this.selectType)i.push(this.records[t].recid);else for(let e=0;e<s.length;e++)i.push({recid:this.records[t].recid,column:s[e]});this.select(i)}else{let e=this.last.selection,t=-1!=e.indexes.indexOf(u),i=!1;$(a.target).parents("td").hasClass("w2ui-col-select")&&(i=!0),(a.ctrlKey||a.shiftKey||a.metaKey||i)&&this.multiSelect||this.showSelectColumn?(o=$(a.target).parents("tr").find(".w2ui-grid-select-check").is(":checked"),!0===(t="row"==this.selectType||-1!=$.inArray(h,e.columns[u])||o?t:!1)?this.unselect({recid:n,column:h}):this.select({recid:n,column:h})):("row"!=this.selectType&&-1==$.inArray(h,e.columns[u])&&(t=!1),300<d.length?this.selectNone():this.unselect(d),!0===t&&1==d.length?this.unselect({recid:n,column:h}):this.select({recid:n,column:h}))}this.status(),this.initResize(),i.finish()}}}columnClick(l,i){if(!0!==this.last.colResizing){let e=this.trigger("columnClick",{target:this.name,field:l,originalEvent:i});if(!0!==e.isCancelled){if("row"==this.selectType){var r=this.getColumn(l);r&&r.sortable&&this.sort(l,null,!(!i||!i.ctrlKey&&!i.metaKey)),"line-number"==e.detail.field&&(this.getSelection().length>=this.records.length?this.selectNone():this.selectAll())}else if(!i.altKey||(r=this.getColumn(l))&&r.sortable&&this.sort(l,null,!(!i||!i.ctrlKey&&!i.metaKey)),"line-number"==e.detail.field)this.getSelection().length>=this.records.length?this.selectNone():this.selectAll();else{i.shiftKey||i.metaKey||i.ctrlKey||this.selectNone();r=this.getSelection(),l=this.getColumn(e.detail.field,!0);let t=[],s=[];if(0!=r.length&&i.shiftKey){let t=l,i=r[0].column;t>i&&(t=r[0].column,i=l);for(let e=t;e<=i;e++)s.push(e)}else s.push(l);if(!0!==(e=this.trigger("columnSelect",{target:this.name,columns:s})).isCancelled){for(let e=0;e<this.records.length;e++)t.push({recid:this.records[e].recid,column:s});this.select(t)}e.finish()}e.finish()}}}columnDblClick(e,t){let i=this.trigger({phase:"before",type:"columnDblClick",target:this.name,field:e,originalEvent:t});!0!==i.isCancelled&&i.finish()}focus(e){let t=this.trigger({phase:"before",type:"focus",target:this.name,originalEvent:e});if(!0===t.isCancelled)return!1;this.hasFocus=!0,$(this.box).removeClass("w2ui-inactive").find(".w2ui-inactive").removeClass("w2ui-inactive"),setTimeout(()=>{let e=$(this.box).find("#grid_"+this.name+"_focus");e.is(":focus")||e.focus()},10),t.finish()}blur(e){let t=this.trigger({phase:"before",type:"blur",target:this.name,originalEvent:e});if(!0===t.isCancelled)return!1;this.hasFocus=!1,$(this.box).addClass("w2ui-inactive").find(".w2ui-selected").addClass("w2ui-inactive"),$(this.box).find(".w2ui-selection").addClass("w2ui-inactive"),t.finish()}keydown(f){let m=this,g="object"!=typeof this.url?this.url:this.url.get;if(!0===m.keyboard){let p=m.trigger({phase:"before",type:"keydown",target:m.name,originalEvent:f});if(!0!==p.isCancelled)if(0<$(this.box).find(">.w2ui-message").length)27==f.keyCode&&this.message();else{let t=!1,i=$(m.box).find("#grid_"+m.name+"_records"),r=m.getSelection(),s=(0===r.length&&(t=!0),r[0]||null),n=[],l=r[r.length-1];if("object"==typeof s&&null!=s){s=r[0].recid,n=[];let e=0;for(;;){if(!r[e]||r[e].recid!=s)break;n.push(r[e].column),e++}l=r[r.length-1].recid}let a=m.get(s,!0),o=m.get(l,!0),h=$(m.box).find(`#grid_${m.name}_rec_`+(null!=a?w2utils.escapeId(m.records[a].recid):"none"));var w=Math.floor($(m.box).find(`#grid_${m.name}_records`).height()/m.recordHeight);let d=!1,e=f.keyCode,u=f.shiftKey;switch(e){case 8:case 46:m.delete(),d=!0,f.stopPropagation();break;case 27:m.selectNone(),d=!0;break;case 65:if(!f.metaKey&&!f.ctrlKey)break;m.selectAll(),d=!0;break;case 13:if("row"==this.selectType&&!0===m.show.expandColumn){if(h.length<=0)break;m.toggle(s,f),d=!0}else{for(let e=0;e<this.columns.length;e++)if(this.getCellEditable(a,e)){n.push(parseInt(e));break}0<(n="row"==this.selectType&&this.last._edit&&this.last._edit.column?[this.last._edit.column]:n).length&&(m.editField(s,this.last.editColumn||n[0],null,f),d=!0)}break;case 37:!function(){if(t)v();else{if("row"==m.selectType){if(h.length<=0)return;var e=m.records[a].w2ui||{};!e||null==e.parent_recid||Array.isArray(e.children)&&0!==e.children.length&&e.expanded?m.collapse(s,f):(m.unselect(s),m.collapse(e.parent_recid,f),m.select(e.parent_recid))}else{let l=m.prevCell(a,n[0]);if(l=l?.index!=a?null:l?.colIndex,u||null!=l||(m.selectNone(),l=0),null!=l)if(u&&m.multiSelect){if(x())return;let t=[],i=[],s=[];if(0===n.indexOf(m.last.sel_col)&&1<n.length){for(let e=0;e<r.length;e++)-1==t.indexOf(r[e].recid)&&t.push(r[e].recid),s.push({recid:r[e].recid,column:n[n.length-1]});m.unselect(s),m.scrollIntoView(a,n[n.length-1],!0)}else{for(let e=0;e<r.length;e++)-1==t.indexOf(r[e].recid)&&t.push(r[e].recid),i.push({recid:r[e].recid,column:l});m.select(i),m.scrollIntoView(a,l,!0)}}else f.metaKey=!1,m.click({recid:s,column:l},f),m.scrollIntoView(a,l,!0);else if(!u)if(1<r.length)m.selectNone();else for(let e=1;e<r.length;e++)m.unselect(r[e])}d=!0}}();break;case 39:!function(){if(t)v();else{if("row"==m.selectType){if(h.length<=0)return;m.expand(s,f)}else{let l=m.nextCell(a,n[n.length-1]);if(l=l.index!=a?null:l.colIndex,u||null!=l||(m.selectNone(),l=m.columns.length-1),null!=l)if(u&&39==e&&m.multiSelect){if(x())return;let t=[],i=[],s=[];if(n.indexOf(m.last.sel_col)==n.length-1&&1<n.length){for(let e=0;e<r.length;e++)-1==t.indexOf(r[e].recid)&&t.push(r[e].recid),s.push({recid:r[e].recid,column:n[0]});m.unselect(s),m.scrollIntoView(a,n[0],!0)}else{for(let e=0;e<r.length;e++)-1==t.indexOf(r[e].recid)&&t.push(r[e].recid),i.push({recid:r[e].recid,column:l});m.select(i),m.scrollIntoView(a,l,!0)}}else f.metaKey=!1,m.click({recid:s,column:l},f),m.scrollIntoView(a,l,!0);else if(!u)if(1<r.length)m.selectNone();else for(let e=0;e<r.length-1;e++)m.unselect(r[e])}d=!0}}();break;case 33:y(w);break;case 34:b(w);break;case 35:b(-1);break;case 36:y(-1);break;case 38:y(f.metaKey||f.ctrlKey?-1:1);break;case 40:b(f.metaKey||f.ctrlKey?-1:1);break;case 17:case 91:if(t)break;w2utils.isSafari&&(m.last.copy_event=m.copy(!1,f),$(m.box).find("#grid_"+m.name+"_focus").val(m.last.copy_event.text).select());break;case 67:(f.metaKey||f.ctrlKey)&&(w2utils.isSafari||(m.last.copy_event=m.copy(!1,f),$(m.box).find("#grid_"+m.name+"_focus").val(m.last.copy_event.text).select()),m.copy(m.last.copy_event,f));break;case 88:if(t)break;(f.ctrlKey||f.metaKey)&&(w2utils.isSafari||(m.last.copy_event=m.copy(!1,f),$(m.box).find("#grid_"+m.name+"_focus").val(m.last.copy_event.text).select()),m.copy(m.last.copy_event,f))}let c=[32,187,189,192,219,220,221,186,222,188,190,191];for(let e=48;e<=111;e++)c.push(e);function y(e){if(t&&v(),!(h.length<=0)){let i=m.prevRow(a,"row"==m.selectType?0:r[0].column,e);if(null!=(i=u||null!=i?i:0==m.searchData.length||g?0:m.last.searchIds[0])){if(u&&m.multiSelect){if(x())return;if("row"==m.selectType)m.last.sel_ind>i&&m.last.sel_ind!=o?m.unselect(m.records[o].recid):m.select(m.records[i].recid);else if(m.last.sel_ind>i&&m.last.sel_ind!=o){i=o;let t=[];for(let e=0;e<n.length;e++)t.push({recid:m.records[i].recid,column:n[e]});m.unselect(t)}else{let t=[];for(let e=0;e<n.length;e++)t.push({recid:m.records[i].recid,column:n[e]});m.select(t)}}else 300<r.length?m.selectNone():m.unselect(r),m.click({recid:m.records[i].recid,column:n[0]},f);m.scrollIntoView(i,null,!1,1!=e),f.preventDefault&&f.preventDefault()}else if(!u)if(1<r.length)m.selectNone();else for(let e=1;e<r.length;e++)m.unselect(r[e])}}function b(e){if(t&&v(),!(h.length<=0)){let i=m.nextRow(o,"row"==m.selectType?0:r[0].column,e);if(null!=(i=u||null!=i?i:0==m.searchData.length||g?m.records.length-1:m.last.searchIds[m.last.searchIds.length-1])){if(u&&m.multiSelect){if(x())return;if("row"==m.selectType)m.last.sel_ind<i&&m.last.sel_ind!=a?m.unselect(m.records[a].recid):m.select(m.records[i].recid);else if(m.last.sel_ind<i&&m.last.sel_ind!=a){i=a;let t=[];for(let e=0;e<n.length;e++)t.push({recid:m.records[i].recid,column:n[e]});m.unselect(t)}else{let t=[];for(let e=0;e<n.length;e++)t.push({recid:m.records[i].recid,column:n[e]});m.select(t)}}else 300<r.length?m.selectNone():m.unselect(r),m.click({recid:m.records[i].recid,column:n[0]},f);m.scrollIntoView(i,null,!1,1!=e),d=!0}else if(!u)if(1<r.length)m.selectNone();else for(let e=0;e<r.length-1;e++)m.unselect(r[e])}}function v(){if(m.records&&0!==m.records.length){let e=Math.floor(i[0].scrollTop/m.recordHeight)+1;(!m.records[e]||e<2)&&(e=0),void 0!==m.records[e]&&m.select({recid:m.records[e].recid,column:0})}}function x(){if("click"==m.last.sel_type){if("row"==m.selectType)return m.last.sel_type="key",1<r.length&&(r.splice(r.indexOf(m.records[m.last.sel_ind].recid),1),m.unselect(r),1);if(m.last.sel_type="key",1<r.length){for(let e=0;e<r.length;e++)if(r[e].recid==m.last.sel_recid&&r[e].column==m.last.sel_col){r.splice(e,1);break}return m.unselect(r),1}}}-1==c.indexOf(e)||f.ctrlKey||f.metaKey||d||(0===n.length&&n.push(0),d=!1,setTimeout(()=>{let e=$(m.box).find("#grid_"+m.name+"_focus");var t=e.val();e.val(""),m.editField(s,n[0],t,f)},1)),d&&f.preventDefault&&f.preventDefault(),p.finish()}}}scrollIntoView(t,s,l,i){let r=this.records.length;if(0!==(r=0==this.searchData.length||this.url?r:this.last.searchIds.length)){if(null==t){var n=this.getSelection();if(0===n.length)return;w2utils.isPlainObject(n[0])?(t=n[0].index,s=n[0].column):t=this.get(n[0],!0)}let e=$(this.box).find("#grid_"+this.name+"_records");var a,n=this.last.searchIds.length;if(0<n&&(t=this.last.searchIds.indexOf(t)),e.height()<this.recordHeight*(0<n?n:r)&&0<e.length&&(a=(n=Math.floor(e[0].scrollTop/this.recordHeight))+Math.floor(e.height()/this.recordHeight),t==n&&(!0===l?e.prop({scrollTop:e.scrollTop()-e.height()/1.3}):(e.stop(),e.animate({scrollTop:e.scrollTop()-e.height()/1.3},250,"linear"))),t==a&&(!0===l?e.prop({scrollTop:e.scrollTop()+e.height()/1.3}):(e.stop(),e.animate({scrollTop:e.scrollTop()+e.height()/1.3},250,"linear"))),(t<n||a<t)&&(!0===l?e.prop({scrollTop:(t-1)*this.recordHeight}):(e.stop(),e.animate({scrollTop:(t-1)*this.recordHeight},250,"linear"))),!0===i&&(!0===l?e.prop({scrollTop:t*this.recordHeight}):(e.stop(),e.animate({scrollTop:t*this.recordHeight},250,"linear")))),null!=s){let t=0,i=0;n=w2utils.scrollBarSize();for(let e=0;e<=s;e++){var o=this.columns[e];o.frozen||o.hidden||(t=i,i+=parseInt(o.sizeCalculated))}e.width()<i-e.scrollLeft()?!0===l?e.prop({scrollLeft:t-n}):e.animate({scrollLeft:t-n},250,"linear"):t<e.scrollLeft()&&(!0===l?e.prop({scrollLeft:i-e.width()+2*n}):e.animate({scrollLeft:i-e.width()+2*n},250,"linear"))}}}scrollToColumn(s){if(null!=s){let t=0,i=!1;for(let e=0;e<this.columns.length;e++){var l=this.columns[e];if(l.field==s){i=!0;break}l.frozen||l.hidden||(l=parseInt(l.sizeCalculated||l.size),t+=l)}i&&(this.last.scrollLeft=t+1,this.scroll())}}dblClick(e,t){let i=null;if("object"==typeof e&&null!==e&&(i=e.column,e=e.recid),null==t&&(t={}),null==i&&t.target){let e=t.target;"TD"!=e.tagName.toUpperCase()&&(e=$(e).parents("td")[0]),i=parseInt($(e).attr("col"))}var s=this.get(e,!0),l=this.records[s];let r=this.trigger({phase:"before",target:this.name,type:"dblClick",recid:e,column:i,originalEvent:t});!0!==r.isCancelled&&(this.selectNone(),this.getCellEditable(s,i)?this.editField(e,i,null,t):(this.select({recid:e,column:i}),(this.show.expandColumn||l&&l.w2ui&&Array.isArray(l.w2ui.children))&&this.toggle(e)),r.finish())}contextMenu(s,l,r){if("text"!=this.last.userSelect){null==(r=null==r?{offsetX:0,offsetY:0,target:query(this.box).find(`#grid_${this.name}_rec_`+s)[0]}:r).offsetX&&(r.offsetX=r.layerX-r.target.offsetLeft,r.offsetY=r.layerY-r.target.offsetTop),w2utils.isFloat(s)&&(s=parseFloat(s));let i=this.getSelection();if("row"==this.selectType)-1==i.indexOf(s)&&this.click(s);else{let e=query(r.target),t=!1;l=(e="TD"!=e[0].tagName.toUpperCase()?query(r.target).closest("td"):e).attr("col");for(let e=0;e<i.length;e++)i[e].recid!=s&&i[e].column!=l||(t=!0);t||null==s||this.click({recid:s,column:l}),t||null==l||this.columnClick(this.columns[l].field,r)}let e=this.trigger("contextMenu",{target:this.name,originalEvent:r,recid:s,column:l});!0!==e.isCancelled&&(0<this.menu.length&&w2menu.show({name:this.name+"-context-menu",anchor:document.body,originalEvent:r.originalEvent,items:this.menu}).select(e=>{this.menuClick(s,e)}),r.preventDefault&&r.preventDefault(),e.finish())}}menuClick(e,t){let i=this.trigger("menuClick",{target:this.name,recid:e,originalEvent:t.detail.originalEvent,menuEvent:t,menuIndex:t.detail.index,menuItem:t.detail.item});!0!==i.isCancelled&&i.finish()}toggle(e){let t=this.get(e);if(null!=t)return t.w2ui=t.w2ui||{},!0===t.w2ui.expanded?this.collapse(e):this.expand(e)}expand(i,e){var s=this.get(i,!0);let l=this.records[s];l.w2ui=l.w2ui||{};var r=w2utils.escapeId(i);let t=l.w2ui.children,n;if(Array.isArray(t)){if(!0===l.w2ui.expanded||0===t.length)return!1;if(!0===(n=this.trigger({phase:"before",type:"expand",target:this.name,recid:i})).isCancelled)return!1;l.w2ui.expanded=!0,t.forEach(e=>{e.w2ui=e.w2ui||{},e.w2ui.parent_recid=l.recid,null==e.w2ui.children&&(e.w2ui.children=[])}),this.records.splice.apply(this.records,[s+1,0].concat(t)),-1!==this.total&&(this.total+=t.length),("object"!=typeof this.url?this.url:this.url.get)||(this.localSort(!0,!0),0<this.searchData.length&&this.localSearch(!0)),!0!==e&&this.refresh(),n.finish()}else{if(0<$(this.box).find("#grid_"+this.name+"_rec_"+r+"_expanded_row").length||!0!==this.show.expandColumn)return!1;if("none"==l.w2ui.expanded)return!1;if($(this.box).find("#grid_"+this.name+"_rec_"+r).after('<tr id="grid_'+this.name+"_rec_"+i+'_expanded_row" class="w2ui-expanded-row">    <td colspan="100" class="w2ui-expanded2">        <div id="grid_'+this.name+"_rec_"+i+'_expanded"></div>    </td>    <td class="w2ui-grid-data-last"></td></tr>'),$(this.box).find("#grid_"+this.name+"_frec_"+r).after('<tr id="grid_'+this.name+"_frec_"+i+'_expanded_row" class="w2ui-expanded-row">'+(this.show.lineNumbers?'<td class="w2ui-col-number"></td>':"")+'    <td class="w2ui-grid-data w2ui-expanded1" colspan="100">       <div id="grid_'+this.name+"_frec_"+i+'_expanded"></div>   </td></tr>'),!0===(n=this.trigger({phase:"before",type:"expand",target:this.name,recid:i,box_id:"grid_"+this.name+"_rec_"+i+"_expanded",fbox_id:"grid_"+this.name+"_frec_"+r+"_expanded"})).isCancelled)return $(this.box).find("#grid_"+this.name+"_rec_"+r+"_expanded_row").remove(),$(this.box).find("#grid_"+this.name+"_frec_"+r+"_expanded_row").remove(),!1;let e=$(this.box).find("#grid_"+this.name+"_rec_"+i+"_expanded"),t=$(this.box).find("#grid_"+this.name+"_frec_"+i+"_expanded");s=e.find("> div:first-child").height();e.height()<s&&e.css({height:s+"px"}),t.height()<s&&t.css({height:s+"px"}),$(this.box).find("#grid_"+this.name+"_rec_"+r).attr("expanded","yes").addClass("w2ui-expanded"),$(this.box).find("#grid_"+this.name+"_frec_"+r).attr("expanded","yes").addClass("w2ui-expanded"),$(this.box).find("#grid_"+this.name+"_cell_"+this.get(i,!0)+"_expand div").html("-"),l.w2ui.expanded=!0,n.finish(),this.resizeRecords()}return!0}collapse(i,s){var l=this.get(i,!0);let r=this.records[l],e=(r.w2ui=r.w2ui||{},w2utils.escapeId(i));var n=r.w2ui.children;let a;if(Array.isArray(n)){if(!0!==r.w2ui.expanded)return!1;if(!0===(a=this.trigger({phase:"before",type:"collapse",target:this.name,recid:i})).isCancelled)return!1;!function i(s){s.w2ui.expanded=!1;for(let t=0;t<s.w2ui.children.length;t++){let e=s.w2ui.children[t];e.w2ui.expanded&&i(e)}}(r);let t=[];for(let e=r;null!=e;e=this.get(e.w2ui.parent_recid))t.push(e.w2ui.parent_recid);n=l+1;let e=n;for(;;){if(this.records.length<=e+1||null==this.records[e+1].w2ui||0<=t.indexOf(this.records[e+1].w2ui.parent_recid))break;e++}this.records.splice(n,e-n+1),-1!==this.total&&(this.total-=e-n+1),("object"!=typeof this.url?this.url:this.url.get)||0<this.searchData.length&&this.localSearch(!0),!0!==s&&this.refresh(),a.finish()}else{if(0===$(this.box).find("#grid_"+this.name+"_rec_"+e+"_expanded_row").length||!0!==this.show.expandColumn)return!1;if(!0===(a=this.trigger({phase:"before",type:"collapse",target:this.name,recid:i,box_id:"grid_"+this.name+"_rec_"+e+"_expanded",fbox_id:"grid_"+this.name+"_frec_"+e+"_expanded"})).isCancelled)return!1;$(this.box).find("#grid_"+this.name+"_rec_"+e).removeAttr("expanded").removeClass("w2ui-expanded"),$(this.box).find("#grid_"+this.name+"_frec_"+e).removeAttr("expanded").removeClass("w2ui-expanded"),$(this.box).find("#grid_"+this.name+"_cell_"+this.get(i,!0)+"_expand div").html("+"),$(this.box).find("#grid_"+this.name+"_rec_"+e+"_expanded").css("height","0px"),$(this.box).find("#grid_"+this.name+"_frec_"+e+"_expanded").css("height","0px"),setTimeout(()=>{$(this.box).find("#grid_"+this.name+"_rec_"+e+"_expanded_row").remove(),$(this.box).find("#grid_"+this.name+"_frec_"+e+"_expanded_row").remove(),r.w2ui.expanded=!1,a.finish(),this.resizeRecords()},300)}return!0}sort(i,e,s){let t=this.trigger({phase:"before",type:"sort",target:this.name,field:i,direction:e,multiField:s});if(!0!==t.isCancelled){if(null!=i){let t=this.sortData.length;for(let e=0;e<this.sortData.length;e++)if(this.sortData[e].field==i){t=e;break}null==e&&(e=null==this.sortData[t]?"asc":(null==this.sortData[t].direction&&(this.sortData[t].direction=""),"asc"===this.sortData[t].direction.toLowerCase()?"desc":"asc")),!1===this.multiSort&&(this.sortData=[],t=0),1!=s&&(this.sortData=[],t=0),null==this.sortData[t]&&(this.sortData[t]={}),this.sortData[t].field=i,this.sortData[t].direction=e}else this.sortData=[];("object"!=typeof this.url?this.url:this.url.get)?(t.finish({direction:e}),this.last.xhr_offset=0,this.reload()):(this.localSort(!1,!0),0<this.searchData.length&&this.localSearch(!0),this.last.scrollTop=0,$(this.box).find("#grid_"+this.name+"_records").prop("scrollTop",0),t.finish({direction:e}),this.refresh())}}copy(e,t){if(w2utils.isPlainObject(e))return e.finish(),e.text;var l=this.getSelection();if(0===l.length)return"";let r="";if("object"==typeof l[0]){let t=l[0].column,i=l[0].column,s=[];for(let e=0;e<l.length;e++)l[e].column<t&&(t=l[e].column),l[e].column>i&&(i=l[e].column),-1==s.indexOf(l[e].index)&&s.push(l[e].index);s.sort((e,t)=>e-t);for(let e=0;e<s.length;e++){var n=s[e];for(let e=t;e<=i;e++)!0!==this.columns[e].hidden&&(r+=this.getCellCopy(n,e)+"\t");r=r.substr(0,r.length-1),r+="\n"}}else{for(let e=0;e<this.columns.length;e++){var i=this.columns[e];if(!0!==i.hidden){let e=i.text||i.field;i.text&&i.text.length<3&&i.tooltip&&(e=i.tooltip),r+='"'+w2utils.stripTags(e)+'"\t'}}r=r.substr(0,r.length-1),r+="\n";for(let e=0;e<l.length;e++){var s=this.get(l[e],!0);for(let e=0;e<this.columns.length;e++)!0!==this.columns[e].hidden&&(r+='"'+this.getCellCopy(s,e)+'"\t');r=r.substr(0,r.length-1),r+="\n"}}r=r.substr(0,r.length-1);let a;return null==e?!0===(a=this.trigger({phase:"before",type:"copy",target:this.name,text:r,cut:88==t.keyCode,originalEvent:t})).isCancelled?"":(r=a.detail.text,a.finish(),r):!1===e?!0===(a=this.trigger({phase:"before",type:"copy",target:this.name,text:r,cut:88==t.keyCode,originalEvent:t})).isCancelled?"":(r=a.detail.text,a):void 0}getCellCopy(e,t){return w2utils.stripTags(this.getCellHTML(e,t))}paste(l,e){var t=this.getSelection();let r=this.get(t[0].recid,!0);var n,a,o,h=t[0].column;let i=this.trigger({phase:"before",type:"paste",target:this.name,text:l,index:r,column:h,originalEvent:e});if(!0!==i.isCancelled){if(l=i.detail.text,"row"==this.selectType||0===t.length)return console.log("ERROR: You can paste only if grid.selectType = 'cell' and when at least one cell selected."),void i.finish();if("object"!=typeof l){let s=[];l=l.split("\n");for(let e=0;e<l.length;e++){var d=l[e].split("\t");let t=0;var u=this.records[r];let i=[];if(null!=u){for(let e=0;e<d.length;e++)this.columns[h+t]&&(n=u,a=this.columns[h+t].field,o=d[e],n.w2ui=n.w2ui||{},n.w2ui.changes=n.w2ui.changes||{},n.w2ui.changes[a]=o,i.push(h+t),t++);for(let e=0;e<i.length;e++)s.push({recid:u.recid,column:i[e]});r++}}this.selectNone(),this.select(s)}else this.selectNone(),this.select([{recid:this.records[r],column:h}]);this.refresh(),i.finish()}}resize(){var t=(new Date).getTime();if(this.box&&$(this.box).attr("name")==this.name){$(this.box).find("> div.w2ui-grid-box").css("width",$(this.box).width()).css("height",$(this.box).height());let e=this.trigger({phase:"before",type:"resize",target:this.name});if(!0!==e.isCancelled)return this.resizeBoxes(),this.resizeRecords(),e.finish(),(new Date).getTime()-t}}update({cells:t,fullCellRefresh:i,ignoreColumns:l}={}){var e=(new Date).getTime();let h=this;if(null==this.box)return 0;if(Array.isArray(t))for(let e=0;e<t.length;e++){var s=t[e].index,r=t[e].column;if(!(s<0))if(null==s||null==r)console.log("ERROR: Wrong argument for grid.update({ cells }), cells should be [{ index: X, column: Y }, ...]");else{let e=this.records[s]??{},t=(e.w2ui=e.w2ui??{},e.w2ui._update=e.w2ui._update??{cells:[]},e.w2ui._update.row1),i=e.w2ui._update.row2;null!=t&&t.isConnected&&null!=i&&i.isColSelected||(t=this.box.querySelector(`#grid_${this.name}_rec_`+w2utils.escapeId(e.recid)),i=this.box.querySelector(`#grid_${this.name}_frec_`+w2utils.escapeId(e.recid)),e.w2ui._update.row1=t,e.w2ui._update.row2=i),n(e,t,i,s,r)}}else for(let e=this.last.range_start-1;e<=this.last.range_end;e++){let s=e,l=(s=0<this.last.searchIds.length?this.last.searchIds[e]:e,this.records[s]);if(!(s<0||null==l)){l.w2ui=l.w2ui??{},l.w2ui._update=l.w2ui._update??{cells:[]};let t=l.w2ui._update.row1,i=l.w2ui._update.row2;null!=t&&t.isConnected&&null!=i&&i.isColSelected||(t=this.box.querySelector(`#grid_${this.name}_rec_`+w2utils.escapeId(l.recid)),i=this.box.querySelector(`#grid_${this.name}_frec_`+w2utils.escapeId(l.recid)),l.w2ui._update.row1=t,l.w2ui._update.row2=i);for(let e=0;e<this.columns.length;e++)n(l,t,i,s,e)}}return(new Date).getTime()-e;function n(e,s,r,n,a){var o=h.columns[a];if(!Array.isArray(l)||!l.includes(a)&&!l.includes(o.field)){let l=e.w2ui._update.cells[a];if(null!=l&&l.isConnected||(l=h.box.querySelector(`#grid_${h.name}_data_${n}_`+a),e.w2ui._update.cells[a]=l),null!=l){if(i)$(l).replaceWith(h.getCellHTML(n,a,!1)),l=h.box.querySelector(`#grid_${h.name}_data_${n}_`+a),e.w2ui._update.cells[a]=l;else{let e=l.children[0],{value:t,style:i,className:s}=h.getCellValue(n,a,!1,!0);if(e.innerHTML!=t&&(e.innerHTML=t),""!=i&&l.style.cssText!=i&&(l.style.cssText=i),""!=s){let t=["w2ui-grid-data"],i=[];n=s.split(" ").filter(e=>!!e);l.classList.forEach(e=>{t.includes(e)||i.push(e)}),l.classList.remove(...i),l.classList.add(...n)}}if(h.columns[a].style&&h.columns[a].style!=l.style.cssText&&(l.style.cssText=h.columns[a].style??""),null!=e.w2ui.class){if("string"==typeof e.w2ui.class){let t=["w2ui-odd","w2ui-even","w2ui-record"],i=[];n=e.w2ui.class.split(" ").filter(e=>!!e);s&&r&&(s.classList.forEach(e=>{t.includes(e)||i.push(e)}),s.classList.remove(...i),s.classList.add(...n),r.classList.remove(...i),r.classList.add(...n))}if(w2utils.isPlainObject(e.w2ui.class)&&"string"==typeof e.w2ui.class[o.field]){let t=["w2ui-grid-data"],i=[];a=e.w2ui.class[o.field].split(" ").filter(e=>!!e);l.classList.forEach(e=>{t.includes(e)||i.push(e)}),l.classList.remove(...i),l.classList.add(...a)}}null!=e.w2ui.style&&(s&&r&&"string"==typeof e.w2ui.style&&s.style.cssText!==e.w2ui.style&&(s.style.cssText="height: "+h.recordHeight+"px;"+e.w2ui.style,s.setAttribute("custom_style",e.w2ui.style),r.style.cssText="height: "+h.recordHeight+"px;"+e.w2ui.style,r.setAttribute("custom_style",e.w2ui.style)),w2utils.isPlainObject(e.w2ui.style)&&"string"==typeof e.w2ui.style[o.field]&&l.style.cssText!==e.w2ui.style[o.field]&&(l.style.cssText=e.w2ui.style[o.field]))}}}}refreshCell(e,t){var i=this.get(e,!0),t=this.getColumn(t,!0),e=!this.records[i]||this.records[i].recid!=e;let s=$(this.box).find((e?".w2ui-grid-summary ":"")+"#grid_"+this.name+"_data_"+i+"_"+t);if(0==s.length)return!1;s.replaceWith(this.getCellHTML(i,t,e))}refreshRow(t,i){let s=$(this.box).find("#grid_"+this.name+"_frec_"+w2utils.escapeId(t)),l=$(this.box).find("#grid_"+this.name+"_rec_"+w2utils.escapeId(t));if(0<s.length){null==i&&(i=this.get(t,!0));var r=s.attr("line"),n=!this.records[i]||this.records[i].recid!=t,a="object"!=typeof this.url?this.url:this.url.get;if(0<this.searchData.length&&!a)for(let e=0;e<this.last.searchIds.length;e++)this.last.searchIds[e]==i&&(i=e);a=this.getRecordHTML(i,r,n);$(s).replaceWith(a[0]),$(l).replaceWith(a[1]);let e=this.records[i].w2ui?this.records[i].w2ui.style:"";"string"==typeof e&&(s=$(this.box).find("#grid_"+this.name+"_frec_"+w2utils.escapeId(t)),l=$(this.box).find("#grid_"+this.name+"_rec_"+w2utils.escapeId(t)),s.attr("custom_style",e),l.attr("custom_style",e),s.hasClass("w2ui-selected")&&(e=e.replace("background-color","none")),s[0].style.cssText="height: "+this.recordHeight+"px;"+e,l[0].style.cssText="height: "+this.recordHeight+"px;"+e),n&&this.resize()}}refresh(){var t=(new Date).getTime(),s="object"!=typeof this.url?this.url:this.url.get;if(this.total<=0&&!s&&0===this.searchData.length&&(this.total=this.records.length),this.box){let e=this.trigger({phase:"before",target:this.name,type:"refresh"});if(!0!==e.isCancelled){this.show.header?$(this.box).find("#grid_"+this.name+"_header").html(w2utils.lang(this.header)+"&#160;").show():$(this.box).find("#grid_"+this.name+"_header").hide(),this.show.toolbar?$(this.box).find("#grid_"+this.name+"_toolbar").show():$(this.box).find("#grid_"+this.name+"_toolbar").hide(),this.searchClose();let i=$(this.box).find("#grid_"+this.name+"_search_all");!this.multiSearch&&"all"==this.last.field&&0<this.searches.length&&(this.last.field=this.searches[0].field,this.last.label=this.searches[0].label);for(let e=0;e<this.searches.length;e++)this.searches[e].field==this.last.field&&(this.last.label=this.searches[e].label);if(this.last.multi?(i.attr("placeholder","["+w2utils.lang("Multiple Fields")+"]"),$.fn.w2field&&i.w2field("clear")):i.attr("placeholder",w2utils.lang("Search")+" "+w2utils.lang(this.last.label,!0)),i.val()!=this.last.search){let e=this.last.search,t=i.data("w2field");t&&(e=t.format(e)),i.val(e)}this.refreshSearch(),this.refreshBody(),this.show.footer?$(this.box).find("#grid_"+this.name+"_footer").html(this.getFooterHTML()).show():$(this.box).find("#grid_"+this.name+"_footer").hide();var s=this.last.selection,l=0<this.records.length&&s.indexes.length==this.records.length,s=0<s.indexes.length&&0!==this.searchData.length&&s.indexes.length==this.last.searchIds.length,r=(l||s?$(this.box).find("#grid_"+this.name+"_check_all").prop("checked",!0):$(this.box).find("#grid_"+this.name+"_check_all").prop("checked",!1),this.status(),this.find({"w2ui.expanded":!0},!0,!0));for(let t=0;t<r.length;t++){let e=this.records[r[t]].w2ui;e&&!Array.isArray(e.children)&&(e.expanded=!1)}return this.markSearch&&setTimeout(()=>{let t=[];for(let e=0;e<this.searchData.length;e++){var i=this.searchData[e],s=this.getSearch(i.field);s&&!s.hidden&&(s=this.getColumn(i.field,!0),t.push({field:i.field,search:i.value,col:s}))}0<t.length&&t.forEach(e=>{$(this.box).find('td[col="'+e.col+'"]').not(".w2ui-head").w2marker(e.search)})},50),this.updateToolbar(),e.finish(),this.resize(),this.addRange("selection"),setTimeout(()=>{this.resize(),this.scroll()},1),this.reorderColumns&&!this.last.columnDrag?this.last.columnDrag=this.initColumnDrag():!this.reorderColumns&&this.last.columnDrag&&this.last.columnDrag.remove(),(new Date).getTime()-t}}}refreshSearch(){if(this.multiSearch&&0<this.searchData.length){0==$(this.box).find(".w2ui-grid-searches").length&&$(this.box).find(".w2ui-grid-toolbar").css("height",this.last._toolbar_height+35+"px").append(`<div id="grid_${this.name}_searches" class="w2ui-grid-searches"></div>`);let r=`
                <span id="grid_${this.name}_search_logic" class="w2ui-grid-search-logic"></span>
                <div class="grid-search-line"></div>`;this.searchData.forEach((i,e)=>{var t=this.getSearch(i.field,!0),s=this.searches[t];let l;if(l=Array.isArray(i.value)?`<span class="grid-search-count">${i.value.length}</span>`:": "+i.value,s&&"date"==s.type)if("between"==i.operator){let e=i.value[0],t=i.value[1];Number(e)===e&&(e=w2utils.formatDate(e)),Number(t)===t&&(t=w2utils.formatDate(t)),l=`: ${e} - `+t}else{let e=i.value,t=(Number(e)==e&&(e=w2utils.formatDate(e)),i.operator);"more:"==(t="less"==(t="more"==t?"since":t)?"before":t).substr(0,5)&&(t="since"),l=`: ${t} `+e}r+=`<span class="w2ui-action" data-click="searchFieldDrop|${t}|${e}|this">
                    ${s?s.label:""}
                    ${l}
            ...
            `,$(this.box).find(`#grid_${this.name}_searches`).html(r),$(this.box).find(`#grid_${this.name}_search_logic`).html(w2utils.lang("AND"==this.last.logic?"All":"Any"))}else $(this.box).find(".w2ui-grid-toolbar").css("height",this.last._toolbar_height).find(".w2ui-grid-searches").remove();this.searchSelected?($(this.box).find(`#grid_${this.name}_search_all`).val(" ").prop("readOnly",!0),$(this.box).find(`#grid_${this.name}_search_name`).show().find(".name-text").html(this.searchSelected.name)):($(this.box).find(`#grid_${this.name}_search_all`).prop("readOnly",!1),$(this.box).find(`#grid_${this.name}_search_name`).hide().find(".name-text").html("")),w2utils.bindEvents($(this.box).find(`#grid_${this.name}_searches .w2ui-action, #grid_${this.name}_searches button`),this)}refreshBody(){this.scroll();var e=this.getRecordsHTML(),t=this.getColumnsHTML(),e='<div id="grid_'+this.name+'_frecords" class="w2ui-grid-frecords" style="margin-bottom: '+(w2utils.scrollBarSize()-1)+'px;">'+e[0]+'</div><div id="grid_'+this.name+'_records" class="w2ui-grid-records" onscroll="w2ui[\''+this.name+"'].scroll(event);\">"+e[1]+'</div><div id="grid_'+this.name+'_scroll1" class="w2ui-grid-scroll1" style="height: '+w2utils.scrollBarSize()+'px"></div><div id="grid_'+this.name+'_fcolumns" class="w2ui-grid-fcolumns">    <table><tbody>'+t[0]+'</tbody></table></div><div id="grid_'+this.name+'_columns" class="w2ui-grid-columns">    <table><tbody>'+t[1]+"</tbody></table></div>";let n=$(this.box).find("#grid_"+this.name+"_body",this.box).html(e),a=$(this.box).find("#grid_"+this.name+"_records",this.box),i=$(this.box).find("#grid_"+this.name+"_frecords",this.box),o=this;"row"==this.selectType&&(a.on("mouseover mouseout","tr",function(e){$(o.box).find("#grid_"+o.name+"_frec_"+w2utils.escapeId($(this).attr("recid"))).toggleClass("w2ui-record-hover","mouseover"==e.type)}),i.on("mouseover mouseout","tr",function(e){$(o.box).find("#grid_"+o.name+"_rec_"+w2utils.escapeId($(this).attr("recid"))).toggleClass("w2ui-record-hover","mouseover"==e.type)})),w2utils.isIOS?a.add(i).on("click","tr",function(e){o.dblClick($(this).attr("recid"),e)}):a.add(i).on("click","tr",function(e){o.click($(this).attr("recid"),e)}).on("contextmenu","tr",function(e){o.contextMenu($(this).attr("recid"),null,e)}),n.data("scrolldata",{lastTime:0,lastDelta:0,time:0}).find(".w2ui-grid-frecords").on("mousewheel DOMMouseScroll ",function(e){e.preventDefault();let t=e.originalEvent,i=n.data("scrolldata"),s=$(this).siblings(".w2ui-grid-records").addBack().filter(".w2ui-grid-records"),l=null!=typeof t.wheelDelta?-1*t.wheelDelta/120:(t.detail||t.deltaY)/3,r=s.scrollTop();i.time=+new Date,i.lastTime<i.time-150&&(i.lastDelta=0),i.lastTime=i.time,i.lastDelta+=l,l=Math.abs(i.lastDelta)<1?0:Math.round(i.lastDelta),n.data("scrolldata",i),l*=(Math.round(a.height()/o.recordHeight)-1)*o.recordHeight/4,s.stop().animate({scrollTop:r+l},250,"linear")}),0===this.records.length&&this.msgEmpty?$(this.box).find("#grid_"+this.name+"_body").append('<div id="grid_'+this.name+'_empty_msg" class="w2ui-grid-empty-msg"><div>'+this.msgEmpty+"</div></div>"):0<$(this.box).find("#grid_"+this.name+"_empty_msg").length&&$(this.box).find("#grid_"+this.name+"_empty_msg").remove(),0<this.summary.length?(t=this.getSummaryHTML(),$(this.box).find("#grid_"+this.name+"_fsummary").html(t[0]).show(),$(this.box).find("#grid_"+this.name+"_summary").html(t[1]).show()):($(this.box).find("#grid_"+this.name+"_fsummary").hide(),$(this.box).find("#grid_"+this.name+"_summary").hide())}render(t){let p=this;var i=(new Date).getTime();if(null!=t&&(0<$(this.box).find("#grid_"+this.name+"_body").length&&$(this.box).removeAttr("name").removeClass("w2ui-reset w2ui-grid w2ui-inactive").html(""),this.box=t),this.box){var s="object"!=typeof this.url?this.url:this.url.get;let e=this.trigger({phase:"before",target:this.name,type:"render",box:t});if(!0!==e.isCancelled){if(this.reset(!0),!this.last.field)if(this.multiSearch&&this.show.searchAll)this.last.field="all",this.last.label="All Fields";else{let e=0;for(;e<this.searches.length&&(this.searches[e].hidden||!1===this.searches[e].simple);)e++;e>=this.searches.length?(this.last.field="",this.last.label=""):(this.last.field=this.searches[e].field,this.last.label=this.searches[e].label)}if($(this.box).attr("name",this.name).addClass("w2ui-reset w2ui-grid w2ui-inactive").html('<div class="w2ui-grid-box">    <div id="grid_'+this.name+'_header" class="w2ui-grid-header"></div>    <div id="grid_'+this.name+'_toolbar" class="w2ui-grid-toolbar"></div>    <div id="grid_'+this.name+'_body" class="w2ui-grid-body"></div>    <div id="grid_'+this.name+'_fsummary" class="w2ui-grid-body w2ui-grid-summary"></div>    <div id="grid_'+this.name+'_summary" class="w2ui-grid-body w2ui-grid-summary"></div>    <div id="grid_'+this.name+'_footer" class="w2ui-grid-footer"></div>    <textarea id="grid_'+this.name+'_focus" class="w2ui-grid-focus-input" '+(this.tabIndex?'tabindex="'+this.tabIndex+'"':"")+(w2utils.isIOS?"readonly":"")+"></textarea></div>"),"row"!=this.selectType&&$(this.box).addClass("w2ui-ss"),0<$(this.box).length&&($(this.box)[0].style.cssText+=this.style),this.initToolbar(),null!=this.toolbar&&this.toolbar.render($(this.box).find("#grid_"+this.name+"_toolbar")[0]),this.last._toolbar_height=$(this.box).find(`#grid_${this.name}_toolbar`).prop("offsetHeight"),this.last.field&&"all"!=this.last.field){let e=this.searchData;setTimeout(()=>{this.searchInitInput(this.last.field,1==e.length?e[0].value:null)},1)}$(this.box).find("#grid_"+this.name+"_footer").html(this.getFooterHTML()),this.last.state||(this.last.state=this.stateSave(!0)),this.stateRestore(),s&&(this.clear(),this.refresh());let t=!1;for(let e=0;e<this.searches.length;e++)if(this.searches[e].hidden){t=!0;break}t?(this.searchReset(!1),s||setTimeout(()=>{this.searchReset()},1)):this.reload(),$(this.box).find("#grid_"+this.name+"_focus").on("focus",function(e){clearTimeout(p.last.kbd_timer),p.hasFocus||p.focus()}).on("blur",function(e){clearTimeout(p.last.kbd_timer),p.last.kbd_timer=setTimeout(()=>{p.hasFocus&&p.blur()},100)}).on("paste",function(s){let l=s.originalEvent.clipboardData||null;if(l){let e=l.items,i=[];for(var r in e=2==e.length&&2==(e=2==e.length&&"file"==e[1].kind?[e[1]]:e).length&&"text/plain"==e[0].type&&"text/html"==e[1].type?[e[1]]:e){let t=e[r];if("file"===t.kind){r=t.getAsFile();i.push({kind:"file",data:r})}else if("string"===t.kind&&("text/plain"===t.type||"text/html"===t.type)){s.preventDefault();let e=l.getData("text/plain");-1!=e.indexOf("\r")&&-1==e.indexOf("\n")&&(e=e.replace(/\r/g,"\n")),i.push({kind:"text/html"==t.type?"html":"text",data:e})}}1===i.length&&"file"!=i[0].kind&&(i=i[0].data),w2ui[p.name].paste(i,s.originalEvent),s.preventDefault()}}).on("keydown",function(e){w2ui[p.name].keydown.call(w2ui[p.name],e)});let c;return $(this.box).off("mousedown.mouseStart").on("mousedown.mouseStart",function(r){if(1==r.which&&("text"==p.last.userSelect&&(p.last.userSelect="",$(p.box).find(".w2ui-grid-body").css(w2utils.cssPrefix("user-select","none"))),!("row"==p.selectType&&($(r.target).parents().hasClass("w2ui-head")||$(r.target).hasClass("w2ui-head"))||p.last.move&&"expand"==p.last.move.type))){if(r.altKey)$(p.box).find(".w2ui-grid-body").css(w2utils.cssPrefix("user-select","text")),p.selectNone(),p.last.move={type:"text-select"},p.last.userSelect="text";else{let e=r.target,t={x:r.offsetX-10,y:r.offsetY-10},i=!1;for(;e&&(!e.classList||!e.classList.contains("w2ui-grid"));)e.tagName&&"TD"==e.tagName.toUpperCase()&&(i=!0),e.tagName&&"TR"!=e.tagName.toUpperCase()&&1==i&&(t.x+=e.offsetLeft,t.y+=e.offsetTop),e=e.parentNode;p.last.move={x:r.screenX,y:r.screenY,divX:0,divY:0,focusX:t.x,focusY:t.y,recid:$(r.target).parents("tr").attr("recid"),column:parseInt(("TD"==r.target.tagName.toUpperCase()?$(r.target):$(r.target).parents("td")).attr("col")),type:"select",ghost:!1,start:!0},null==p.last.move.recid&&(p.last.move.type="select-column");let s=r.target,l=$(p.box).find("#grid_"+p.name+"_focus");if(p.last.move){let e=p.last.move.focusX,t=p.last.move.focusY,i=$(s).parents("table").parent();(i.hasClass("w2ui-grid-records")||i.hasClass("w2ui-grid-frecords")||i.hasClass("w2ui-grid-columns")||i.hasClass("w2ui-grid-fcolumns")||i.hasClass("w2ui-grid-summary"))&&(e=p.last.move.focusX-$(p.box).find("#grid_"+p.name+"_records").scrollLeft(),t=p.last.move.focusY-$(p.box).find("#grid_"+p.name+"_records").scrollTop()),($(s).hasClass("w2ui-grid-footer")||0<$(s).parents("div.w2ui-grid-footer").length)&&(t=$(p.box).find("#grid_"+p.name+"_footer").position().top),i.hasClass("w2ui-scroll-wrapper")&&i.parent().hasClass("w2ui-toolbar")&&(e=p.last.move.focusX-i.scrollLeft()),l.css({left:e-10,top:t})}setTimeout(()=>{p.last.inEditMode||(-1!=["INPUT","TEXTAREA","SELECT"].indexOf(s.tagName.toUpperCase())?$(s).focus():l.is(":focus")||l.focus())},50),p.multiSelect||p.reorderRows||"drag"!=p.last.move.type||delete p.last.move}if(1==p.reorderRows){let e=r.target;if("TD"!=e.tagName.toUpperCase()&&(e=$(e).parents("td")[0]),$(e).hasClass("w2ui-col-number")||$(e).hasClass("w2ui-col-order")){p.selectNone(),p.last.move.reorder=!0;var s=$(p.box).find(".w2ui-even.w2ui-empty-record").css("background-color"),l=$(p.box).find(".w2ui-odd.w2ui-empty-record").css("background-color");$(p.box).find(".w2ui-even td").not(".w2ui-col-number").css("background-color",s),$(p.box).find(".w2ui-odd td").not(".w2ui-col-number").css("background-color",l);let t=p.last.move,i=$(p.box).find(".w2ui-grid-records");if(!t.ghost){let e=$(p.box).find("#grid_"+p.name+"_rec_"+t.recid);s=e.parents("table").find("tr:first-child").clone();t.offsetY=r.offsetY,t.from=t.recid,t.pos=e.position(),t.ghost=$(e).clone(!0),t.ghost.removeAttr("id"),e.find("td").remove(),e.append('<td colspan="1000"><div style="height: '+p.recordHeight+'px; background-color: #eee; border-bottom: 1px dashed #aaa; border-top: 1px dashed #aaa;"></div></td>'),i.append('<div id="grid_'+p.name+'_ghost_line" style="position: absolute; z-index: 999999; pointer-events: none; width: 100%;"></div>'),i.append('<table id="grid_'+p.name+'_ghost" style="position: absolute; z-index: 999998; opacity: 0.9; pointer-events: none;"></table>'),$(p.box).find("#grid_"+p.name+"_ghost").append(s).append(t.ghost)}let e=$(p.box).find("#grid_"+p.name+"_ghost");e.css({top:t.pos.top,left:t.pos.left,"border-top":"1px solid #aaa","border-bottom":"1px solid #aaa"})}else p.last.move.reorder=!1}$(document).on("mousemove.w2ui-"+p.name,n).on("mouseup.w2ui-"+p.name,a),r.stopPropagation()}}),this.updateToolbar(),e.finish(),this.last.observeResize=new ResizeObserver(()=>{this.resize()}),this.last.observeResize.observe(this.box),(new Date).getTime()-i;function n(a){if(a.target.tagName){let n=p.last.move;if(n&&-1!=["select","select-column"].indexOf(n.type)&&(n.divX=a.screenX-n.x,n.divY=a.screenY-n.y,!(Math.abs(n.divX)<=1&&Math.abs(n.divY)<=1)))if(p.last.cancelClick=!0,1==p.reorderRows&&p.last.move.reorder){let e=$(a.target).parents("tr"),i=e.attr("recid");if((i="-none-"==i?"bottom":i)!=n.from){let e=$(p.box).find("#grid_"+p.name+"_rec_"+i);$(p.box).find(".insert-before"),e.addClass("insert-before"),n.lastY=a.screenY,n.to=i;var o=e.position();let t=$(p.box).find("#grid_"+p.name+"_ghost_line");o?t.css({top:o.top,left:n.pos.left,"border-top":"2px solid #769EFC"}):t.css({"border-top":"2px solid transparent"})}let t=$(p.box).find("#grid_"+p.name+"_ghost");void t.css({top:n.pos.top+n.divY,left:n.pos.left})}else{n.start&&n.recid&&(p.selectNone(),n.start=!1);let r=[];o=("TR"==a.target.tagName.toUpperCase()?$(a.target):$(a.target).parents("tr")).attr("recid");if(null==o){if("row"!=p.selectType&&(!p.last.move||"select"!=p.last.move.type)){var h=parseInt($(a.target).parents("td").attr("col"));if(isNaN(h))p.removeRange("column-selection"),$(p.box).find(".w2ui-grid-columns .w2ui-col-header, .w2ui-grid-fcolumns .w2ui-col-header").removeClass("w2ui-col-selected"),$(p.box).find(".w2ui-col-number").removeClass("w2ui-row-selected"),delete n.colRange;else{let e=h+"-"+h,t=(n.column<h&&(e=n.column+"-"+h),[]);var i=(e=n.column>h?h+"-"+n.column:e).split("-");for(let e=parseInt(i[0]);e<=parseInt(i[1]);e++)t.push(e);if(n.colRange!=e&&!0!==(c=p.trigger({phase:"before",type:"columnSelect",target:p.name,columns:t,isCancelled:!1})).isCancelled){null==n.colRange&&p.selectNone();var s=e.split("-");$(p.box).find(".w2ui-grid-columns .w2ui-col-header, .w2ui-grid-fcolumns .w2ui-col-header").removeClass("w2ui-col-selected");for(let e=parseInt(s[0]);e<=parseInt(s[1]);e++)$(p.box).find("#grid_"+p.name+"_column_"+e+" .w2ui-col-header").addClass("w2ui-col-selected");$(p.box).find(".w2ui-col-number").not(".w2ui-head").addClass("w2ui-row-selected"),n.colRange=e,p.removeRange("column-selection"),p.addRange({name:"column-selection",range:[{recid:p.records[0].recid,column:s[0]},{recid:p.records[p.records.length-1].recid,column:s[1]}],style:"background-color: rgba(90, 145, 234, 0.1)"})}}}}else{let l=p.get(n.recid,!0);if(!(null==l||p.records[l]&&p.records[l].recid!=n.recid)){let e=p.get(o,!0);if(null!=e){let i=parseInt(n.column),s=parseInt(("TD"==a.target.tagName.toUpperCase()?$(a.target):$(a.target).parents("td")).attr("col"));isNaN(i)&&isNaN(s)&&(i=0,s=p.columns.length-1),l>e&&(h=l,l=e,e=h);var d,o="ind1:"+l+",ind2;"+e+",col1:"+i+",col2:"+s;if(n.range!=o){n.range=o;for(let t=l;t<=e;t++)if(!(0<p.last.searchIds.length&&-1==p.last.searchIds.indexOf(t)))if("row"!=p.selectType){i>s&&(d=i,i=s,s=d);for(let e=i;e<=s;e++)p.columns[e].hidden||r.push({recid:p.records[t].recid,column:parseInt(e)})}else r.push(p.records[t].recid);if("row"!=p.selectType){var u=p.getSelection();let e=[];for(let i=0;i<r.length;i++){let t=!1;for(let e=0;e<u.length;e++)r[i].recid==u[e].recid&&r[i].column==u[e].column&&(t=!0);t||e.push({recid:r[i].recid,column:r[i].column})}p.select(e),e=[];for(let i=0;i<u.length;i++){let t=!1;for(let e=0;e<r.length;e++)r[e].recid==u[i].recid&&r[e].column==u[i].column&&(t=!0);t||e.push({recid:u[i].recid,column:u[i].column})}p.unselect(e)}else if(p.multiSelect){let t=p.getSelection();for(let e=0;e<r.length;e++)-1==t.indexOf(r[e])&&p.select(r[e]);for(let e=0;e<t.length;e++)-1==r.indexOf(t[e])&&p.unselect(t[e])}}}}}}}}function a(i){let s=p.last.move;if(setTimeout(()=>{delete p.last.cancelClick},1),!$(i.target).parents().hasClass(".w2ui-head")&&!$(i.target).hasClass(".w2ui-head")){if(s&&-1!=["select","select-column"].indexOf(s.type)){if(null!=s.colRange&&!0!==c.isCancelled){var l=s.colRange.split("-");let i=[];for(let e=0;e<p.records.length;e++){let t=[];for(let e=parseInt(l[0]);e<=parseInt(l[1]);e++)t.push(e);i.push({recid:p.records[e].recid,column:t})}p.removeRange("column-selection"),c.finish(),p.select(i)}if(1==p.reorderRows&&p.last.move.reorder)if(null!=s.to){let e=p.trigger({phase:"before",target:p.name,type:"reorderRow",recid:s.from,moveBefore:s.to});if(!0===e.isCancelled)return o(),void delete p.last.move;i=p.get(s.from,!0);let t=p.get(s.to,!0);"bottom"==s.to&&(t=p.records.length);var r=p.records[i];null!=i&&null!=t&&(p.records.splice(i,1),i>t?p.records.splice(t,0,r):p.records.splice(t-1,0,r)),o(),e.finish()}else o()}delete p.last.move,$(document).off(".w2ui-"+p.name)}}function o(){$(p.box).find("#grid_"+p.name+"_ghost").remove(),$(p.box).find("#grid_"+p.name+"_ghost_line").remove(),p.refresh(),delete p.last.move}}}}destroy(){let e=this.trigger({phase:"before",target:this.name,type:"destroy"});!0!==e.isCancelled&&($(this.box).off(),"object"==typeof this.toolbar&&this.toolbar.destroy&&this.toolbar.destroy(),0<$(this.box).find("#grid_"+this.name+"_body").length&&$(this.box).removeAttr("name").removeClass("w2ui-reset w2ui-grid w2ui-inactive").html(""),this.last.observeResize?.disconnect(),delete w2ui[this.name],e.finish())}initColumnOnOff(){if(this.show.toolbarColumns){let i=[{id:"line-numbers",text:"Line #",checked:this.show.lineNumbers}];for(let t=0;t<this.columns.length;t++){var s=this.columns[t];let e=this.columns[t].text;!1!==s.hideable&&(e=(e=!e&&this.columns[t].tooltip?this.columns[t].tooltip:e)||"- column "+(parseInt(t)+1)+" -",i.push({id:s.field,text:w2utils.stripTags(e),checked:!s.hidden}))}var e="object"!=typeof this.url?this.url:this.url.get;(e&&this.show.skipRecords||this.show.saveRestoreState)&&i.push({text:"--"}),e&&this.show.skipRecords&&(e=`
                ${w2utils.lang("Skip")}
            ...
            `,i.push({id:"",test:e,group:!1,icon:"w2ui-icon-empty"})),this.show.saveRestoreState&&i.push({id:"stateSave",text:w2utils.lang("Save Grid State"),icon:"w2ui-icon-empty",group:!1},{id:"stateReset",text:w2utils.lang("Restore Default State"),icon:"w2ui-icon-empty",group:!1});let t=[];return i.forEach(e=>{e.text=w2utils.lang(e.text),e.checked&&t.push(e.id)}),this.toolbar.set("w2ui-column-on-off",{selected:t,items:i}),i}}initColumnDrag(e){if(this.columnGroups&&this.columnGroups.length)throw"Draggable columns are not currently supported with column groups.";let o=this,h={};function t(){h.pressed=!1,clearTimeout(h.timeout)}function i(n){h.timeout&&clearTimeout(h.timeout);let a=this;h.pressed=!0,h.timeout=setTimeout(()=>{if(h.pressed&&0!==h.numberPreColumnsPresent){let e,i,t,s,l,r=["w2ui-col-number","w2ui-col-expand","w2ui-col-select"].concat(["w2ui-head-last"]);if($(n.originalEvent.target).parents().hasClass("w2ui-head")){for(let e=0,t=r.length;e<t;e++)if($(n.originalEvent.target).parents().hasClass(r[e]))return;if(h.numberPreColumnsPresent=$(o.box).find(".w2ui-head.w2ui-col-number, .w2ui-head.w2ui-col-expand, .w2ui-head.w2ui-col-select").length,h.columnHead=s=$(n.originalEvent.target).parents(".w2ui-head"),h.originalPos=l=parseInt(s.attr("col"),10),!0===(e=o.trigger({type:"columnDragStart",phase:"before",originalEvent:n,origColumnNumber:l,target:s[0]})).isCancelled)return!1;i=h.columns=$(o.box).find(".w2ui-head:not(.w2ui-head-last)"),$(document).on("mouseup",u),$(document).on("mousemove",d),h.ghost=$(a).clone(!0),$(h.ghost).find('[col]:not([col="'+h.originalPos+'"]), .w2ui-toolbar, .w2ui-grid-header').remove(),$(h.ghost).find(".w2ui-col-number, .w2ui-col-expand, .w2ui-col-select").remove(),$(h.ghost).find(".w2ui-grid-body").css({top:0}),t=$(h.ghost).find('[col="'+h.originalPos+'"]'),$(document.body).append(h.ghost),$(h.ghost).css({width:0,height:0,margin:0,position:"fixed",zIndex:999999,opacity:0}).addClass(".w2ui-grid-ghost").animate({width:t.width(),height:$(o.box).find(".w2ui-grid-body").first().height(),left:n.pageX,top:n.pageY,opacity:.8},0),h.offsets=[];for(let e=0,t=i.length;e<t;e++)h.offsets.push($(i[e]).offset().left);e.finish()}}},150)}function d(e){var t,i,s;h.pressed&&(t=e.originalEvent.pageX,e=e.originalEvent.pageY,s=h.offsets,i=$(".w2ui-head:not(.w2ui-head-last)").width(),h.targetInt=Math.max(h.numberPreColumnsPresent,function(i,s,l){{if(i<=s[0])return 0;if(i>=s[s.length-1]+l)return s.length;for(let e=0,t=s.length;e<t;e++){var r=s[e],n=s[e+1]||s[e]+l,a=(n-s[e])/2+s[e];if(r<i&&i<=a)return e;if(a<i&&i<=n)return e+1}return 0}}(t,s,i)),s=h.targetInt,h.marker||h.markerLeft||(h.marker=$('<div class="col-intersection-marker"><div class="top-marker"></div><div class="bottom-marker"></div></div>'),h.markerLeft=$('<div class="col-intersection-marker"><div class="top-marker"></div><div class="bottom-marker"></div></div>')),h.lastInt&&h.lastInt===s||(h.lastInt=s,h.marker.remove(),h.markerLeft.remove(),$(".w2ui-head").removeClass("w2ui-col-intersection"),s>=h.columns.length?($(h.columns[h.columns.length-1]).children("div:last").append(h.marker.addClass("right").removeClass("left")),$(h.columns[h.columns.length-1]).addClass("w2ui-col-intersection")):s<=h.numberPreColumnsPresent?($(h.columns[h.numberPreColumnsPresent]).prepend(h.marker.addClass("left").removeClass("right")).css({position:"relative"}),$(h.columns[h.numberPreColumnsPresent]).prev().addClass("w2ui-col-intersection")):($(h.columns[s]).children("div:last").prepend(h.marker.addClass("left").removeClass("right")),$(h.columns[s]).prev().children("div:last").append(h.markerLeft.addClass("right").removeClass("left")).css({position:"relative"}),$(h.columns[s-1]).addClass("w2ui-col-intersection"))),i=t,s=e,$(h.ghost).css({left:i-10,top:s-10}))}function u(e){h.pressed=!1;let t,i,s,l,r,n=$(o.box).find(".w2ui-grid-ghost");if(!0===(t=o.trigger({type:"columnDragEnd",phase:"before",originalEvent:e,target:h.columnHead[0]})).isCancelled)return!1;s=o.columns[h.originalPos],l=o.columns,r=$(h.columns[Math.min(h.lastInt,h.columns.length-1)]),(i=h.lastInt<h.columns.length?parseInt(r.attr("col")):l.length)!==h.originalPos+1&&i!==h.originalPos&&r&&r.length?($(h.ghost).animate({top:$(o.box).offset().top,left:r.offset().left,width:0,height:0,opacity:.2},300,function(){$(this).remove(),n.remove()}),l.splice(i,0,w2utils.clone(s)),l.splice(l.indexOf(s),1)):($(h.ghost).remove(),n.remove()),$(document).off("mouseup",u),$(document).off("mousemove",d),h.marker&&h.marker.remove(),h={},o.refresh(),t.finish({targetColumnNumber:i-1})}return h.lastInt=void 0,h.pressed=!1,h.timeout=null,h.columnHead=null,$(o.box).off("mousedown.colDrag").on("mousedown.colDrag",i),$(o.box).off("mouseup.colDrag").on("mouseup.colDrag",t),{remove(){$(o.box).off("mousedown.colDrag",i),$(o.box).off("mouseup.colDrag",t),$(o.box).find(".w2ui-head").removeAttr("draggable"),o.last.columnDrag=!1}}}columnOnOff(e,t){let i=this.trigger("columnOnOff",{target:this.name,field:t,originalEvent:e});if(!0!==i.isCancelled){var s=this.find({"w2ui.expanded":!0},!0);for(let e=0;e<s.length;e++){var l=this.records[e].w2ui;l&&!Array.isArray(l.children)&&(this.records[e].w2ui.expanded=!1)}"line-numbers"==t?(this.show.lineNumbers=!this.show.lineNumbers,this.refresh()):(e=this.getColumn(t)).hidden?this.showColumn(e.field):this.hideColumn(e.field),i.finish()}}initToolbar(){let l=this;if(null==this.toolbar.render){let t=this.toolbar.items||[];var e;if(this.toolbar.items=[],this.toolbar=new w2toolbar(w2utils.extend({},this.toolbar,{name:this.name+"_toolbar",owner:this})),this.show.toolbarReload&&this.toolbar.items.push(w2utils.extend({},this.buttons.reload)),this.show.toolbarColumns&&this.toolbar.items.push(w2utils.extend({},this.buttons.columns)),this.show.toolbarSearch&&(e=`
                ...
                </div>`,this.toolbar.items.push({id:"w2ui-search",type:"html",html:e,onRefresh(e){e.done(()=>{let e=query(this.box).find(`#grid_${l.name}_search_all`);w2utils.bindEvents(query(this.box).find(`#grid_${l.name}_search_all, .w2ui-action`),l),e.on("change",function(e){let t=this.value;var i=jQuery(this).data("selected");let s=jQuery(this).data("w2field");s&&(t=s.clean(t)),s&&"list"==s.type&&i&&void 0===i.id?l.searchReset():l.search(l.last.field,t),l.searchSuggest(!0,!0,this)}).on("keydown",function(e){40==e.keyCode&&l.searchSuggest(!0)})})}})),Array.isArray(t)){let e=t.map(e=>e.id);this.show.toolbarAdd&&!e.includes(this.buttons.add.id)&&this.toolbar.items.push(w2utils.extend({},this.buttons.add)),this.show.toolbarEdit&&!e.includes(this.buttons.edit.id)&&this.toolbar.items.push(w2utils.extend({},this.buttons.edit)),this.show.toolbarDelete&&!e.includes(this.buttons.delete.id)&&this.toolbar.items.push(w2utils.extend({},this.buttons.delete)),this.show.toolbarSave&&!e.includes(this.buttons.save.id)&&((this.show.toolbarAdd||this.show.toolbarDelete||this.show.toolbarEdit)&&this.toolbar.items.push({type:"break",id:"w2ui-break2"}),this.toolbar.items.push(w2utils.extend({},this.buttons.save)))}this.toolbar.items.push(...t),this.toolbar.on("click",e=>{let i=this.trigger("toolbar",{target:e.target,originalEvent:e});if(!0!==i.isCancelled){let t;switch(e.detail.item.id){case"w2ui-reload":if(!0===(t=this.trigger("reload",{target:this.name})).isCancelled)return!1;this.reload(),t.finish();break;case"w2ui-column-on-off":e.detail.subItem?(s=e.detail.subItem.id,["stateSave","stateReset"].includes(s)?this[s]():this.columnOnOff(e,e.detail.subItem.id)):(console.log(this.initColumnOnOff()),this.initResize(),this.resize());break;case"w2ui-add":if(!0===(t=this.trigger("add",{target:this.name,recid:null})).isCancelled)return!1;t.finish();break;case"w2ui-edit":{var s=this.getSelection();let e=null;if(1==s.length&&(e=s[0]),!0===(t=this.trigger("edit",{target:this.name,recid:e})).isCancelled)return!1;t.finish();break}case"w2ui-delete":this.delete();break;case"w2ui-save":this.save()}i.finish()}}),this.toolbar.on("refresh",e=>{if("w2ui-search"==e.target){let e=this.searchData;setTimeout(()=>{this.searchInitInput(this.last.field,1==e.length?e[0].value:null)},1)}})}}initResize(){let r=this;$(this.box).find(".w2ui-resizer").off(".grid-col-resize").on("click.grid-col-resize",function(e){e.stopPropagation?e.stopPropagation():e.cancelBubble=!0,e.preventDefault&&e.preventDefault()}).on("mousedown.grid-col-resize",function(e){e=e||window.event,r.last.colResizing=!0,r.last.tmp={x:e.screenX,y:e.screenY,gx:e.screenX,gy:e.screenY,col:parseInt($(this).attr("name"))},r.last.tmp.tds=$(r.box).find("#grid_"+r.name+"_body table tr:first-child td[col="+r.last.tmp.col+"]"),e.stopPropagation?e.stopPropagation():e.cancelBubble=!0,e.preventDefault&&e.preventDefault();for(let e=0;e<r.columns.length;e++)r.columns[e].hidden||(null==r.columns[e].sizeOriginal&&(r.columns[e].sizeOriginal=r.columns[e].size),r.columns[e].size=r.columns[e].sizeCalculated);let i={phase:"before",type:"columnResize",target:r.name,column:r.last.tmp.col,field:r.columns[r.last.tmp.col].field};i=r.trigger(w2utils.extend(i,{resizeBy:0,originalEvent:e}));let s;$(document).off(".grid-col-resize").on("mousemove.grid-col-resize",function(e){var t;1==r.last.colResizing&&(e=e||window.event,!0===(i=r.trigger(w2utils.extend(i,{resizeBy:e.screenX-r.last.tmp.gx,originalEvent:e}))).isCancelled?i.isCancelled=!1:(r.last.tmp.x=e.screenX-r.last.tmp.x,r.last.tmp.y=e.screenY-r.last.tmp.y,t=parseInt(r.columns[r.last.tmp.col].size)+r.last.tmp.x+"px",r.columns[r.last.tmp.col].size=t,s&&clearTimeout(s),s=setTimeout(()=>{r.resizeRecords(),r.scroll()},100),r.last.tmp.tds.css({width:t}),r.last.tmp.x=e.screenX,r.last.tmp.y=e.screenY))}).on("mouseup.grid-col-resize",function(e){$(document).off(".grid-col-resize"),r.resizeRecords(),r.scroll(),i.finish({originalEvent:e}),setTimeout(()=>{r.last.colResizing=!1},1)})}).on("dblclick.grid-col-resize",function(e){let t=parseInt($(this).attr("name")),i=r.columns[t],s=0;if(!1===i.autoResize)return!0;e.stopPropagation?e.stopPropagation():e.cancelBubble=!0,e.preventDefault&&e.preventDefault(),$(r.box).find('.w2ui-grid-records td[col="'+t+'"] > div',r.box).each(()=>{var e=this.offsetWidth-this.scrollWidth;e<s&&(s=e-3)});let l={phase:"before",type:"columnAutoResize",target:r.name,column:i,field:i.field};!0===(l=r.trigger(w2utils.extend(l,{resizeBy:Math.abs(s),originalEvent:e}))).isCancelled?l.isCancelled=!1:(s<0&&(i.size=Math.min(parseInt(i.size)+Math.abs(s),i.max||1/0)+"px",r.resizeRecords(),r.resizeRecords(),r.scroll()),l.finish({originalEvent:e}))}).each((e,t)=>{let i=$(t).parent();$(t).css({height:i.height(),"margin-left":i.width()-3+"px"})})}resizeBoxes(){let e=$(this.box).find("#grid_"+this.name+"_header"),t=$(this.box).find("#grid_"+this.name+"_toolbar"),i=$(this.box).find("#grid_"+this.name+"_fsummary"),s=$(this.box).find("#grid_"+this.name+"_summary"),l=$(this.box).find("#grid_"+this.name+"_footer"),r=$(this.box).find("#grid_"+this.name+"_body");this.show.header&&e.css({top:"0px",left:"0px",right:"0px"}),this.show.toolbar&&t.css({top:0+(this.show.header?w2utils.getSize(e,"height"):0)+"px",left:"0px",right:"0px"}),0<this.summary.length&&(i.css({bottom:0+(this.show.footer?w2utils.getSize(l,"height"):0)+"px"}),s.css({bottom:0+(this.show.footer?w2utils.getSize(l,"height"):0)+"px",right:"0px"})),this.show.footer&&l.css({bottom:"0px",left:"0px",right:"0px"}),r.css({top:0+(this.show.header?w2utils.getSize(e,"height"):0)+(this.show.toolbar?w2utils.getSize(t,"height"):0)+"px",bottom:0+(this.show.footer?w2utils.getSize(l,"height"):0)+(0<this.summary.length?w2utils.getSize(s,"height"):0)+"px",left:"0px",right:"0px"})}resizeRecords(){let s=this,e=($(this.box).find(".w2ui-empty-record").remove(),$(this.box)),t=$(this.box).find("> div.w2ui-grid-box");var i=$(this.box).find("#grid_"+this.name+"_header"),l=$(this.box).find("#grid_"+this.name+"_toolbar");let r=$(this.box).find("#grid_"+this.name+"_summary"),n=$(this.box).find("#grid_"+this.name+"_fsummary");var a,o,h=$(this.box).find("#grid_"+this.name+"_footer");let d=$(this.box).find("#grid_"+this.name+"_body"),u=$(this.box).find("#grid_"+this.name+"_columns"),c=$(this.box).find("#grid_"+this.name+"_fcolumns"),p=$(this.box).find("#grid_"+this.name+"_records"),f=$(this.box).find("#grid_"+this.name+"_frecords"),m=$(this.box).find("#grid_"+this.name+"_scroll1"),g=8*String(this.total).length+10,w=(g<34&&(g=34),null!=this.lineNumberWidth&&(g=this.lineNumberWidth),!1),y=!1,b=0;for(let e=0;e<this.columns.length;e++)this.columns[e].frozen||this.columns[e].hidden||(a=parseInt(this.columns[e].sizeCalculated||this.columns[e].size),b+=a);p.width()<b&&(w=!0),d.height()-u.height()<$(p).find(">table").height()+(w?w2utils.scrollBarSize():0)&&(y=!0),this.fixedBody?(o=t.height()-(this.show.header?w2utils.getSize(i,"height"):0)-(this.show.toolbar?w2utils.getSize(l,"height"):0)-("none"!=r.css("display")?w2utils.getSize(r,"height"):0)-(this.show.footer?w2utils.getSize(h,"height"):0),d.css("height",o)):(o=w2utils.getSize(u,"height")+w2utils.getSize($(this.box).find("#grid_"+this.name+"_records table"),"height")+(w?w2utils.scrollBarSize():0),this.height=o+(this.show.header?w2utils.getSize(i,"height"):0)+(this.show.toolbar?w2utils.getSize(l,"height"):0)+("none"!=r.css("display")?w2utils.getSize(r,"height"):0)+(this.show.footer?w2utils.getSize(h,"height"):0),t.css("height",this.height),d.css("height",o),e.css("height",w2utils.getSize(t,"height")));let v=this.records.length;i="object"!=typeof this.url?this.url:this.url.get;if(0==this.searchData.length||i||(v=this.last.searchIds.length),this.fixedBody||(y=!1),w||y?(u.find("> table > tbody > tr:nth-child(1) td.w2ui-head-last").css("width",w2utils.scrollBarSize()).show(),p.css({top:(0<this.columnGroups.length&&this.show.columns?1:0)+w2utils.getSize(u,"height")+"px","-webkit-overflow-scrolling":"touch","overflow-x":w?"auto":"hidden","overflow-y":y?"auto":"hidden"})):(u.find("> table > tbody > tr:nth-child(1) td.w2ui-head-last").hide(),p.css({top:(0<this.columnGroups.length&&this.show.columns?1:0)+w2utils.getSize(u,"height")+"px",overflow:"hidden"}),0<p.length&&(this.last.scrollTop=0,this.last.scrollLeft=0)),w?(f.css("margin-bottom",w2utils.scrollBarSize()),m.show()):(f.css("margin-bottom",0),m.hide()),f.css({overflow:"hidden",top:p.css("top")}),this.show.emptyRecords&&!y){let t=Math.floor(p.height()/this.recordHeight)-1,e=0;if((e=p[0]?p[0].scrollHeight-t*this.recordHeight:e)>=this.recordHeight&&(e-=this.recordHeight,t++),this.fixedBody){for(let e=v;e<t;e++)x(e,this.recordHeight,this);x(t,e,this)}}function x(e,t,i){let s="",l="";var r;s+='<tr class="'+(e%2?"w2ui-even":"w2ui-odd")+' w2ui-empty-record" recid="-none-" style="height: '+t+'px">',l+='<tr class="'+(e%2?"w2ui-even":"w2ui-odd")+' w2ui-empty-record" recid="-none-" style="height: '+t+'px">',i.show.lineNumbers&&(s+='<td class="w2ui-col-number"></td>'),i.show.selectColumn&&(s+='<td class="w2ui-grid-data w2ui-col-select"></td>'),i.show.expandColumn&&(s+='<td class="w2ui-grid-data w2ui-col-expand"></td>'),l+='<td class="w2ui-grid-data-spacer" col="start" style="border-right: 0"></td>',i.show.orderColumn&&(l+='<td class="w2ui-grid-data w2ui-col-order" col="order"></td>');for(let e=0;e<i.columns.length;e++){var n=i.columns[e];(n.hidden||e<i.last.colStart||e>i.last.colEnd)&&!n.frozen||(r='<td class="w2ui-grid-data" '+(null!=n.attr?n.attr:"")+' col="'+e+'"></td>',n.frozen?s+=r:l+=r)}s+='<td class="w2ui-grid-data-last"></td> </tr>',l+='<td class="w2ui-grid-data-last" col="end"></td> </tr>',$(i.box).find("#grid_"+i.name+"_frecords > table").append(s),$(i.box).find("#grid_"+i.name+"_records > table").append(l)}let _,C;if(0<d.length){let i=parseInt(d.width())-(y?w2utils.scrollBarSize():0)-(this.show.lineNumbers?g:0)-(this.show.selectColumn?26:0)-(this.show.expandColumn?26:0)-1,s=(_=i,!1);for(let t=C=0;t<this.columns.length;t++){let e=this.columns[t];0<e.gridMinWidth&&(e.gridMinWidth>_&&!0!==e.hidden&&(e.hidden=!0,s=!0),e.gridMinWidth<_&&!0===e.hidden&&(e.hidden=!1,s=!0))}if(!0===s)return void this.refresh();for(let t=0;t<this.columns.length;t++){let e=this.columns[t];e.hidden||("px"==String(e.size).substr(String(e.size).length-2).toLowerCase()?(i-=parseFloat(e.size),this.columns[t].sizeCalculated=e.size,this.columns[t].sizeType="px"):(C+=parseFloat(e.size),this.columns[t].sizeType="%",delete e.sizeCorrected))}if(100!=C&&0<C)for(let t=0;t<this.columns.length;t++){let e=this.columns[t];e.hidden||"%"==e.sizeType&&(e.sizeCorrected=Math.round(100*parseFloat(e.size)*100/C)/100+"%")}for(let e=0;e<this.columns.length;e++){var k=this.columns[e];k.hidden||"%"==k.sizeType&&(null!=this.columns[e].sizeCorrected?this.columns[e].sizeCalculated=Math.floor(i*parseFloat(k.sizeCorrected)/100)-1+"px":this.columns[e].sizeCalculated=Math.floor(i*parseFloat(k.size)/100)-1+"px")}}let q=0;for(let t=0;t<this.columns.length;t++){let e=this.columns[t];e.hidden||(null==e.min&&(e.min=20),parseInt(e.sizeCalculated)<parseInt(e.min)&&(e.sizeCalculated=e.min+"px"),parseInt(e.sizeCalculated)>parseInt(e.max)&&(e.sizeCalculated=e.max+"px"),q+=parseInt(e.sizeCalculated))}let T=parseInt(_)-parseInt(q);if(0<T&&0<C){let t=0;for(;;){let e=this.columns[t];if(null==e)t=0;else if(e.hidden||"px"==e.sizeType)t++;else{if(e.sizeCalculated=parseInt(e.sizeCalculated)+1+"px",0===--T)break;t++}}}else 0<T&&u.find("> table > tbody > tr:nth-child(1) td.w2ui-head-last").css("width",w2utils.scrollBarSize()).show();let S=1;this.show.lineNumbers&&(S+=g),this.show.selectColumn&&(S+=26),this.show.expandColumn&&(S+=26);for(let e=0;e<this.columns.length;e++)this.columns[e].hidden||this.columns[e].frozen&&(S+=parseInt(this.columns[e].sizeCalculated));c.css("width",S),f.css("width",S),n.css("width",S),m.css("width",S),u.css("left",S),p.css("left",S),r.css("left",S),u.find("> table > tbody > tr:nth-child(1) td").add(c.find("> table > tbody > tr:nth-child(1) td")).each((e,i)=>{$(i).hasClass("w2ui-col-number")&&$(i).css("width",g);var t=$(i).attr("col");if(null!=t){if("start"==t){let t=0;for(let e=0;e<s.last.colStart;e++)!s.columns[e]||s.columns[e].frozen||s.columns[e].hidden||(t+=parseInt(s.columns[e].sizeCalculated));$(i).css("width",t+"px")}s.columns[t]&&$(i).css("width",s.columns[t].sizeCalculated)}if($(i).hasClass("w2ui-head-last"))if(s.last.colEnd+1<s.columns.length){let t=0;for(let e=s.last.colEnd+1;e<s.columns.length;e++)!s.columns[e]||s.columns[e].frozen||s.columns[e].hidden||(t+=parseInt(s.columns[e].sizeCalculated));$(i).css("width",t+"px")}else $(i).css("width",w2utils.scrollBarSize()+(0<T&&0===C?T:0)+"px")}),3==u.find("> table > tbody > tr").length&&u.find("> table > tbody > tr:nth-child(1) td").add(c.find("> table > tbody > tr:nth-child(1) td")).html("").css({height:"0px",border:"0px",padding:"0px",margin:"0px"}),p.find("> table > tbody > tr:nth-child(1) td").add(f.find("> table > tbody > tr:nth-child(1) td")).each((e,i)=>{$(i).hasClass("w2ui-col-number")&&$(i).css("width",g);var t=$(i).attr("col");if(null!=t){if("start"==t){let t=0;for(let e=0;e<s.last.colStart;e++)!s.columns[e]||s.columns[e].frozen||s.columns[e].hidden||(t+=parseInt(s.columns[e].sizeCalculated));$(i).css("width",t+"px")}s.columns[t]&&$(i).css("width",s.columns[t].sizeCalculated)}if($(i).hasClass("w2ui-grid-data-last")&&0===$(i).parents(".w2ui-grid-frecords").length)if(s.last.colEnd+1<s.columns.length){let t=0;for(let e=s.last.colEnd+1;e<s.columns.length;e++)!s.columns[e]||s.columns[e].frozen||s.columns[e].hidden||(t+=parseInt(s.columns[e].sizeCalculated));$(i).css("width",t+"px")}else $(i).css("width",(0<T&&0===C?T:0)+"px")}),r.find("> table > tbody > tr:nth-child(1) td").add(n.find("> table > tbody > tr:nth-child(1) td")).each((e,i)=>{$(i).hasClass("w2ui-col-number")&&$(i).css("width",g);var t=$(i).attr("col");if(null!=t){if("start"==t){let t=0;for(let e=0;e<s.last.colStart;e++)!s.columns[e]||s.columns[e].frozen||s.columns[e].hidden||(t+=parseInt(s.columns[e].sizeCalculated));$(i).css("width",t+"px")}s.columns[t]&&$(i).css("width",s.columns[t].sizeCalculated)}$(i).hasClass("w2ui-grid-data-last")&&0===$(i).parents(".w2ui-grid-frecords").length&&$(i).css("width",w2utils.scrollBarSize()+(0<T&&0===C?T:0)+"px")}),this.initResize(),this.refreshRanges(),(this.last.scrollTop||this.last.scrollLeft)&&0<p.length&&(u.prop("scrollLeft",this.last.scrollLeft),p.prop("scrollTop",this.last.scrollTop),p.prop("scrollLeft",this.last.scrollLeft))}getSearchesHTML(){let s=`
