	...
	<div class="row">
		<div class="span12 navbar">
			<div class="navbar-inner">
				<ul class="nav">
				  <li <?=($check_section == 'layout' ? 'class="active"' : '')?>><a href="<?=$site_root?>/docs/1.5/layout">Layout</a> </li>
				  <li <?=($check_section == 'grid' ? 'class="active"' : '')?>><a href="<?=$site_root?>/docs/1.5/grid">Grid</a></li>
				  <li <?=($check_section == 'toolbar' ? 'class="active"' : '')?>><a href="<?=$site_root?>/docs/1.5/toolbar">Toolbar</a></li>
				  <li <?=($check_section == 'sidebar' ? 'class="active"' : '')?>><a href="<?=$site_root?>/docs/1.5/sidebar">Sidebar</a></li>
				  <li <?=($check_section == 'tabs' ? 'class="active"' : '')?>><a href="<?=$site_root?>/docs/1.5/tabs">Tabs</a></li>
				  ...
				  <li id="version">
                    ...
                    <select onchange="document.location = String('<?php echo $ver_url?>').replace('~VERSION~', this.value)"
                        ...
                        <option value="1.4">ver 1.4</option>
				  		<option value="1.5" selected>ver 1.5</option>
				  	</select>
				  	</div>
				  </li>
				</ul>
