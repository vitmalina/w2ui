	...
	<div class="row">
		<div class="span12 navbar">
			<div class="navbar-inner">
				<ul class="nav">
				  <li <?=($check_section == 'layout' ? 'class="active"' : '')?>><a href="<?=$site_root?>/docs/1.4/layout">Layout</a> </li>
				  <li <?=($check_section == 'grid' ? 'class="active"' : '')?>><a href="<?=$site_root?>/docs/1.4/grid">Grid</a></li>
				  <li <?=($check_section == 'toolbar' ? 'class="active"' : '')?>><a href="<?=$site_root?>/docs/1.4/toolbar">Toolbar</a></li>
				  <li <?=($check_section == 'sidebar' ? 'class="active"' : '')?>><a href="<?=$site_root?>/docs/1.4/sidebar">Sidebar</a></li>
				  <li <?=($check_section == 'tabs' ? 'class="active"' : '')?>><a href="<?=$site_root?>/docs/1.4/tabs">Tabs</a></li>
				  <li <?=($check_section == 'form' ? 'class="active"' : '')?>><a href="<?=$site_root?>/docs/1.4/form">Form</a></li>
				  <li <?=($check_section == 'popup' ? 'class="active"' : '')?>><a href="<?=$site_root?>/docs/1.4/popup">Popup</a></li>
				  <li <?=($check_section == 'utils' ? 'class="active"' : '')?>><a href="<?=$site_root?>/docs/1.4/utils">Utilities</a></li>
				</ul>
				<ul class="nav pull-right">
				  <li id="version">
                    ...
                    <select onchange="document.location = String('<?php echo $ver_url?>').replace('~VERSION~', this.value)"
				  		...
				  		<option value="1.3">ver 1.3</option>
                        <option value="1.4" selected>ver 1.4</option>
