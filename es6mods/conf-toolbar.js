export default {
    ...
    tooltip: 'top',
    items: [
        { type: 'button', id: 'item1.0', text: 'BTN', img: 'icon-page', tooltip() { return (new Date()).getTime(); }},
        {
        ...
        { type: 'check', id: 'item1.1', text: 'Check', img: 'icon-page', tooltip() { return (new Date()).getTime(); },
